...
protected:
    ...
    *         Returns NULL if and only if {@code p} is NULL.
    */
    ...
    * <p>
    * The returned pointer will be NULL only if {@code segment} is
   ...
   /**
    * Allocate a new block and slice a segment of size {@code n}
    ...
    * in the same block and return the {@code joined} segment pointer to
    ...
    * in the same block and return the 'joined' segment pointer to
    * be added to the free list.
    * <p>
    * This method returns the same segment if it is not joined.
    * <p>
   ...
   /**
    * Return the index to use for a segment of size {@code n}
    * in the free lists.
    */
