...
EXTERN_C
void VSAPI scClearProjectFileListCache(VSPSZ workspaceFile, VSPSZ projectFile,bool clearWildcardCache=false);
...
VSPSZ VSAPI scProjectFindFile(VSPSZ workspaceFile, VSPSZ projectFile, VSPSZ file, 
                              int checkPath = 1, int returnAll = 0, int matchPathSuffix = 0,int force_case_insensitive_matching=0);
...
VSDLLEXPORT int SEGetNumProjectFiles(const slickedit::SEString &workspaceFile, 
                                        ...
                                        int projectHandle = -1);
VSDLLEXPORT void SEProjectFileCacheMaybeUpdate(const slickedit::SEString &workspaceFile, const slickedit::SEString &projectFile);
...
VSDLLEXPORT slickedit::SEString SEProjectFindFile(const slickedit::SEString &workspaceFile, const slickedit::SEString &projectFile,
                                                  const slickedit::SEString &file, bool checkPath = true, bool returnAll = false, bool matchPathSuffix = false, bool force_case_insensitive_matching=false);
