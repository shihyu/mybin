...
enum VSMSGDEFS_SLICKT {
    ...
    // Repeated case in switch statement
    REPEATED_CASE_IN_SWITCH_RC = -1291,
    // Case statement after default in switch statement
    CASE_STATEMENT_AFTER_DEFAULT_IN_SWITCH_RC = -1292,
    // Included from here
    MODULE_INCLUDED_FROM_RC = -1293,
    // Found {1} warnings
    SLICKC_COMPILE_HAS_WARNINGS_RC = -1294,
    // One warning
    SLICKC_COMPILE_HAS_ONE_WARNING_RC = -1295,
};
#endif
...
enum VSMSGDEFS_SLICKEDITOR {
    ...
    // 
    APPNAME_RC = -2115,
    // Instance ID specified not allowed with +new option
    VSRC_INSTANCE_ID_SPECIFIED_NOT_ALLOWED_WITH_NEW_OPTION= -2116,
    // Too many instance IDs
    VSRC_TOO_MANY_INSTANCE_IDS= -2117,
    // Instance ID not found
    VSRC_INSTANCE_ID_NOT_FOUND= -2118,
    // Instance ID specified already exists
    VSRC_INSTANCE_ID_ALREADY_EXISTS= -2119,
    // Failed to communicate with existing instance. Index out of range.
    VSRC_FAILED_TO_COMMUNICATE_WITH_EXISTING_INSTANCE_INDEX_OUT_OF_RANGE= -2120,
...
enum VSMSGDEFS_SLICKI {
    ...
    SQUARE_ROOT_OF_NEGATIVE_NUMBER_RC = -3106,
    // Invalid return type for DLL function
    INVALID_DLL_RETURN_TYPE_RC = -3107,
};
#endif
...
enum VSMSGDEFS_CLEX {
    ...
    // Color coding profile '{0}': Invalid start_substring_colors '{1}'
    CLEXRC_INVALID_START_SUBSTRING_COLORS_2ARG = -3595,
    // Color coding profile '{0}': Invalid end_substring_colors '{1}'
    CLEXRC_INVALID_END_SUBSTRING_COLORS_2ARG = -3596,
};
#endif
...
enum VSMSGDEFS_BTREE {
    ...
    // Statement to be included in current context
    VS_TAG_FLAG_IN_CONTEXT_RC = -3993,
    // Nested local symbol definition
    VS_TAG_FLAG_NESTED_LOCAL_RC = -3994,
    // Asynchronous
    VS_TAG_FLAG_ASYNCHRONOUS_RC = -3995,
    // Factory
    VS_TAG_FLAG_FACTORY_RC = -3996,
    // Late / lazy variable initialization
    VS_TAG_FLAG_LATE_RC = -3997,
    // Procedure
...
enum VSMSGDEFS_VSDIFF {
    ...
    // Cannot modify {0} because it is being diffed
    VSDIFF_FILE_IS_BEING_DIFFED = -7011
};
#endif
...
enum VSMSGDEFS_MACRO {
    ...
    // Symbol color for Protected member variable symbol
    ...
    // Symbol color for Private member variable symbol
    ...
    // Symbol color for Public static member variable symbol
    VSRC_CFG_SYMBOL_COLOR_PUBLIC_STATIC_MEMBER_VARIABLE_DESCRIPTION = -101608,
    // Package static member variable
    VSRC_CFG_SYMBOL_COLOR_PACKAGE_STATIC_MEMBER_VARIABLE = -101609,
    // Symbol color for Package static member variable symbol
    ...
    // Symbol color for Protected static member variable symbol
    ...
    // Symbol color for Package member function symbol
    ...
    // Symbol color for Protected member function symbol
    ...
    // Symbol color for Private member function symbol
    ...
    // Symbol color for Public static member function symbol
    VSRC_CFG_SYMBOL_COLOR_PUBLIC_STATIC_MEMBER_FUNCTION_DESCRIPTION = -101636,
    // Package static member function
    VSRC_CFG_SYMBOL_COLOR_PACKAGE_STATIC_MEMBER_FUNCTION = -101637,
    // Symbol color for Package static member function symbol
    ...
    // Symbol color for Protected static member function symbol
    ...
    // Symbol color for Public static class property symbol
    ...
    // Symbol color for Package static class property symbol
    ...
    // Symbol color for Protected static class property symbol
    ...
    // This color is used to highlight source in the editor window for any 
    // errors detected by Live Errors.
    VSRC_CFG_LIVE_ERRORS_ERROR_DESCRIPTION = -101852, 
    // This color is used to highlight source in the editor window for any
    // warnings detected by Live Errors.
    VSRC_CFG_LIVE_ERRORS_WARNING_DESCRIPTION = -101853, 

    // Show symbol information
    VSRC_SHOW_SYMBOL_INFO_NO_WORD = -101854,
    // Show symbol information for '{0}'
    VSRC_SHOW_SYMBOL_INFO = -101855,
    // Imported options from
...
enum CMERROR_REGEX {
    ...
    CMRC_REGEX_INVALID_RANGE_SPECIFICATION,
    // Regex search cancelled
    CMRC_REGEX_SEARCH_CANCELLED,
...
enum CMERROR_GREP {
    ...
    //     --recurse       Recurse directories and change -t to turn off recurse 
    //                     directories. +t always turns on recurse directories.
...
enum VSMSGDEFS_SVC {
    ...
    // Could not get annotation info for file '{0}'
    //
    // {1}
    VSRC_SVC_COULD_NOT_GET_ANNOTATION_INFO,
