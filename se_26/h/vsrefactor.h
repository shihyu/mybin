 ...
 * @param isFilename Is {@code message} a file name?
 *
 * @return 0 on success, <0 on cancellation.
 *
 * @categories Refactoring_Functions
 ...
 *
 * @return <ul>
 *         <li>COMMAND_CANCELLED_RC if {@code status} is COMMAND_CANCELLED_RC
 ...
 * @param wid        Window ID
 * @param text       text to insert
 * @param textLen    number of bytes allocated to {@code text}
 *
 ...
 * {@code startSeekPos} and {@code endSeekPos} into a separate function and replace
