...
#define VS_TAG_USER_VERSION_64BITFLAGS 26000
/**
 ...
 */
#define VS_TAG_LATEST_VERSION          26000
/**
 ...
 *
 * @param yes_or_no  {@code true} to configure database to use memory mapped files
 *
 ...
 *
 * @param yes_or_no  {@code true} to configure database to use independent cacahing
 *
 * @return 0 on success, &lt;0 on error. 
 *  
 * @note 
...
/**
 * @return Return {@code true} if the tag database is current open for writing. 
 */
EXTERN_C
 ...
 * {@code file_name}, not necessarily the literal file extension. 
 *  
 ...
 */
EXTERN_C 
int VSAPI tag_get_bitmap_for_type(int tag_type_id, VSINT64Param tag_flags=SE_TAG_FLAG_NULL, VSHREFVAR pic_overlay=VSHVAR_NULL);
/**
 * @return 
 ...
 * @param waitForMS        set to {@code true} if you want to wait for the specified 
