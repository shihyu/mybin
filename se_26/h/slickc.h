...
#ifndef VSHVAR_T_DEFINED
#define VSHVAR_T_DEFINED
   #if __cplusplus
      enum VSHVAR_T : int {
         VSHVAR_INVALID = -1,
         VSHVAR_NULL    = 0,
         VSHVAR_RC      = 1,
         VSHVAR_DOT     = 2,
         VSHVAR_MAX     = 0x7fffffff,
      };
   #else
      typedef int VSHVAR_T;
      #define VSHVAR_INVALID -1
      #define VSHVAR_NULL     0
      #define VSHVAR_RC       1
      #define VSHVAR_DOT      2
      #define VSHVAR_MAX      0x7fffffff
   #endif
#endif

#define HVAR      VSHVAR_T
#define VSHVAR    VSHVAR_T
...
#define SENumberConst    const slickedit::SENumber &
#define SENumberByRef    slickedit::SENumber &
...
struct VSARGTYPE {
   ...
   /**
    * Construct from integer argument
    */
   VSARGTYPE(const int arg_i) {
      kind = VSARGTYPE_INT;
      u.i = arg_i;
   }
   /**
    * Construct from long argument
    */
   VSARGTYPE(const long arg_l) {
      kind = VSARGTYPE_LONG;
      u.l = arg_l;
   }
   /**
    * Construct from size_t argument
    */
   VSARGTYPE(const size_t arg_size) {
      kind = VSARGTYPE_SIZE_T;
      u.size = arg_size;
   }
   /**
    * Construct from bool argument
    */
   VSARGTYPE(const bool arg_b) {
      kind = VSARGTYPE_BOOL;
      u.b = arg_b;
   }
   /**
    * Construct from HVAR argument 
    * Extra argument is used to distinguish from {@code int} 
    */
   VSARGTYPE(const VSHVAR arg_hvar) {
      kind = VSARGTYPE_HVAR;
      u.hvar = arg_hvar;
   }
   /**
    * Construct from null-termianted C string argument
    */
   VSARGTYPE(const char *arg_psz) {
      kind = VSARGTYPE_PSZ;
      u.psz = arg_psz;
   }
   /**
    * Construct from pointer to LSTR argument
    */
   VSARGTYPE(const VSLSTR *arg_plstr) {
      kind = VSARGTYPE_PLSTR;
      u.plstr = arg_plstr;
   }
   /**
    * Construct from pointer to VSBUFARG argument
    */
   VSARGTYPE(VSBUFARG *arg_buf) {
      kind = VSARGTYPE_BUF;
      u.pBufArg = arg_buf;
   }
   /**
    ...
    */
   VSARGTYPE(const VSINT64 arg_i64) {
      kind = VSARGTYPE_INT64;
      u.i64 = arg_i64;
   }
   /**
    * Construct from double precision float
    */
   VSARGTYPE(const double arg_dub) {
      kind = VSARGTYPE_DOUBLE;
      u.d = arg_dub;
   }
   /**
    * Construct from pointer to bool
    */
   VSARGTYPE(bool *arg_pbool) {
      kind = VSARGTYPE_REF_BOOL;
      u.pbool = arg_pbool;
   }
   /**
    * Construct from pointer to integer
    */
   VSARGTYPE(int *arg_pint32) {
      kind = VSARGTYPE_REF_INT;
      u.pint32 = arg_pint32;
   }
   /**
    * Construct from pointer to long
    */
   VSARGTYPE(long *arg_plong) {
      kind = VSARGTYPE_REF_LONG;
      u.plong = arg_plong;
   }
   /**
    * Construct from pointer to 64-bit integer
    */
   VSARGTYPE(VSINT64 *arg_pint64) {
      kind = VSARGTYPE_REF_INT64;
      u.pint64 = arg_pint64;
   }
   /**
    * Construct from pointer to size_t
    */
   VSARGTYPE(size_t *arg_psize) {
      kind = VSARGTYPE_REF_SIZE_T;
      u.psize = arg_psize;
   }
   /**
    * Construct from pointer to double-precision float
    */
   VSARGTYPE(double *arg_pdub) {
      kind = VSARGTYPE_REF_DOUBLE;
      u.pd = arg_pdub;
   }
   /**
    * Construct from const pointer to cmStringUtf8
    */
   VSARGTYPE(const cmROStringUtf8 *arg_str) {
      kind = VSARGTYPE_CMSTRING;
      u.pCMString = arg_str;
   }
   /**
    * Construct from reference pointer to cmStringUtf8
    */
   VSARGTYPE(cmStringUtf8 *arg_str) {
      kind = VSARGTYPE_REF_CMSTRING;
      u.prefCMString = arg_str;
   }
   /**
    * Construct from const pointer to SEString
    */
   VSARGTYPE(const slickedit::SEString *arg_str) {
      kind = VSARGTYPE_SESTRING;
      u.pSEString = arg_str;
   }
   /**
    * Construct from reference pointer to SEString
    */
   VSARGTYPE(slickedit::SEString *arg_str) {
      kind = VSARGTYPE_REF_SESTRING;
      u.prefSEString = arg_str;
   }

   /**
    * Default copy constructor.
    */
   VSARGTYPE(const VSARGTYPE &src) = default;
   /**
    * Default assignment operator.
    */
   VSARGTYPE & operator =(const VSARGTYPE &src) = default;

   /**
    * Assign from integer argument
    */
   VSARGTYPE & operator =(const int arg_i) {
      kind = VSARGTYPE_INT;
      u.i = arg_i;
      return *this;
   }
   /**
    * Assign from long argument
    */
   VSARGTYPE & operator =(const long arg_l) {
      kind = VSARGTYPE_LONG;
      u.l = arg_l;
      return *this;
   }
   /**
    * Assign from size_t argument
    */
   VSARGTYPE & operator =(const size_t arg_size) {
      kind = VSARGTYPE_SIZE_T;
      u.size = arg_size;
      return *this;
   }
   /**
    * Assign from bool argument
    */
   VSARGTYPE & operator =(const bool arg_b) {
      kind = VSARGTYPE_BOOL;
      u.b = arg_b;
      return *this;
   }
   /**
    * Assign from HVAR argument
    */
   VSARGTYPE & operator =(const VSHVAR arg_hvar) {
      kind = VSARGTYPE_HVAR;
      u.hvar = arg_hvar;
      return *this;
   }
   /**
    * Assign from null-termianted C string argument
    */
   VSARGTYPE & operator =(const char *arg_psz) {
      kind = VSARGTYPE_PSZ;
      u.psz = arg_psz;
      return *this;
   }
   /**
    * Assign from pointer to LSTR argument
    */
   VSARGTYPE & operator =(const VSLSTR *arg_plstr) {
      kind = VSARGTYPE_PLSTR;
      u.plstr = arg_plstr;
      return *this;
   }
   /**
    * Assign from pointer to VSBUFARG argument
    */
   VSARGTYPE & operator =(VSBUFARG *arg_buf) {
      kind = VSARGTYPE_BUF;
      u.pBufArg = arg_buf;
      return *this;
   }
    ...
    */
   VSARGTYPE & operator =(const VSINT64 arg_i64) {
      kind = VSARGTYPE_INT64;
      u.i64 = arg_i64;
      return *this;
   }
   /**
    * Assign from double precision float
    */
   VSARGTYPE & operator =(const double arg_dub) {
      kind = VSARGTYPE_DOUBLE;
      u.d = arg_dub;
      return *this;
   }
   /**
    * Assign from pointer to bool
    */
   VSARGTYPE & operator =(bool *arg_pbool) {
      kind = VSARGTYPE_REF_BOOL;
      u.pbool = arg_pbool;
      return *this;
   }
   /**
    * Assign from pointer to integer
    */
   VSARGTYPE & operator =(int *arg_pint32) {
      kind = VSARGTYPE_REF_INT;
      u.pint32 = arg_pint32;
      return *this;
   }
   /**
    * Assign from pointer to long
    */
   VSARGTYPE & operator =(long *arg_plong) {
      kind = VSARGTYPE_REF_LONG;
      u.plong = arg_plong;
      return *this;
   }
   /**
    * Assign from pointer to 64-bit integer
    */
   VSARGTYPE & operator =(VSINT64 *arg_pint64) {
      kind = VSARGTYPE_REF_INT64;
      u.pint64 = arg_pint64;
      return *this;
   }
   /**
    * Assign from pointer to size_t
    */
   VSARGTYPE & operator =(size_t *arg_psize) {
      kind = VSARGTYPE_REF_SIZE_T;
      u.psize = arg_psize;
      return *this;
   }
   /**
    * Assign from pointer to double-precision float
    */
   VSARGTYPE & operator =(double *arg_pdub) {
      kind = VSARGTYPE_REF_DOUBLE;
      u.pd = arg_pdub;
      return *this;
   }
   /**
    * Assign from const pointer to cmStringUtf8
    */
   VSARGTYPE & operator =(const cmROStringUtf8 *arg_str) {
      kind = VSARGTYPE_CMSTRING;
      u.pCMString = arg_str;
      return *this;
   }
   /**
    * Assign from reference pointer to cmStringUtf8
    */
   VSARGTYPE & operator =(cmStringUtf8 *arg_str) {
      kind = VSARGTYPE_REF_CMSTRING;
      u.prefCMString = arg_str;
      return *this;
   }
   /**
    * Assign from const pointer to SEString
    */
   VSARGTYPE & operator =(const slickedit::SEString *arg_str) {
      kind = VSARGTYPE_SESTRING;
      u.pSEString = arg_str;
      return *this;
   }
   /**
    * Assign from reference pointer to SEString
    */
   VSARGTYPE & operator =(slickedit::SEString *arg_str) {
      kind = VSARGTYPE_REF_SESTRING;
      u.prefSEString = arg_str;
      return *this;
   }
 ...
 * specifies that {@code pBuf} is null terminated 
 ...
 * zero.</p>
 * 
 * @param pcancel            Optionally points to a user 
 *                           variable.  When the user variable
 *                           is non-zero, this function returns.
 * @param ProcessTimerEvents Determines whether timer events 
 *                           should be processed.
 * @param AllowUserInput 
 * @param timeoutInMS        (default 0, ignored) stop after milliseconds
 * 
 * @see vsEvent2Index
 * @see vsIndex2Event
 ...
 */
void VSAPI vsProcessEvents(int *pcancel=0,int ProcessTimerEvents=0,int AllowUserInput=0,int timeoutInMS=0);
 ...
 * {@code pszName}.  We recommend 
 * VSMAXEVENTNAME.
 * 
 * @param option	One of the following option letters:
 * 
 * <dl>
 * <dt>{@literal 'S'}</dt><dd>Return Slick-C&reg; source code event name.  
 * These will never change so that our Slick-C&reg; 
 * source code will be backward compatible.</dd>
 * <dt>{@literal 'L'}</dt><dd>Return long event names intended for 
 * display on a menu. like "Alt+F4" instead for 
 * "A+F4".</dd>
 * <dt>{@literal 'C'}</dt><dd>Return short event names intended for 
 ...
 * @param version
 * 
 * @return Returns input {@code index} unmodified.
 * 
 * @see vsIndex2Event
 ...
 * {@code root_keytab_index} or the value of 
 ...
 * {@code index} is empty (see <b>vsHvarMakeEmpty</b>()), the first 
 * element is returned.  If there are no more elements, {@code index} is set 
 ...
 * Slick-C&reg; array.   If the index specified by {@code i} is greater than the 
 ...
 * {@code hVarHashtab} is not currently an array, the current variable 
 ...
 * inserted.  If {@code hVarHashtab} is not currently a hash table, the 
 ...
 * {@code hvar}.  If the value of the variable is not a valid integer, an 
...
/**
 * @return Returns integer value of interpreter variable corresponding to 
 * {@code hvar}.  If the value of the variable is not a valid 64-bit integer, 
 ...
 *         interpreter variable corresponding to {@code hvar}. If
...
/**
 * @return Returns high precision floating point value of interpreter variable 
 * corresponding to {@code hvar}.  If the value of the variable is not a valid 
 * floating pointer number, an unknown value is returned.
 * 
 * @example
 * <pre>
 * 	      VSHVAR hvar;
 * 	      slickedit::SENumber n;
 * 	      int index;
 *  
 * 	      // The rc variable is a global variable which always exists.
 * 	      index=vsFindIndex("rc",VSTYPE_VAR);
 ...
 * 
 */ 
int VSAPI vsHvarGetDouble(VSHVAR hvar, class slickedit::SENumber& value);
/**
 * @return Returns the id of the interpreter variable pointed to
 *         by the interpreter variable corresponding to {@code hVar}.
 * 
 * @see vsHvarSetI
 * @see vsHvarSetI64
 * @see vsHvarSetDouble
...
/**
 * Sets value of interpreter variable to the floating point number specified.
 * 
 * @example
 * <pre>
 * 	      // The rc variable is a global variable which always exists.
 ...
 * 	      VSHVAR hvar=vsGetVar(index);
 * 	      // Specify integer for variable value
 * 	      vsHvarSetDouble(hvar, slickedit::SENumber(123.456));
 * </pre>
 * 	
 * @see vsHvarSetB
 * @see vsHvarGetZ
 ...
 * 
 */ 
int VSAPI vsHvarSetDouble(VSHVAR hVar, const class slickedit::SENumber &value);
/**
 * Sets value of interpreter variable specified to data pointed to by pBuf. 
 * {@code BufLen} specifies the length of the data.
 * 
 * @example
 * <pre>
 * 	      VSHVAR hvar;
 ...
 * {@code src} variable goes out of scope, it will be 
 ...
 * @see vsHvarSetDouble
 * @see vsHvarSetZ 
 * @see vsHvarGetPointer 
 *  
 * @categories Miscellaneous_Functions
 */
int VSAPI vsHvarSetPointer(VSHVAR hvar,VSHVAR src);
/** 
 * Gets value of interpreter variable expected to be a Slick-C pointer type. 
 *  
 * NOTE:  As always with pointer types, use with care, because 
 * interpreter variables are not reference counted.  If the 
 * {@code src} variable goes out of scope, it will be 
 ...
 * @see vsHvarSetDouble
 * @see vsHvarSetZ 
 * @see vsHvarSetPointer 
 *  
 * @categories Miscellaneous_Functions
 */
VSHVAR VSAPI vsHvarGetPointer(VSHVAR hvar);

/** 
 * Sets value of interpreter variable specified to be a pointer 
 * to a Slick-C function.
 *  
 * @param hvar    interpreter variable (destination) 
 * @param src     interpreter variable (source)
 * 
 ...
 * @see vsHvarSetDouble
 * @see vsHvarSetZ 
 * @see vsHvarGetFunctionPointer 
 *  
 * @categories Miscellaneous_Functions
 */
int VSAPI vsHvarSetFunctionPointer(VSHVAR hvar, VSFUNPTR src);
/** 
 * Gets value of interpreter variable expected to be a pointer to a Slick-C function index.
 *  
 * @param hvar    interpreter variable (destination) 
 * @param src     interpreter variable (source)
 * 
 ...
 * @see vsHvarSetDouble
 * @see vsHvarSetZ 
 * @see vsHvarSetFunctionPointer 
 *  
 * @categories Miscellaneous_Functions
 */
VSFUNPTR VSAPI vsHvarGetFunctionPointer(VSHVAR hvar);
 ...
 *         Returns CLASS_NAME_NOT_FOUND_RC if the class is not found.
 *         Returns INVALID_HVAR_ARGUMENT_RC if {@code hvar} is 
 ...
 *         type of the {@code hvar} class instance.
 ...
 *         INVALID_HVAR_ARGUMENT_RC if {@code hvar} is not a struct or
 *         class instance.
 * 
 ...
 * 
 * @return {@code true} if {@code hvar} is an instance of {@code name}
 ...
 * key.</p>
 * 
 * <p>The syntax for {@code pszFuncProto} is:<br>
 * 
 ...
 */
#if MACHINE_MAX_DLL_CALL_PARAMS < MAX_SUPPORTED_DLL_CALL_PARAMS
// For platforms where we have to call a thunking function for some
// parameters, we can not do the type check of `pfn`, because 
// all of the parameters of the thunking function are intptr_t, to
// match the dllprocN_tp function pointers.  
 ...
 * library find function, using the {@code func_name} declared in
 ...
 * 
 * @param func-name is the name of the DLL function to be registered.  
 * {@code dllname} is optional and indicates the name of the DLL which 
...
/**
 * Copies string value of property into {@code pszValue}.  The returned 
 * string is always null terminated.  No more than {@code BufLen} 
...
/**
 * Copies string value of property into {@code pBuf}.  No more than 
 * {@code BufLen} bytes are copied.
 * 
 ...
 * 
 * @param prop_id	One of the VSP_??? constants in "vs.h".
 * {@code pBuf}	Output buffer for string value.  Buffer is not 
 * null terminated.  This can be 0.
 * 
 * @param BufLen	Number of bytes allocated to {@code pBuf}.
 * 
 * @param pBufLen	If  this is not 0, this is set to the number of 
 * characters you need to allocate to 
 * {@code pBuf}.
...
/**
 * Sets value of integer property to {@code value}.  For documentation on 
...
/**
 * Sets value of a 64-bit integer property to {@code value}.  For documentation 
...
/**
 * Sets value of VSHVAR property to {@code hvar}. 
...
/**
 * Sets value of string property to {@code pszValue}.
 * 
...
/**
 * Sets value of string property to {@code pBuf}.  For documentation on 
 * the properties, you must translate the VSP_??? constants into the 
 * Slick-C&reg; property name.  For example, VSP_BUFNAME corresponds 
 * to <b>p_buf_name</b> and VSP_LINE corresponds to 
 * <b>p_line</b>.
...
/**
 * Opens the file specified with access specified by {@code option}.
 * 
...
/**
 * Closes the file handle {@code fh}.  {@code fh} must have been returned 
 * by <b>vsFileOpen</b>.
 * 
...
/**
 * Reads number of bytes specified by {@code BufLen} into {@code pBuf}.
 * 
...
/**
 * Write number of bytes specified by {@code BufLen} to the file 
 * specified by {@code fh}.  {@code pBuf} points to the data to be written.
 * 
...
/**
 * Changes the file position for the file specified by {@code fh}.
 * 
 * @return If successful, the new seek position is returned.  Otherwise a negative 
 * error code is returned.
 * 
 * @param option changes the meaning of {@code SeekPos} as follows:
 * 
 * <dl>
 ...
 * 
 * @param InfoLen Number of characters in {@code pInfo}.  -1 
 * means {@code pInfo} is null terminated.
 * 
 * @see vsFindIndex
 * @see vsNameMatch
 * @see vsNameName
 ...
 * This function is thread-safe. 
 *  
 * @return Returns name table index to {@code pszName} of one of the types 
 * specified by {@code flags}. 0 is returned if a match is not found.  A 
 * name type match is considered if  ({@code flags} & 
 * <b>vsNameType</b>({@code index})) is true.  Search is not case 
 * sensitive except for names of type VSTYPE_PICTURE and 
 * VSTYPE_MODULE under UNIX.  All underscore characters in 
 * {@code name} are converted to dash characters before searching takes 
 ...
 *  
 * @return Returns name table index to {@code pszName} of one of the types 
 * specified by {@code flags}. A name type match is considered if 
 * ({@code flags} & <b>vsNameType</b>({@code index})) is true. 
 * Search is not case sensitive except for names of type 
 * VSTYPE_PICTURE and VSTYPE_MODULE under UNIX.  All underscore 
 * characters in {@code name} are converted to dash characters 
 ...
 * {@code index} is invalid or does not correspond to a procedure or 
 ...
 * 0 is returned if index is not valid or can not be resolved.
 *  
 * @attention 
 * This function is thread-safe. 
 *  
...
/** 
 * @return
 * Convert the given function name index to a Slick-C function pointer type.
 * 0 is returned if index is not valid or can not be resolved.
 *  
 * @attention 
 * This function is thread-safe. 
 ...
 * @categories Names_Table_Functions
 */
VSFUNPTR VSAPI vsName2FunctionPointer(int index);
 ...
 *                kind==VSTYPE_PICTURE, {@code pszName} is
...
/**
 * @return Returns name table {@code index} of the name with prefix matching 
 * {@code pszNamePrefix} and where ({@code flags} & 
 * name_type({@code index})) is true.  A non-zero value for 
 * {@code find_first}, begins a new search.  If {@code find_first} is zero, 
 ...
 * flag is given.  Underscores in {@code pszName} are translated to dashes 
 ...
 * {@code index} specified with the arguments specified.  Any return 
 ...
 * @categories Miscellaneous_Functions
 */ 
void VSAPI vsCallIndex(int wid,int index,int Nofargs=0,const VSARGTYPE *pArgList=nullptr);

/**
 * Looks up the given procedure or command type in the names table 
 * using {@link vsFindIndex}, then calls it using {@link vsCallIndex}.
 * 
 * @param wid           window id (0 for current window)
 * @param pszProcName   Slick-C procedure or command to look up and call
 * @param Nofargs       number of arguments in pArgList
 * @param pArgList      list of arguments, may be nullptr if Nofargs==0
 * 
 * @return 
 * Returns 0 on success, error &lt; 0 if procedure is not found.
 */
int VSAPI vsCallName(int wid,const char *pszProcName,int Nofargs=0,const VSARGTYPE *pArgList=nullptr);
 ...
 * @param width 
 * @param height 
 * @param state        Initial window state. {@literal 'N'}=Normalized, 
 *                     {@literal 'M'}=Maximized, {@literal 'I'}=Iconized/minimized.
 ...
 * @param len    New allocation size for {@code pBuf}.
 * 
 * @return If successful, resizes the memory allocated by {@link vsAlloc}
 *         to allow up to {@code len} bytes and returns a pointer to the
 *         newly allocated memory.  {@code pBuf} may be 0 to allocate new
 *         memory.  Otherwise 0 is returned.  The new memory is
 *         initialized to the previous value if any pointed to by
 *         {@code pBuf}.  Use the {@link vsFree} function to free memory allocated
 *         by this function.
 * @see vsFree
 * @see vsAlloc
 * 
...
/**
 * @return If {@code ParamNum} is zero, the number of parameters passed to the 
 * function are returned.  If {@code ParamNum} is greater than the number 
 ...
 * typeless variable.  The vsHvar{@code xxx} functions can be used to get 
 * VSHVARs.
 * 
 * @see vsHvarGetI
 * @see vsHvarGetI64
...
/**
 * Converts VSPLSTR to ASCIIZ string.  No more than {@code DestLen} 
 * are written.
 * 
 * @return Returns {@code pszDest}.
 * 
 * @categories Miscellaneous_Functions
 * 
 */ 
 ...
 * {@code InitTohVar} is non-zero, the returned variable is a copy of the 
 ...
 * 
 */ 
VSHVAR VSAPI vsHvarAlloc(VSHVAR InitTohVar=VSHVAR_NULL);
...
/**
 * @return Returns variable format of {@code hvar}.  One of the VSVF_??? 
 * constants.
 * 
...
/**
 * Sets value of long integer property to {@code value}.
 * 
 * @param wid	Window id of object or index to resource 
 * returned by <b>vsFindIndex</b>, 
 * <b>vsNameMatch</b>, 
 ...
 * 
 * @param SearchForLen	Number of bytes in {@code pSearchFor}.
 * You can specify -1 if pSearchFor is NULL 
 * terminated.
 * 
 * @param pBuf	Buffer to search in.
 * 
 * @param BufLen	Number of bytes in {@code pBuf}.
 * 
 * @param start	Character position to start searching from 
 * 1..{@code BufLen}.  Specify 1 to start search 
 * from firstcharacter.
 * 
 ...
 * the character {@literal 'a'}, it will not be found as the
 ...
 *                                    if you search for the character {@literal 'a'}, it will not
...
/**
 * @return Returns {@code pInputStr} with all occurrences of {@code pSearchStr} 
 * replaced with {@code pReplaceStr}.  See <b>vsStrPos</b> function for 
 * information on valid search {@code options}.
 * 
...
/**
 * Calls the given procedure or command type using {@link vsCallIndex}.
 * 
 * @param wid           window id (0 for current window)
 * @param iProcIndex    Slick-C procedure or command index (from vsFindIndex) 
 * @param args          variadic argument list compatible with {@link VSARGTYPE} 
 * 
 * @return 
 * Returns 0 on success, error &lt; 0 if procedure is not found.
 */
template <typename...T>
inline void VSDLLEXPORT SECallIndex(int wid, int iProcIndex, T...args) {
   VSARGTYPE argList[] = {args...};
   vsCallIndex(wid, iProcIndex, sizeof(argList)/sizeof(argList[0]), argList);
}
 ...
 */
template <typename...T>
inline int VSDLLEXPORT SECallName(int wid, const char *pszProcName, T...args) {
   VSARGTYPE argList[] = {args...};
   return vsCallName(wid, pszProcName, sizeof(argList)/sizeof(argList[0]), argList);
}
