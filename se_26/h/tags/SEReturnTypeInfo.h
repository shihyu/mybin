...
public:
    ...
    * this return type.  For example, for a class named {@literal 'Al'} in a namespace 
    * named {@literal 'Bundy'}, the information would be 'Al(bundy:class)'.
    *  
   ...
   /**
    * @return Returns {@code true} if this is a pointer type.
    */
   ...
   /**
    * @return Returns {@code true} if this is a reference type.
    */
   ...
   /**
    * @return Returns {@code true} if this is a type alias, for example, a typedef 
   ...
   /**
    * @return Returns {@code true} if this is an array type.
    */
   ...
   /**
    * @return Returns {@code true} if this is a hash table type.
    */
   ...
   /**
    * @return Returns {@code true} if the given return flag is a special type, such 
    *         as a pointer, reference, array, hash table, template or function.
    */
   const bool isReturnTypeSpecial() const;
   /**
    * @return Returns {@code true} if the given return type is a builtin type for the 
    *         current language mode.
    */
   const bool isReturnTypeBuiltin() const;
   /**
    * @return Returns {@code true} if the given return type is a placeholder. 
    */
   const bool isReturnTypeFake() const;
   /**
    * @return Returns {@code true} if the given return flag is set.
    * @param flag          return type flag to test 
    */
   const bool isReturnTypeFlagSet(const SETagReturnTypeFlags flag) const;
   /**
    * @return Returns {@code true} if the all of the given return flags are set. 
    * @param flags         return type flags to test 
    */
   const bool areAllReturnTypeFlagsSet(const SETagReturnTypeFlags flags) const;
   /**
    * @return Returns {@code true} if the any of the given return flags are set. 
    * @param flags         return type flags to test 
    */
   ...
   /**
    * @return Returns {@code true} if this is a template type or a template type instance.
    */
    ...
    * 
    * @param yesno         {@code true} or {@code false} indicating if this is a template. 
   ...
   /**
    * @return Returns {@code true} if this is a function call or function pointer.
    */
    ...
    * 
    * @param yesno         {@code true} or {@code false} indicating if this is a function. 
