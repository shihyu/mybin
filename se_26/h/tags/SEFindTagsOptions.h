...
struct VSDLLEXPORT SEFindTagsOptions {
   ...
   void clear();
   /**
    * @return Return {@code true} if this object is in a null state.
    */
    ...
    *  
    * @param on_off    {@code true} or {@code false}
    */
    ...
    * 
    * @param word_info    Slick-C struct to copy out contents to 
    */
   void copyOut(VSHREFVAR word_info) const;

   /**
    * Copy the contexts of the given Slick-C struct AUTO_COMPLETE_INFO 
    * in to this instance. 
    * 
    * @param word_info    Slick-C struct to copy out contents from
    */
   void copyIn(VSHREFVAR word_info);
