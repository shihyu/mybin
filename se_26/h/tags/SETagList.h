...
public:
    ...
    * @param isEmbeddedSection            is {@code rhsTokenList} from embedded code?
    ...
    * @see findCurrentTagId() 
    */
   const unsigned int findNearestTagId(const SEString &fileName, 
                                       const unsigned int currentLineNumber,
...
private:
   ...
   SESharedPointer<class SEPrivateTagList> mpTagList;
