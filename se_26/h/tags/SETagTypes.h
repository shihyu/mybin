 ...
 * 
 * @return 
 * Returns {@code true} if the type is allowed according to the flags, {@code false} if not.
 */
...
/**
 * @return 
 * Return {@code true} if the given type is a function, procedure, constructor, 
...
/**
 * @return 
 * Return {@code true} if the given type is a prototype for a function, 
...
/**
 * @return 
 * Return {@code true} if the given type is a variable, global variable, member variable, 
...
/**
 * @return 
 * Return {@code true} if the given type is a database table, index, column, trigger, 
...
/**
 * @return 
 * Return {@code true} if the given type is a constant, enumerator, or #define symbol.
 * Return {@code false} otherwise.
 * 
 * @param tagType    tag type ID
 */
...
/**
 * @return 
 * Return {@code true} if the given type is any statement type (loop, if, block, etc.)
 * Return {@code false} otherwise.
 * 
 * @param tagType    tag type ID
 */
...
/**
 * @return 
 * Return {@code true} if the given type is a class, struct, union, or interface.
 * Return {@code false} otherwise.
 * 
...
/**
 * @return 
 * Return {@code true} if the given type is a package, namespace, program, library, 
...
/**
 * @return 
 * Return {@code true} if the given type is an annotation, #region, #note, #todo, or #warning.
...
/**
 * @return 
 * Return {@code true} if the given type is a preprecessing control statement.
 * Return {@code false} otherwise.
 * 
 * @param tagType    tag type ID
 */
...
/**
 * @return 
 * Return {@code true} if the given symbol is opaque, meaning that symbols defined 
...
/**
 * @return 
 * Return {@code true} if the given type is preprocessig, a #include, an annotation, 
...
/**
 * @return 
 * Return {@code true} if the given symbol type has arguments, or should be expected 
 ...
 * 
 * @return 
 * The function returns {@code false} if the tag does not meet filtration criteria,
 * and {@code true} if the tag does meet criteria.
 */
