...
typedef int (*SETagFindTagsCallbackType)(class SETagList &matches,
                                         SEArray<SEString> &errorArgs,
                                         const class SEString &langId,
                                         const struct SEReturnTypeInfo &contextReturnType,
                                         const struct SEReturnTypeInfo &prefixReturnType,
...
public:
    ...
    *                            only if the search terminates in error, of course.
    * @param langId              current language mode
    * @param contextReturnType   return type evaluated for the current context
    * @param prefixReturnType    return type evaluated for the prefix expression 
    *                            found by expression analysis (idexpInfo). 
    ...
    * the current language mode inherits callbacks from.  Returns {@code nullptr} if 
    ...
    * the {@link listTags()} method, this function will return {@code nullptr}.
    *  
    * @param checkParents  If this instance does not have the callback, 
    *                      check the inherited language mode(s) 
    */
    ...
    * this function will return {@code nullptr}.
    *  
    * @param checkParents  If this instance does not have the callback, 
    *                      check the inherited language mode(s) 
    */
    ...
    * the {@link getIDExpressionInfo()} method, this function will return {@code nullptr}.
    * 
    * @param langId        language mode identifier
    */
    ...
    * by the given language.  If this instance (or an inherited instance) overrides 
    * the {@link findTags()} method, this function will return {@code nullptr}.
    * 
    * @param langId        language mode identifier
    */
   ...
   /**
    * @return 
    * Return {@code true} if statement-level tagging is supported for this language.
    */
   ...
   /**
    * @return 
    * Return {@code true} if tokenization is supported for this language. 
    */
   ...
   /**
    * @return 
    * Return {@code true} if the parser creates positional keywords tokens.
    */
   ...
   /**
    * @return 
    * Return {@code true} if the parser supports incremental tagging.
    */
