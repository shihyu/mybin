...
extern VSDLLEXPORT int SEDocCommentType2CommentFlags(const SETagDocCommentType commentType);

extern VSDLLEXPORT const SETagDocCommentType SECommentFlags2DocCommentType(const int comment_flags);
