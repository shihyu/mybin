...
public:
    ...
    * @param maxMatches       Stop if {@code foundFiles} set contains this many files
    * @param checkTimeout     Stop if the search runs out of time 
    * @param timeoutAfterMS   If non-zero, stop if this function is busy for 
    *                         more than this amount of time in milliseconds. 
    * 
    ...
    * @param maxMatches       Stop if {@code foundClasses} set contains this many classes
    * @param checkTimeout     Stop if the search runs out of time 
    * @param timeoutAfterMS   If non-zero, stop if this function is busy for 
    *                         more than this amount of time in milliseconds. 
    * 
    ...
    * or tag name prefix), and return {@code true} if it is a match.
    * 
    ...
    */
     ...
     * or class name prefix), and return {@code true} if it is a match.
     * 
   ...
   /** 
    * @return 
    * Return {@code true} if the tag filters match for the given symbol.
    * 
...
protected:
    ...
    * 
    * @return 
    * Returns {@code true} if it is time to stop. 
    */
