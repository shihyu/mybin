...
public:
   ...
   /**
    * @return 
    * Returns {@code true} if this token block exactly matches the given token list.
    */
   bool operator == (const SETokenList &rhs) const;
   /**
    * @return 
    * Returns {@code true} if this token block does not match the given token list.
    */
   bool operator != (const SETokenList &rhs) const;
    ...
    * the given timeframe. 
    *  
    * @return Return {@code true} if the lock was successfully obtained. 
    *  
    * @see lockTokenList() 
    * @see unlockTokenList(); 
    */
   ...
   /**
    * @return {@code true} if the token spans the given offset 
    *  
    * @see getStartOffset()
    * @see getEndOffset()
    */
   ...
   /**
    * @return {@code true} if the token spans the given line number 
    *  
    * @see getStartLineNumber() 
    * @see getEndLineNumber() 
    */
   ...
   /**
    * @return Return {@code true} if the given token spans the given seek position.
    * 
    * @param tokenID   unique Id of token
   ...
   /** 
    * @return 
    * Return {@code true} if the given token is part of a embedded code section.
    * 
    * @see pushEmbeddedSection() 
    * @see popEmbeddedSection() 
    * @see getNumEmbeddedTokenLists() 
   ...
   /** 
    * @return 
    * Return {@code true} if the given token is part of a preprocessed code section.
    * 
    * @see pushPreprocessedSection() 
    * @see popPreprocessedSection() 
    * @see getNumPreprocessedTokenLists() 
...
private:
    ...
    */
   SESharedPointer<class SEMainTokenList> mpMainTokenList;
