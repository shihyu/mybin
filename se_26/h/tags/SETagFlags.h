...
enum SETagFlags : VSUINT64 {
    ...
    */
   SE_TAG_FLAG_IN_CONTEXT        = 0x0000100000000000ULL,
   /**
    ...
    */
   SE_TAG_FLAG_NESTED_LOCAL      = 0x0000200000000000ULL,

   /**
    * Asynchronous method or statement (runs in thread)
    */
   SE_TAG_FLAG_ASYNCHRONOUS      = 0x0000400000000000ULL,
   /**
    * Factory method for creating class instances.
    */
   SE_TAG_FLAG_FACTORY           = 0x0000800000000000ULL,
   /**
    * Late / lazy variable initialization
    */
   SE_TAG_FLAG_LATE              = 0x0001000000000000ULL,
};
