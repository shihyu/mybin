...
struct VSDLLEXPORT SEIDExpressionInfo {
    ...
    * Equality operator
    */
   bool operator == (const SEIDExpressionInfo& src) const;
   /**
    * Inequality operator
    */
   bool operator != (const SEIDExpressionInfo& src) const;
   ...
   void clear();
   /**
    * @return Return {@code true} if this object is in it's initial NULL state.
    */
   ...
   /**
    * Copy the contexts of the given Slick-C struct VS_TAG_IDEXP_INFO 
    * in to this instance. 
    * 
    * @param idexp_info    Slick-C struct to copy out contents from
    */
   void copyIn(VSHREFVAR idexp_info);
