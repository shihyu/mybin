...
public:
    ...
    * Note: the capacity() of the string will be >= {@code initial_capacity}.
    *
    ...
    * string will be greater than or equal to {@code new_capacity}.
    *
    ...
    * is already longer than {@code text_len}, do nothing.  This function
    ...
    * lifetime of {@code this}.  FURTHERMORE, if {@code this} is modified, the
    ...
    * the given null-terminated "C" string(s).  If the {@code after}
    * string is null, use {@code text} both before and after.
    *
    * @param text       The string to prepend
   ...
   /**
    * Surround the contents of this string with the given
    * the given character array(s).  If the {@code after}
    * string is null, use {@code text} both before and after.
    *
    * @param text       The string to prepend
   ...
   /**
    * Surround the contents of this string with the given
    * the given VSE lstr_p(s).  If the {@code after} string is null,
    * use {@code text} both before and after.
    *
   ...
   /**
    * Surround the contents of this string with the given
    * the given VSE cmStringUtf8(s).  If the {@code after} string is null,
    * use {@code text} both before and after.
    *
   ...
   /**
    * Replace {@code text_len} characters starting at the given
    ...
    * @param isUTF8  Set to {@code true} to do UTF-8 safe character replacement 
    *
    ...
    * @param isUTF8        Set to {@code true} to do UTF-8 safe character replacement 
    *                      {@code false} will use the OS strstr() function to find matches 
    *
   ...
   /**
    * Delete {@code num_chars} characters starting at the given position.
    *
   ...
   /**
    * Trim {@code num_chars} characters off of the end of the string.
    *
    * @param num_chars  The number of characters to delete
    * @return 0 on success
    */
    ...
    * @param ltb        Strip leading, trailing, or both?  {@literal 'L'}, {@literal 'T'}, or {@literal 'B'}
    ...
    *  
    * @param onlyIfBothQuotes    quotes are only stripped if they are at 
    *                            both the start and end of the string. 
    *
    * @return 0 on success
    */
   int stripQuotes(bool onlyIfBothQuotes=false);
   ...
   /**
    * Get all lower-case copy of this string.
    * @return 0 on success, &lt;0 on error.
    */
...
//#endif
    ...
    *
    * @return {@code true} if it begins with the pattern, false otherwise
    */
    ...
    * @param pattern Pattern to look for
    *
    * @return {@code true} if it ends with the pattern, false otherwise
    */
    ...
    * @param delim            character delimeter to split string at
    *
    * @return {@code true} if this string is in the given list, false otherwise
    */
   bool isInList(const SEString &array, const char delim=' ') const;

   /**
    * Parse the first item off of this string and return it.
    * Setting the remainder of the string to the {@code rest} argument.
    * This function does not work with strings containing nulls.
    *
    * @param delim      character delimeter to split string at
    * @param rest       the rest of the string, maybe be {@code this}
    ...
    * the beginning of the string to the {@code start} argument. This 
    * function does not work with strings containing nulls. 
    *
    * @param delim      character delimeter to split string at
    * @param start      the beginning of the string 
    *                   (before last delimeter), maybe be {@code this}
    *
    * @return the first item off of the list
    */
    ...
    * ending in {@literal 'U'} or {@literal 'L'}, etc.), then specify a stop character 
    ...
    * <ul>
    * <li>Prefix: 0123 (leading {@literal '0'} harmless but unnecessary)
    * <li>Sign: -0123
    * <li>Suffix: 0123L
    * </ul>
    * </p>
 ...
 *
 * @returns SEString containing value of {@code var}
 *  
 * @see vsHvarSetS
 * @see vsHvarGetI
 * @see vsHvarSetI
