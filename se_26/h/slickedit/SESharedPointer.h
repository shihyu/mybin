...
public:
    ...
    /** 
     * @return Return {@code true} if pointer to data is not allocated.
     */
    bool operator !() const;

    /**
     * @return Returns {@code true} if the pointer is null.
     */
    operator bool() const;
     ...
     * existing pointer managed by this class to be deleted and replaced by {@code ptr}. 
     * 
    ...
    /**
     * @return Returns {@code true} if the instance is unique (not a shared pointer).
     */
