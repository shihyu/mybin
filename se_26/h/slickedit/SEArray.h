...
public:
    ...
    * function registered for this class.  Relies on {@code T} supporting == and &lt; 
    *  
   ...
   /**
    * Delete up to {@code count} items at the specified index in the list.
    *
    * @param index        Index of item to remove
   ...
   size_t length() const;
   /**
    * @return Return {@code true} if the given index is valid for this array.
    */
   ...
   /**
    * Set the length of the array to exactly {@code numItems} items.
    ...
    * <p>
    * NOTE:  This has no effect if getCapacity() is already &ge; {@code numItems}.
    * <p>
    ...
    * If {@code iter} is unitialized, it will retrieve the first item 
    * in the collection. 
    *  
    ...
    * If {@code iter} is unitialized, it will retrieve the last item 
    * in the collection. 
    *  
    * @param iter    black-box iterator object 
    * @param key     (output) set to key for item retrieved 
    ...
    * If {@code iter} is unitialized, it will return NULL.
    * 
    * @param iter    black-box iterator object 
    * @param key     (output) set to key for item retrieved 
    *  
    ...
    * If {@code iter} is uninitialized, the result is undefined. 
    * 
    ...
    * @param iter    black-box iterator object 
    * 
    * @return 0 on success, &lt;0 on error or if {@code iter} is unitialized. 
    */
