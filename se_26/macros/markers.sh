...
/**
 * Enumerated type for keeping track of what marker type priorities are used 
 * by various editor features.  Valus range from 0 (highest) to 255 (lowest).
 *  
 * @appliesTo Edit_Window, Editor_Control
 * @categories Marker_Functions
 */
enum VSMarkerTypePriorities {
   VSMARKER_TYPE_PRIORITY_FIND = 200,
   VSMARKER_TYPE_PRIORITY_INCREMENTAL_SEARCH =   4,
   VSMARKER_TYPE_PRIORITY_DOC_SEARCH_CURRENT =   5,
   VSMARKER_TYPE_PRIORITY_DOC_SEARCH_MATCH   =  10,
   VSMARKER_TYPE_PRIORITY_URL                =  20,
   VSMARKER_TYPE_PRIORITY_REAL_TIME_ERRORS   =  30,
   VSMARKER_TYPE_PRIORITY_SPELL              =  40,
   VSMARKER_TYPE_PRIORITY_HIGHLIGHT          =  50,
   VSMARKER_TYPE_PRIORITY_REFERENCES         = 100,
   VSMARKER_TYPE_PRIORITY_TAG_HIGHLIGHT      = 150,
   VSMARKER_TYPE_PRIORITY_SYMBOL_COLORING    = 200,
   VSMARKER_TYPE_PRIORITY_KEYWORDS           = 225,
   VSMARKER_TYPE_PRIORITY_WWTS               = 240,
};
 ...
 * @categories Marker_Functions
 */
extern void _LineMarkerRemoveBMIndex(int wid,int BMIndex);
/**
 * Removes all line markers for the specified editor control that have the
 ...
 * @categories Marker_Functions
 */
extern void _LineMarkerRemoveUserDataInt64(int wid, int type, long iUserData);
 ...
 * @categories Marker_Functions
 */
extern void _StreamMarkerRemoveBMIndex(int wid,int BMIndex);
/**
 * Removes all stream markers for the specified editor control that have the
 * specified {@code iUserData} and the given {@code type}.
 *
 ...
 * @categories Marker_Functions
 */
extern void _StreamMarkerRemoveUserDataInt64(int wid, int type, long iUserData);
/**
 ...
 * @categories Marker_Functions
 */
extern void _StreamMarkerRemoveAllBMIndex(int BMIndex);
 ...
 * @categories Marker_Functions
 */
extern void _StreamMarkerRemoveAllUserDataInt64(int type, long iUserData);
 ...
 * @categories Marker_Functions
 */
extern void _LineMarkerFindListWithType(int (&list)[], int wid, int markerTypeId=0, int BMIndex=0, long userData64=0);
 ...
 * @categories Marker_Functions
 */
extern void _StreamMarkerFindListWithType(int (&list)[], int wid, int markerTypeId=0, int BMIndex=0, long userData64=0);
 ...
 * <i>NofLines</i> property of the line marker.
 * </dd>
 * <dt>VSMARKERTYPEFLAG_SYMBOL_COLORING</dt><dd>
 ...
 * </dd>
 * <dt>VSMARKERTYPEFLAG_FONT_BOLD</dt><dd> 
 * Indicates that this stream marker should be displayed with bold font. 
 * </dd> 
 * <dt>VSMARKERTYPEFLAG_FONT_ITALIC</dt><dd> 
 * Indicates that this stream marker should be displayed with italic font. 
 * </dd> 
 * <dt>VSMARKERTYPEFLAG_FONT_UNDERLINE</dt><dd> 
 * Indicates that this stream marker should be displayed with underline font. 
 * </dd> 
 * <dt>VSMARKERTYPEFLAG_REVERSE_COLOR</dt><dd> 
 * Indicates that this stream marker should be displayed with foreground 
...
/**
 * Set 64-bit integer data for this stream marker. 
 *
 * @param StreamMarkerIndex      Index of stream marker returned by a _StreamMarkerAdd function.
 * @param UserData               integer value
 *  
 * @since 26.0 
 * @appliesTo Edit_Window, Editor_Control
 * @categories Marker_Functions
...
/** 
 * @return 
 * Return 64-bit integer data for this stream marker. 
 *
 * @param StreamMarkerIndex      Index of stream marker returned by a _StreamMarkerAdd function.
 *
 * @since 26.0 
 ...
 * @categories Marker_Functions
 */
extern void _StreamMarkerSetStyleFlags(int StreamMarkerIndex, int MarkerTypeFlags);
/** 
 * @return 
 ...
 * @categories Marker_Functions
 */
extern int _StreamMarkerGetStyleFlags(int StreamMarkerIndex);
...
/**
 * Update scroll markup information for the given editor window
 */
extern void _ScrollMarkupUpdateModel(int wid);
