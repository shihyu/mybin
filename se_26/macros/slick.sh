...
const COMPILER_NAME_VS2022=           "Visual Studio 2022";
...
#define SLICK_HELP_FILE       ((_QtMajorVersion()==5) ?"slickedit5.qhc":"slickedit.qhc")
...
const VSBUFFLAG_DELETE_FILE_ON_CLOSE_OR_RENAME= 0x400;  /* Delete temp file probably created by "e +t" */
...
const SUBWORDTAG_ARG= ("swtag:"(REMOVE_DUPS_MATCH|SMALLSORT_MATCH|TERMINATE_MATCH));
...
_metadata enum CFGColorConstants {
   ...
   CFG_LIVE_ERRORS_ERROR       = 107,
   CFG_LIVE_ERRORS_WARNING     = 108,

   // colors 109-127 reserved for future use
   VSCFG_UNUSED                = 109,

   // "named" symbol coloring colors
   CFG_SYMBOL_COLOR_SYMBOL_NOT_FOUND                 = 128,
   CFG_SYMBOL_COLOR_LOCAL_VARIABLE                   = 129,
   CFG_SYMBOL_COLOR_STATIC_LOCAL_VARIABLE            = 130,
   CFG_SYMBOL_COLOR_PARAMETER                        = 131,
   CFG_SYMBOL_COLOR_TEMPLATE_PARAMETER               = 132,
   CFG_SYMBOL_COLOR_PUBLIC_MEMBER_VARIABLE           = 133,
   CFG_SYMBOL_COLOR_PACKAGE_MEMBER_VARIABLE          = 134,
   CFG_SYMBOL_COLOR_PROTECTED_MEMBER_VARIABLE        = 135,
   CFG_SYMBOL_COLOR_PRIVATE_MEMBER_VARIABLE          = 136,
   CFG_SYMBOL_COLOR_PUBLIC_STATIC_MEMBER_VARIABLE    = 137,
   CFG_SYMBOL_COLOR_PACKAGE_STATIC_MEMBER_VARIABLE   = 138,
   CFG_SYMBOL_COLOR_PROTECTED_STATIC_MEMBER_VARIABLE = 139,
   CFG_SYMBOL_COLOR_PRIVATE_STATIC_MEMBER_VARIABLE   = 140,
   CFG_SYMBOL_COLOR_GLOBAL_VARIABLE                  = 141,
   CFG_SYMBOL_COLOR_STATIC_GLOBAL_VARIABLE           = 142,
   CFG_SYMBOL_COLOR_GLOBAL_FUNCTION                  = 143,
   CFG_SYMBOL_COLOR_STATIC_GLOBAL_FUNCTION           = 144,
   CFG_SYMBOL_COLOR_CLASS_CONSTRUCTOR                = 145,
   CFG_SYMBOL_COLOR_CLASS_DESTRUCTOR                 = 146,
   CFG_SYMBOL_COLOR_PUBLIC_MEMBER_FUNCTION           = 147,
   CFG_SYMBOL_COLOR_PACKAGE_MEMBER_FUNCTION          = 148,
   CFG_SYMBOL_COLOR_PROTECTED_MEMBER_FUNCTION        = 149,
   CFG_SYMBOL_COLOR_PRIVATE_MEMBER_FUNCTION          = 150,
   CFG_SYMBOL_COLOR_PUBLIC_STATIC_MEMBER_FUNCTION    = 151,
   CFG_SYMBOL_COLOR_PACKAGE_STATIC_MEMBER_FUNCTION   = 152,
   CFG_SYMBOL_COLOR_PROTECTED_STATIC_MEMBER_FUNCTION = 153,
   CFG_SYMBOL_COLOR_PRIVATE_STATIC_MEMBER_FUNCTION   = 154,
   CFG_SYMBOL_COLOR_NESTED_FUNCTION                  = 155,
   CFG_SYMBOL_COLOR_PUBLIC_CLASS_PROPERTY            = 156,
   CFG_SYMBOL_COLOR_PACKAGE_CLASS_PROPERTY           = 157,
   CFG_SYMBOL_COLOR_PROTECTED_CLASS_PROPERTY         = 158,
   CFG_SYMBOL_COLOR_PRIVATE_CLASS_PROPERTY           = 159,
   CFG_SYMBOL_COLOR_PUBLIC_STATIC_CLASS_PROPERTY     = 160,
   CFG_SYMBOL_COLOR_PACKAGE_STATIC_CLASS_PROPERTY    = 161,
   CFG_SYMBOL_COLOR_PROTECTED_STATIC_CLASS_PROPERTY  = 162,
   CFG_SYMBOL_COLOR_PRIVATE_STATIC_CLASS_PROPERTY    = 163,
   CFG_SYMBOL_COLOR_CLASS                            = 164,
   CFG_SYMBOL_COLOR_TEMPLATE_CLASS                   = 165,
   CFG_SYMBOL_COLOR_ABSTRACT_CLASS                   = 166,
   CFG_SYMBOL_COLOR_INTERFACE_CLASS                  = 167,
   CFG_SYMBOL_COLOR_STRUCT                           = 168,
   CFG_SYMBOL_COLOR_UNION_OR_VARIANT_TYPE            = 169,
   CFG_SYMBOL_COLOR_TYPE_DEFINITION_OR_ALIAS         = 170,
   CFG_SYMBOL_COLOR_PREPROCESSOR_MACRO               = 171,
   CFG_SYMBOL_COLOR_PACKAGE_OR_NAMESPACE             = 172,
   CFG_SYMBOL_COLOR_SYMBOLIC_CONSTANT                = 173,
   CFG_SYMBOL_COLOR_ENUMERATED_TYPE                  = 174,
   CFG_SYMBOL_COLOR_ENUMERATION_CONSTANT             = 175,
   CFG_SYMBOL_COLOR_STATEMENT_LABEL                  = 176,
   CFG_SYMBOL_COLOR_DATABASE_TABLE                   = 177,
   CFG_SYMBOL_COLOR_DATABASE_TABLE_COLUMN            = 178,
   CFG_SYMBOL_COLOR_DATABASE_TABLE_INDEX             = 179,
   CFG_SYMBOL_COLOR_DATABASE_TABLE_VIEW              = 180,
   CFG_SYMBOL_COLOR_MODULE                           = 181,
   CFG_SYMBOL_COLOR_CONCEPT                          = 182,
   CFG_SYMBOL_COLOR_RULE                             = 183,
   CFG_SYMBOL_COLOR_ANNOTATION_TYPE                  = 184,
   CFG_SYMBOL_COLOR_ANNOTATION                       = 185,
   CFG_SYMBOL_COLOR_CONTROL                          = 186,
   CFG_SYMBOL_COLOR_MENU                             = 187,
   CFG_SYMBOL_COLOR_FORM                             = 188,
   CFG_SYMBOL_COLOR_EVENT_TABLE                      = 189,
   CFG_SYMBOL_COLOR_PROTECTED_SCOPE                  = 190,
   CFG_SYMBOL_COLOR_PRIVATE_SCOPE                    = 191,

   CFG_SYMBOL_COLOR_PALETTE_00                       = 192,
   CFG_SYMBOL_COLOR_PALETTE_01                       = 193,
   CFG_SYMBOL_COLOR_PALETTE_02                       = 194,
   CFG_SYMBOL_COLOR_PALETTE_03                       = 195,
   CFG_SYMBOL_COLOR_PALETTE_04                       = 196,
   CFG_SYMBOL_COLOR_PALETTE_05                       = 197,
   CFG_SYMBOL_COLOR_PALETTE_06                       = 198,
   CFG_SYMBOL_COLOR_PALETTE_07                       = 199,
   CFG_SYMBOL_COLOR_PALETTE_08                       = 200,
   CFG_SYMBOL_COLOR_PALETTE_09                       = 201,
   CFG_SYMBOL_COLOR_PALETTE_10                       = 202,
   CFG_SYMBOL_COLOR_PALETTE_11                       = 203,
   CFG_SYMBOL_COLOR_PALETTE_12                       = 204,
   CFG_SYMBOL_COLOR_PALETTE_13                       = 205,
   CFG_SYMBOL_COLOR_PALETTE_14                       = 206,
   CFG_SYMBOL_COLOR_PALETTE_15                       = 207,
   CFG_SYMBOL_COLOR_PALETTE_16                       = 208,
   CFG_SYMBOL_COLOR_PALETTE_17                       = 209,
   CFG_SYMBOL_COLOR_PALETTE_18                       = 210,
   CFG_SYMBOL_COLOR_PALETTE_19                       = 211,
   CFG_SYMBOL_COLOR_PALETTE_20                       = 212,
   CFG_SYMBOL_COLOR_PALETTE_21                       = 213,
   CFG_SYMBOL_COLOR_PALETTE_22                       = 214,
   CFG_SYMBOL_COLOR_PALETTE_23                       = 215,
   CFG_SYMBOL_COLOR_PALETTE_24                       = 216,
   CFG_SYMBOL_COLOR_PALETTE_25                       = 217,
   CFG_SYMBOL_COLOR_PALETTE_26                       = 218,
   CFG_SYMBOL_COLOR_PALETTE_27                       = 219,
   CFG_SYMBOL_COLOR_PALETTE_28                       = 220,
   CFG_SYMBOL_COLOR_PALETTE_29                       = 221,
   CFG_SYMBOL_COLOR_PALETTE_30                       = 222,
   CFG_SYMBOL_COLOR_PALETTE_31                       = 223,
   CFG_SYMBOL_COLOR_PALETTE_32                       = 224,
   CFG_SYMBOL_COLOR_PALETTE_33                       = 225,
   CFG_SYMBOL_COLOR_PALETTE_34                       = 226,
   CFG_SYMBOL_COLOR_PALETTE_35                       = 227,
   CFG_SYMBOL_COLOR_PALETTE_36                       = 228,
   CFG_SYMBOL_COLOR_PALETTE_37                       = 229,
   CFG_SYMBOL_COLOR_PALETTE_38                       = 230,
   CFG_SYMBOL_COLOR_PALETTE_39                       = 231,
   CFG_SYMBOL_COLOR_PALETTE_40                       = 232,
   CFG_SYMBOL_COLOR_PALETTE_41                       = 233,
   CFG_SYMBOL_COLOR_PALETTE_42                       = 234,
   CFG_SYMBOL_COLOR_PALETTE_43                       = 235,
   CFG_SYMBOL_COLOR_PALETTE_44                       = 236,
   CFG_SYMBOL_COLOR_PALETTE_45                       = 237,
   CFG_SYMBOL_COLOR_PALETTE_46                       = 238,
   CFG_SYMBOL_COLOR_PALETTE_47                       = 239,
   CFG_SYMBOL_COLOR_PALETTE_48                       = 240,
   CFG_SYMBOL_COLOR_PALETTE_49                       = 241,
   CFG_SYMBOL_COLOR_PALETTE_50                       = 242,
   CFG_SYMBOL_COLOR_PALETTE_51                       = 243,
   CFG_SYMBOL_COLOR_PALETTE_52                       = 244,
   CFG_SYMBOL_COLOR_PALETTE_53                       = 245,
   CFG_SYMBOL_COLOR_PALETTE_54                       = 246,
   CFG_SYMBOL_COLOR_PALETTE_55                       = 247,
   CFG_SYMBOL_COLOR_PALETTE_56                       = 248,
   CFG_SYMBOL_COLOR_PALETTE_57                       = 249,
   CFG_SYMBOL_COLOR_PALETTE_58                       = 250,
   CFG_SYMBOL_COLOR_PALETTE_59                       = 251,
   CFG_SYMBOL_COLOR_PALETTE_60                       = 252,
   CFG_SYMBOL_COLOR_PALETTE_61                       = 253,
   CFG_SYMBOL_COLOR_PALETTE_62                       = 254,
   CFG_SYMBOL_COLOR_PALETTE_63                       = 255,

   // 64-color abstract symbol coloring palette
   CFG_FIRST_SYMBOL_COLOR                            = 128,
   CFG_LAST_SYMBOL_COLOR                             = 255,
 ...
 * <p>
 *
   Tab found at {@code index} was closed.
 *
 * <p>
 *
 * @appliesTo SSTab
...
const F_INHERIT_ALL=F_INHERIT_FG_COLOR|F_INHERIT_BG_COLOR|F_INHERIT_STYLE;
...
/**
 * Name of the current active minimap color scheme.
 * Set to "" to indicate that the minimap should use the 
 * same color profile as the main editor control.
 *
 * @default ""
 * @categories Configuration_Variables
 */
_str def_minimap_color_scheme;
...
/**
 * If enabled, when searching leave the last occurence of search
...
/** 
 * Shift+&lt;cursor key&gt; style.  0 specifies character selection. 
 * 
 * @default '' (true)
 * @categories Configuration_Variables
 * 
 * @note
 * This configuration variables below should have been bool but is not 
 * for backward compatibility with VS user configuration files. 
 * For these strings "0" is false and all other string values are true.
 */
 _str def_scursor_style;

 /**
 * Prompt commands with GET_STRING switch.
 * 
 * @default '' (true)
 * @categories Configuration_Variables
 * 
...
/**
 * If non-zero and text is selected, text is indented.
 * 
 * @default '' (true)
 * @categories Configuration_Variables
 * 
...
/**
 * Set to {@code false} for fast brace matching. 
 *  
 * When set to {@code true}, {@link find_matching_paren()} uses slower paren matching 
...
/**
 * When set to {@code true}, display file, window, and project history information 
 * on menus verbosely as "filename full_path_to/filename" (note the actual file 
 * name part is repeated).  When set to {@code false}, the file history information 
...
_metadata enum_flags CPPTaggingFlags {
   ...
   CTAGS_FLAGS_CPP_NESTED_STRUCT_AS_C           = 0x200,
};
 ...
 * <li><b>0x20</b>  -- Ignore Visual C++ bracketed Attributes in C++ code.
 ...
 * <li><b>0x200</b> -- Treat the scoping of nested structs and unions in C++ as 
 *                     they would be handled in ANSI-C or K&amp;R C (unscoped).</li>
 * </ul>
 *
 * @default 2
...
int _pic_lbuser;         // List Box user-defined item
...
int _pic_symbold_overlay;       // Red file for different symbols
int _pic_symbold2_overlay;      // Blue, different symbol the user has viewed
int _pic_symbolm_overlay;       // Overlay of a minus sign, symbol does not exist
int _pic_symbolp_overlay;       // Overlay of a plus sign.  Symbol only exists in this path
int _pic_symbolmoved_overlay;   // Overlay for moved functions
int _pic_symbol_viewed_overlay; // Overlay for functions that are viewed
...
int _pic_lbvs_star;              // SE shield with a star inside
...
int _pic_otb_overlay_readonly;
int _pic_otb_overlay_writable;
 ...
 *
 * @default {@code true} on Unix, {@code false} otherwise
 * @categories Configuration_Variables
 *
 * @see _autoclipboard
 * @see mou_paste
...
_metadata enum_flags SVCUpdateFlags {
   VCF_AUTO_CHECKOUT,
   VCF_EXIT_CHECKIN,
   VCF_SET_READ_ONLY,
   VCF_PROMPT_TO_ADD_NEW_FILES,
   VCF_PROMPT_TO_REMOVE_DELETED_FILES
}
...
_metadata const VSOPTION_MINIMAP_SHOW_SYMBOL_COLORING  = 130;
_metadata const VSOPTION_DOCUMENT_TABS_SCROLL_FLAGS    = 131;
_metadata const VSOPTION_OPEN_AS_FILE_NOT_WORKSPACE    = 132;
 ...
 */
_metadata enum_flags VSDocumentTabsScrollFlags { 
   VSDOCUMENT_TABS_SWITCH_ON_VERT_SCROLL = 0x01,
   VSDOCUMENT_TABS_SWITCH_ON_HORZ_SCROLL = 0x02,
};
...
const MFFIND_FIND_FILES_MATCH_DIRECTORIES= 0x10000;
const MFFIND_FIND_FILES_EXCLUDE_FILES= 0x20000;


//_grep_file_list flags
const VSGREPFLAG_SORT_FILENAMES=    0x01;
const VSGREPFLAG_EXPAND_WILDCARDS=  0x02;
const VSGREPFLAG_DISPLAY_STATUS=    0x04;
const VSGREPFLAG_LIST_BUFFERS=      0x08; /* FIND or when replace and !DIFF*/
...
const TREENODE_STRIKE_THRU=      0x800;   // node caption is strikethru
...
const MODIFYFLAG_CONTEXT_OVERSIZED=      0x8000000;
...
/**
 * If {@code true}, use memory mapped files for tag databases. 
...
/**
 * If {@code true}, use independent file caches for each tag database, rather 
 ...
 * If {@code false}, it will use the option determined by {@link def_open_style}. 
 *
 * @default true
 * @categories Configuration_Variables 
 */
...
_metadata enum_flags OptionsChangeEventFlags {
   ...
   OCEF_RESET_LANGUAGE_FONTS_AND_COLORS,
   OCEF_NONE = 0x0
};
...
const VSSCC_OK                                =   0;
const VSSCC_E_INITIALIZEFAILED                =  -1;
const VSSCC_E_UNKNOWNPROJECT                  =  -2;
const VSSCC_E_COULDNOTCREATEPROJECT           =  -3;
const VSSCC_E_NOTCHECKEDOUT                   =  -4;
const VSSCC_E_ALREADYCHECKEDOUT               =  -5;
const VSSCC_E_FILEISLOCKED                    =  -6;
const VSSCC_E_FILEOUTEXCLUSIVE                =  -7;
const VSSCC_E_ACCESSFAILURE                   =  -8;
const VSSCC_E_CHECKINCONFLICT                 =  -9;
const VSSCC_E_FILEALREADYEXISTS               =  -10;
const VSSCC_E_FILENOTCONTROLLED               =  -11;
const VSSCC_E_FILEISCHECKEDOUT                =  -12;
const VSSCC_E_NOSPECIFIEDVERSION              =  -13;
const VSSCC_E_OPNOTSUPPORTED                  =  -14;
const VSSCC_E_NONSPECIFICERROR                =  -15;
const VSSCC_E_OPNOTPERFORMED                  =  -16;
const VSSCC_E_TYPENOTSUPPORTED                =  -17;
const VSSCC_E_VERIFYMERGE                     =  -18;
const VSSCC_E_FIXMERGE                        =  -19;
const VSSCC_E_SHELLFAILURE                    =  -20;
const VSSCC_E_INVALIDUSER                     =  -21;
const VSSCC_E_PROJECTALREADYOPEN              =  -22;
const VSSCC_E_PROJSYNTAXERR                   =  -23;
const VSSCC_E_INVALIDFILEPATH                 =  -24;
const VSSCC_E_PROJNOTOPEN                     =  -25;
const VSSCC_E_NOTAUTHORIZED                   =  -26;
const VSSCC_E_FILESYNTAXERR                   =  -27;
const VSSCC_E_FILENOTEXIST                    =  -28;
 ...
 * current context window, Defs tool window, and Symbol tool window 
 * if we have already waited {@link def_update_tagging_idle}, but the 
...
bool _mfMessageListIsActive;

// ProjectPacks defines all the values for a project pack.
bool def_error_check_help_items;

/**
 * Set this to {@code false} to disable all AutoSave and Context Tagging&reg; 
...
_command int begin_select(_str markid="",bool LockSelection=true,bool RestoreScrollPos=false,int persistent_wid=0);
...
void _UpdateSlickCStack(int ignoreNStackItems=0,int errorCode=0,_str DumpFileName="",int timer_handle=-1);
...
struct COMMENT_TYPE {
   ...
   _str features;
   _str start_color;
   _str start_substring_colors;
   _str end_color;
   _str end_substring_colors;
   _str color_to_eol;
...
const VSMARKERTYPEFLAG_SYMBOL_COLORING=            0x800000;
const VSMARKERTYPEFLAG_FONT_BOLD=                  0x1000000;
const VSMARKERTYPEFLAG_FONT_ITALIC=                0x2000000;
const VSMARKERTYPEFLAG_FONT_UNDERLINE=             0x4000000;
const VSMARKERTYPEFLAG_REVERSE_COLOR=              0x8000000;
const VSMARKERTYPEFLAG_FONT_STRIKETHRU=            0x10000000;
...
const VSLANGPROPNAME_TAB_ALIGNS_CURSORS=   "tab_aligns_cursors";
...
const VSLANGPROPNAME_APIHELP_DEFAULT_PROFILE= "apihelp_default_profile";
const VSLANGPROPNAME_COLOR_PROFILE= "color_profile";
const VSLANGPROPNAME_ALT_COLOR_PROFILE= "alt_color_profile";
const VSLANGPROPNAME_ALT_COLOR_FILESPEC= "alt_color_filespec";
const VSLANGPROPNAME_MINIMAP_COLOR_PROFILE= "minimap_color_profile";
const VSLANGPROPNAME_ALT_MINIMAP_COLOR_PROFILE= "alt_minimap_color_profile";
const VSLANGPROPNAME_FONT_INFO= "font";
 ...
 * @param ext                 extension to get value for 
 *  
 * @return                    {@code true} to ignore suffix, {@code false} to treat as 'Plain Text'
 *  
 * @see _ExtensionSetRefersTo 
 *  
 * @categories Configuration_Functions
 ...
 * Note that {@code lang} must be a real language ID, not a 
...
/** 
 * Flags for update svc update dialog 
 */ 
int def_svc_update_flags;
/**
 ...
 *
 * @return {@code true} if Slick-C&reg; debugging was originally enabled,
 ...
 *
 * @param  on_off  {@code true} to turn on profiling;
 *                 {@code false} to turn it off.
 *
 * @return {@code true} if Slick-C&reg; profiling was originally enabled,
 *         {@code false} otherwise.
 *
 * @see profile
 ...
 * 
 * @return Normally will return {@code ms}, but if there is an existing 
 ...
 * 
 * @return {@code true} if the timeout is expired. 
 *  
 * @categories Macro_Programming_Functions
 */
...
/**
 * @return Returns {@code true} if SlickEdit can locate a delta backup for the given file.
 *
 ...
 * @param getMostRecentFilename If true, return the most recent 
 *                           filename, not the archive filename
 * 
 * @return _str Archive filename for <B>Filename</B>.
 */
extern _str DSGetArchiveFilename(_str Filename,bool getMostRecentFilename=false);
/**
...
/**
 * Extract a copy of the file and version specified to the
 * destFilename specified.
 *
 * @param Filename file to extract
 * @param iVersion Version to extract
 * @param destFilename  File contents are written to this
 *                      filename.
 *
 * @return status for this operation.  0 if successful
 */
extern int DSExtractVersionToFile(_str Filename,int iVersion,_str destFilename);
extern int DSExtractMostRecentVersion(_str Filename,int &status,_str AlternatePath="");
extern int DSExtractMostRecentVersionToFile(_str Filename,_str destFilename);
/**
 ...
 * <p>
 * If {@code lang} is not specified, the current object
 ...
 * for {@code ext}, then it will check for language setup information {@code ext}.
...
/**
  * Save window layout {@code state} of MDI form and encode
  * to string. Used by auto-restore. Specify which areas to save 
  * by setting {@code areas} to one or more 
...
/**
  * Restore window layout {@code state} of MDI form 
  * returned from {@code _MDISaveState}. Used by 
  * auto-restore. Specify which areas to restore by setting 
  * {@code areas} to one or more WindowLayoutArea flags. 
  * Set optional {@code flags} to one or more 
  * RestoreStateFlag. 
  *
  * @param state 
  * @param areas 
...
/** 
 * Save layout {@code state} for specified mdi-window 
 * {@code mdi_wid} and return as encoded string. Specify 
 * which areas to restore by setting {@code areas} to one 
...
/**
 * Restore windows from array {@code wids} into specified 
 * mdi window {@code mdi_wid} using layout 
 * {@code state} returned from 
 * {@code _MDIWindowSaveLayout}. Specify which areas to 
 * restore by setting {@code areas} to one or more 
 * WindowLayoutArea flags. Set optional {@code flags} to 
...
/**
 * Append the string {@code ch} (usually a single character) to the end of the given 
 * string if the string does not already end with {@code ch}.  By default, do not 
 * append {@code ch} if the string is initially empty. 
 * 
 * @param text           (reference) string to append to
 * @param ch             character or token to append
 * @param appendIfEmpty  (default false) append {@code ch} if {@code text} is empty 
 *  
...
/**
 * Prepend the string {@code ch} (usually a single character) to the beginning of the 
 * given string if the string does not already start with {@code ch}.  By default, 
 * do not add {@code ch} if the string is initially empty. 
 * 
 * @param text           (reference) string to prepend onto
 * @param ch             character or token to add
 * @param appendIfEmpty  (default false) add {@code ch} if {@code text} is empty 
 *  
 * @categories String_Functions 
 *  
 * @see _maybe_prepend 
...
/**
 * Strip the {@code ch} (usually a single character) from the end of the given 
 ...
 * @param isFileName      is {@code str} a file name or path?
 * @param caseSensitive   is {@code str} case sensitive?  Ignored if {@code isFileName} is true
 * 
 * @categories String_Functions
 */
 ...
 * @param success set to {@code false} if {@code val} is in invalid number 
 * 
 * Binary numbers may start with {@literal 'b'} or {@literal '0b'}. 
 * Hex numbers may start with {@literal '0x'} or {@literal 'x'}. 
 * Octal numbers may start with the digit {@literal '0'}.
 *  
 * A trailing {@literal 'L'} indicates that the number should be treated as a 64-bit integer. 
 * A trailing {@literal 'U'} indicates that the number should be treated as unsigned. 
 * {@literal 'U'} and {@literal 'L'} can be used in combination. 
 *  
 * @see hex2dec 
 * @see _hex2long
 * @categories String_Functions
 ...
 * <ul> 
 *    <li><b>{@literal 'g'}</b> -- scientific notation with base 10 exponent</li>
 *    <li><b>{@literal 'f'}</b> -- floating point notation, no exponent (can be very long)</li>
 *    <li><b>{@literal 'x'}</b> -- hexadecimal floating point notation with base 10 exponent </li>
 * </ul>
 * 
...
const FLMFOFLAG_READONLY=        0x200;
const FLMFOFLAG_WRITABLE=        0x400;
 ...
 * @categories Project_Functions
 */
extern void _clearProjectFileListCache(_str workspaceFile, _str projectFile,bool clearWildcardCache=false);
 ...
 *                               project file.
 * @param force_case_insensitive_matching 
 *                               When true, performace case
 *                               insensitive matching even on
 *                               case sensitive platforms. No
 *                               effect on case insensitive file
 *                               matching platforms.
 *  
...
extern _str _projectFindFile(_str workspaceFile, _str projectFile, _str file, 
                             int checkPath = 1, int returnAll = 0, int matchPathSuffix = 0,bool force_case_insensitive_matching=false);
...
extern void _MSBuildGetCustomView(_str AssociatedFileType, int srcHandle, int destHandle, int filesNode, _str workspaceFilename, _str projectName);
...
// Return the default short cut file text
extern _str _X11Shortcut_GetText();
// Return the destination short cut application filename
extern _str _X11Shortcut_AppFilename();
// Return the destination short cut desktop filename
extern _str _X11Shortcut_DesktopFilename();
// Return the destination Diff short cut application filename
extern _str _X11Shortcut_DiffAppFilename();
// Return the default short cut file text
extern _str _X11Shortcut_DiffGetText();
#endif
...
extern int _IsBinaryModeFile(_str filename, int options = 0);
...
/**
 * Format binary time {@code timeb} according to the 
 * {@code format} specification and return result. Use 
 * <code>_time('B')</code> to get a binary time. 
 *
 * <p>
 *
 * Uses the same conversion-specifiers as the operating system 
 * implementation of {@code strftime}.
 * 
...
/**
 * Return the index of the URL marker type for 
 * stream markers used to display URLs in text. 
 */
int _QURLMarkerType();
...
extern _str _ComboBoxGetPlaceHolderText(int);
 ...
 *               <dl compact>
 *               <dt><b>{@literal 'L'}</b> <dd>find document to left
 *               <dt><b>{@literal 'R'}</b> <dd>find document to right
 *               <dt><b>{@literal 'A'}</b> <dd>find document above
 *               <dt><b>{@literal 'B'}</b> <dd>find document below
 *               <dt><b>{@literal 'N'}</b> <dd>find next document (active or not)
 *               <dt><b>{@literal 'n'}</b> <dd>Same as {@literal 'N'} but non circular
 *               <dt><b>{@literal 'P'}</b> <dd>find previous document (active or not)
 *               <dt><b>{@literal 'p'}</b> <dd>Same as {@literal 'P'} but not circular
 *               <dt><b>{@literal 'C'}</b> <dd>find current document tab within tab group
 *               <dt><b>{@literal '1'}</b> <dd>find next document within tab group
 *               <dt><b>{@literal '2'}</b> <dd>find previous document within tab group
 *               <dt><b>{@literal 'F'}</b> <dd>find first document within tab group
 *               <dt><b>{@literal 'Z'}</b> <dd>find last document within tab group
 *               <dt><b>{@literal 'G'}</b> <dd>find next tab group
 *               <dt><b>{@literal 'H'}</b> <dd>find previous tab group
 *               <dt><b>{@literal 'g'}</b> <dd>Same as {@literal 'G'} but not circular
 *               <dt><b>{@literal 'h'}</b> <dd>Same as {@literal 'H'} but not circular
 *               </dl>
 * @param move_or_close
 ...
 *    <dl compact>
 *    <dt><b>{@literal 'B'}</b> <dd>Basic group info. tabInfo array not filled in
 *    <dt><b>{@literal 'A'}</b> <dd>All info. Fill in tabInfo array
 *    </dl>
 */
 ...
 * {@code window_list}. Set <code>includeHidden=true</code> 
...
enum_flags FileRegexSyntax {
   /**
      Default search syntax is ant-like but
      is slightly different for Windows and Unix/macOS.

      On all platforms, *, **, and ? have the same ant-like special meaning.
      On Windows, a trailing *. matches a filename with no extension.
      On Unix & macOS, a character set [...] can be used to match a set of characters
      On Unix & macOS, a backslash can be used to specify a literal character (like \*, \[ etc.)
   */
   FILEREGEXSYNTAX_DEFAULT=0,
   /**
    * SlickEdit regex syntax. Note that a small amount of processing is done to modify your
    * specified regex like put '^' at the beginning if necessary and $ at the end. This way,
    * you can easily convert an ant-like pattern to this syntax.
    *
    *  Example:
    *     **&sol;*.cpp   --> \o**&sol;\o*.cpp
    *  
    * Notice how you simple translate the ant syntax "**" to "\o**" to convert and ant-like
    * pattern to SlickEdit regex syntax. Also, note that you don't need to use "^" in the front and 
    * "$" at the end. 
    *  
    * \o*, \o** \o**&sol; and ? have the same ant-like special  meaning as *, ** , **&sol;, 
    *                       and ? respectively. 
    * [...]                 Specifies a set of characters to match.
    * (str1|str2|str3, ...) SlickEdit regex syntax for the EditorConfig pattern {str1,str2,str3, ...}
    * \or{num1..num2}  Matches any integer numbers between num1 and num2, where num1 and num2 can be either positive or negative
   */
   FILEREGEXSYNTAX_REGEX=1,
   /**
      Editor config syntax is the same for all platforms.

      *, **, **&sol;, and ? have the same ant-like special meaning.
      [...] specifies a sets of characters to match
      {str1,str2,str3, ...} Is a match if any of the strings specified match. Strings may contain wildcards.
      {num1..num2}  Matches any integer numbers between num1 and num2, where num1 and num2 can be either positive or negative
   */
   FILEREGEXSYNTAX_EDITORCONFIG=2,
};

extern bool _FileRegexMatchName(_str wildcards,_str name,FileRegexSyntax syntax=FILEREGEXSYNTAX_DEFAULT);
extern bool _FileRegexMatchPath(_str wildcards,_str filename, bool SeparateWildcardPath=false,FileRegexSyntax syntax=FILEREGEXSYNTAX_DEFAULT);
extern bool _FileRegexMatchExcludePath(_str wildcards, _str filename,FileRegexSyntax syntax=FILEREGEXSYNTAX_DEFAULT);
extern bool _FileRegexMatchExcludeName(_str wildcards, _str filename,FileRegexSyntax syntax=FILEREGEXSYNTAX_DEFAULT);
/**
 * Perform regex substitions on last file regex match.
 *  
 * Only call this function after a match from  _FileRegexMatchName 
 * or _FileRegexMatchPath. Be sure to use the FILEREGEXSYNTAX_REGEX 
 * syntax if you want to specify a tagged expression. 
 * 
 * @param replaceString  (input and output) Replace string with SlickEdit syntax match groups specified. 
 *                       SlickEdit regex syntax escape sequences are supported.
 */
extern void _FileRegexReplace(_str &replaceString);
...
extern int _grep_file_list(int list_wid, int grep_flags/*=VSGREPFLAG_DISPLAY_STATUS|VSGREPFLAG_LIST_BUFFERS*/, int NofThreads,VSGREP_ARGS &grep_args, long &NofFilesSearched);
/**
...
extern void _ProjectWriteCacheState(_str workspaceFile,_str workspaceStateFile);
extern void _ProjectReadCacheState(_str workspaceFile,_str workspaceStateFile);
/** 
 * Determines whether a timer was stopped due to a Slick-C 
 * stack. 
 *  
 * Timers are stopped (not freed) when a Slick-C stack occurs 
 * durring a timer event. Previous version (prior to v26) 
 * without this function freed the timer. 
 *  
 * @return Returns true if the timer was stopped due to a 
 *         Slick-C stack.
 */
extern bool _timer_is_stopped(int timer_handle);
/**
 * Returns and potentially allocates a persistent wid for the
 * window. 
 *  
 * <p>The persistent wid is stored in p_persistent_wid. 
 ...
 * file when possible. 
 * 
 * @return int  Returns a valid persistent wid.
 */
extern int _get_persistent_wid();

/**
 * Returns instance id for this editor
 *  
 * <p>See -sid invocation option.
 * 
 * @return _str instance id for this editor
 */
extern _str _InstanceId();
/**
 * Returns list of instance data excluding current instance. 
 *  
 * <p>Each info entry in the array looks like this: 
 *  
 * process_id  "instance_id" .
 *  
 * The instance is not always double quoted.
 * 
 * @param instance_info_list 
 *     Set to array of instance info excluding current instance.
 *     Most recent instance info is first.
 * 
 */
extern void _InstanceGetList(_str &instance_info_list);

/**
 * Fast searching for line flags.
 * 
 * @param match_flags            Line flags to match.
 * @param skip_flags             Line flags to skip
 * @param direction              >0 means search forward. 
 *                               <0 means search backward.
 * @param match_first_line       Determines whether to check the
 *                               current line for a match.
 * @param search_within_selection Determines whether to only 
 *                                search within the current
 *                                selection.
 * 
 * @return int   Returns 0 if match found. Other wise 
 *         STRING_NOT_FOUND_RC is returned.
 */
extern int _FindLineFlags(long match_flags, long skip_flags,int direction=1, bool match_first_line=true,bool search_within_selection=false);

/**
 * Given a string of bytes representing a character, tests 
 * whether the character is an alphabetic character. 
 * 
 * @param ch - string of bytes    
 * 
 * @return bool 
 * @example
 * <pre>
 *    ch := get_text(-1)
 *    if (_UTF8IsAlpha(ch)) say("alpha!");
 * </pre>
 */
extern bool _UTF8IsAlpha(_str ch);

extern void _bgm_filter_project_files(int wid,_str wildcards, _str file_exclude);

/**
 * Used to cache the list of visible document windows. 
 *  
 * @see _GetVisibleFileTabs 
 * @see _ResetVisibleFileTabs
 * @see _DoCallbackForAllVisibleTabs 
 * @see _RemoveVisibleFileTab 
 */
struct VisibleTabsCache {
   /**
    * Do minimal work?
    */
   bool tab_minimal_work;

   /**
    * Last list of visible document tabs retrieved.
    */
   int gvisible_tabs[];
   /**
    * Last full list of editor windows retrieved.
    */
   int gother_tabs[];

   /**
    * Keeps track of our index in the visible tab list 
    */
   int visible_tab_iter;
   /**
    * Keeps track of if we are doing minimap work 
    */
   int other_tab_iter;
};
