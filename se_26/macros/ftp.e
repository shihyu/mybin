...
/**
 * Fetch flags for tree item at {@code index}. Active
 * window must be a {@code _tree_view}.
 *
 * @param index 
 ...
 * filenames by {@code type}, and ascending/descending 
 * order via {@code sort_flags}, using 
 ...
 * <p>
 *
 * Active window must be a {@code _tree_view}.
 *
...
/**
 * Fetch sort flags for tree column {@code col}. Active 
 * window must be a {@code _tree_view}. 
 * 
 * @param col 
 * 
...
/**
 * Set sort {@code flags} for tree column {@code col}.
 * Active window must be a {@code _tree_view}. 
 * 
 * @param col 
...
/**
 * Add {@code file} item to remote tree control as child of
 * TREE_ROOT_INDEX.
 *
 * <p>
 *
 * {@code name_sort_flags} are used to set sorting hints 
 ...
 * <p>
 *
 * {@code size_sort_flags} are used to set sorting hints
 ...
 * <p>
 *
 * {@code modified_sort_flags} are used to set sorting
 ...
 * <p>
 *
 * {@code attribs_sort_flags} are used to set sorting hints
