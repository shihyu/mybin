...
defmain()
{
   ...
   if ( def_alt_menu ) {
      ...
      // Remove this for Ve&rsion Control, will have to add some back in
      set_eventtab_index(_default_keys,event2index(A_R),0);
      set_eventtab_index(_default_keys,event2index(name2event('M-R')),0);
      ...
      execute('bind-to-key -r gui-insert-file 'event2index(A_R),"");
      execute('bind-to-key -r gui-insert-file 'event2index(name2event('M-R')),"");
      if (def_gui) {
      ...
      execute('bind-to-key -r root-keydef 'event2index(A_R),"");
      execute('bind-to-key -r root-keydef 'event2index(name2event('M-R')),"");
#if USE_B_FOR_BUILD
      ...
      execute('bind-to-key -r config 'event2index(A_P),"");
      execute('bind-to-key -r config 'event2index(name2event('M-P')),"");
      execute('bind-to-key -r move-window-line 'event2index(A_R),"");
      execute('bind-to-key -r move-window-line 'event2index(name2event('M-R')),"");
#if USE_B_FOR_BUILD
      execute('bind-to-key -r prev_word 'event2index(A_B),"");
      execute('bind-to-key -r prev_word 'event2index(name2event('M-B')),"");
#endif
      ...
      execute('bind-to-key -r select_paragraph 'event2index(A_H),"");
      execute('bind-to-key -r select_paragraph 'event2index(name2event('M-H')),"");
   } else if ( def_keys=='vcpp-keys' ) {
      execute('bind-to-key -r root-keydef 'event2index(A_R),"");
      execute('bind-to-key -r root-keydef 'event2index(name2event('M-R')),"");
   } else if ( def_keys=='vsnet-keys' ) {
      execute('bind-to-key -r root-keydef 'event2index(A_R),"");
      execute('bind-to-key -r root-keydef 'event2index(name2event('M-R')),"");
