...
/**
 * Load a dock channel on a docking {@code area}. 
 *
...
/**
 * Get dock channel wid for a docking {@code area}. 
 *
 ...
 * {@code area}. Geometry of dock-channel is stored in 
 ...
 * {@code area}. Geometry of dock-palette is stored in 
 * <code>(x,y)-(width,height)</code> <b>relative to the MDI 
 * frame</b>. 
 *
 * @param area  One of DOCKINGAREA_* constants. 
