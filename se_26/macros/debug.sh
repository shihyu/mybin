 ...
 * 
 * @return {@code true} if the disassembly is to be displayed, {@code false} if not, &lt;0 on error.
 * 
 * @categories Debugger_Functions
 */
 ...
 * @param reply            command reply data
 * @param errmsg           output skimmed from stderr
 * @param parse_reply      If false, {@code reply} is a string,
 ...
 *
 * @param i          index of runtime expr to get, first index is {@literal 1}
...
/**
 * @return 
 * Returns {@code true} if the given number base option applies to the given data type. 
 * 
