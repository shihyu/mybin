...
ctlfixedfonts.lbutton_up()
{
   ...
   before := "";
   after := "";
   parse upcase(options) with before 'F' after;
...
void _font_form.on_resize()
{
   ...
   minHeight := borderY + frame1.p_height + 
                borderY + ctlfixedfonts.p_height +
                borderY + (frame1.p_height intdiv 2) + /* in place of sample height */
                borderY + _ok.p_height +
                borderY;
   ...
   // height distribution
   buttonY := clientHeight - borderY - _ok.p_height;
