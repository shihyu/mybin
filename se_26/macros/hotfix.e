 ...
 */
int hotfixFindAll(_str path, _str (&fix_list)[], int infoFlags, bool findAllHotfixes=false, bool checkIfApplied=false)
{
...
_command void create_hotfix(_str files="") name_info(MULTI_FILE_ARG','VSARG2_NCW|VSARG2_READ_ONLY)
{
   ...
   format_list := 'Slick-C Files(*.e;*.sh),Macro Files (*.e),Macro Headers(*.sh),All Files ('ALLFILES_RE')';
   if (files == "") {
