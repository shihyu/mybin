...
static _str _c_type_conversions:[]:[] = {
   ...
   "c" => {
      ...
      // new signed integer types in C++11
      "int8_t"                 => ":int:signed:signed int:signed char:char:",
      "int16_t"                => ":int:signed:signed int:signed short:short:",
      "int32_t"                => ":int:signed:signed int:signed long:long:",
      "int64_t"                => ":int:signed:signed int:signed long long:long long:",
      "int_fast8_t"            => ":int:signed:signed int:signed char:char:",
      "int_fast16_t"           => ":int:signed:signed int:signed short:short:",
      "int_fast32_t"           => ":int:signed:signed int:signed long:long:",
      "int_fast64_t"           => ":int:signed:signed int:signed long long:long long:",
      "int_least8_t"           => ":int:signed:signed int:signed char:char:",
      "int_least16_t"          => ":int:signed:signed int:signed short:short:",
      "int_least32_t"          => ":int:signed:signed int:signed long:long:",
      "int_least64_t"          => ":int:signed:signed int:signed long long:long long:",
      ...
      "intmax_t"               => ":int64_t:long long:ssize_t:",
      // new unsigned integer types in C++11
      "uint8_t"                => ":unsigned:unsigned int:unsigned char:byte:",
      "uint16_t"               => ":unsigned:unsigned int:unsigned short:",
      "uint32_t"               => ":unsigned:unsigned int:unsigned long:",
      "uint64_t"               => ":unsigned:unsigned int:unsigned long long:",
      "uint_fast8_t"           => ":unsigned:unsigend int:unsigned char:byte:",
      "uint_fast16_t"          => ":unsigned:unsigend int:unsigned short:",
      "uint_fast32_t"          => ":unsigned:unsigend int:unsigned long:",
      "uint_fast64_t"          => ":unsigned:unsigend int:unsigned long long:",
      "uint_least8_t"          => ":unsigned:unsigned int:unsigned char:byte:",
      "uint_least16_t"         => ":unsigned:unsigned int:unsigned short:",
      "uint_least32_t"         => ":unsigned:unsigned int:unsigned long:",
      "uint_least64_t"         => ":unsigned:unsigned int:unsigned long long:",
      "uintptr_t"               => ":unsigned:unsigned int:unsigned long:unsigned long int:unsigned long long:unsigned long long int:size_t:ssize_t:intptr_t:",
      "uintmax_t"               => ":uint64_t:unsigned long long:size_t:",
   },
   ...
   "cs" => {
      ...
      "int"                => ":dynamic:char:sbyte:byte:short:ushort:int:nint:",
      "uint"               => ":dynamic:char:ubyte:byte:ushort:uint:nuint:",
      "nint"               => ":dynamic:char:sbyte:byte:short:ushort:int:",
      "nuint"              => ":dynamic:char:ubyte:byte:ushort:uint:",
      "long"               => ":dynamic:char:sbyte:byte:short:ushort:int:uint:long:",
      "ulong"              => ":dynamic:char:ubyte:byte:ushort:uint:ulong:nuint:",
      "char"               => ":dynamic:char:",
      "float"              => ":dynamic:char:sbyte:byte:ubyte:short:ushort:int:uint:nint:nuint:long:ulong:float:",
      "double"             => ":dynamic:char:sbyte:byte:ubyte:short:ushort:int:uint:nint:nuint:long:ulong:float:double:",
      "decimal"            => ":dynamic:char:sbyte:byte:ubyte:short:ushort:int:uint:nint:nuint:long:ulong:",
      "object"             => ":dynamic:char:sbyte:byte:ubyte:short:ushort:int:uint:nint:nuint:long:ulong:float:double:object:",
...
static _str _e_int_control_names:[] = {
   ...
   "editor_wid"            => "_sc_lang_editor",
   "target_wid"            => "_sc_lang_editor",
   "child_wid"             => "_sc_lang_editor",
...
_str _e_get_control_name_type(_str builtin_type, _str symbol)
{
   ...
   // check list of common variable names for controls with "m_"
   if (builtin_type=="int" && beginsWith(symbol, "m_", strict:true) && _e_int_control_names._indexin(substr(symbol, 3))) {
      return _e_int_control_names:[substr(symbol, 3)];
   }
   ...
   */
   ...
   if (prefixexp == "" && candidate_cm.type_name=="enumc") {
      ...
      if (outer_name!="" && pos(outer_name, cur_context) != 1) {
         class_sep := (_LanguageInheritsFrom("java") || _LanguageInheritsFrom("cs") || _LanguageInheritsFrom("d") || _LanguageInheritsFrom("dart"))? "." : "::";
                                ...
                                struct VS_TAG_RETURN_TYPE (&visited):[]=null, int depth=0)
{
   ...
   if (rt_expected.pointer_count > 0) {
      ...
      if (!_c_is_builtin_type(rt_expected.return_type) && _LanguageInheritsFrom("c") && !_LanguageInheritsFrom("ansic")) {
         ...
         if (_LanguageInheritsFrom("java") || _LanguageInheritsFrom("cs" || _LanguageInheritsFrom("rs") || _LanguageInheritsFrom("dart"))) {
            class_name = stranslate(class_name,".",VS_TAGSEPARATOR_class);
   ...
   if (_LanguageInheritsFrom("c") && !_LanguageInheritsFrom("d")) {
      if (rt_expected.return_type=="int"                    ||
          ...
          rt_expected.return_type=="int8_t"                 ||
          rt_expected.return_type=="int16_t"                ||
          rt_expected.return_type=="int32_t"                ||
          rt_expected.return_type=="int64_t"                ||
          rt_expected.return_type=="int_fast8_t"            ||
          rt_expected.return_type=="int_fast16_t"           ||
          rt_expected.return_type=="int_fast32_t"           ||
          rt_expected.return_type=="int_fast64_t"           ||
          rt_expected.return_type=="int_least8_t"           ||
          rt_expected.return_type=="int_least16_t"          ||
          rt_expected.return_type=="int_least32_t"          ||
          rt_expected.return_type=="int_least64_t"          ||
          rt_expected.return_type=="intptr_t"               ||
          rt_expected.return_type=="intmax_t"               ||
          rt_expected.return_type=="uint8_t"                ||
          rt_expected.return_type=="uint16_t"               ||
          rt_expected.return_type=="uint32_t"               ||
          rt_expected.return_type=="uint64_t"               ||
          rt_expected.return_type=="uint_fast8_t"           ||
          rt_expected.return_type=="uint_fast16_t"          ||
          rt_expected.return_type=="uint_fast32_t"          ||
          rt_expected.return_type=="uint_fast64_t"          ||
          rt_expected.return_type=="uint_least8_t"          ||
          rt_expected.return_type=="uint_least16_t"         ||
          rt_expected.return_type=="uint_least32_t"         ||
          rt_expected.return_type=="uint_least64_t"         ||
          rt_expected.return_type=="uintptr_t"              ||
          rt_expected.return_type=="uintmax_t"              ||
          false ) {
                 ...
                 _str options = "")
{
   ...
   class_sep := (is_java || lang=="e" || lang=="d" || lang=="dart")? ".":"::";
   return_type := "";
   result := "";
   initial_value := "";
   before_return := "";
   ...
   case "staticselector":
      ...
      if (verbose) {
         if (in_class_def && (tag_flags & SE_TAG_FLAG_FACTORY)) {
            strappend(before_return,"factory ");
         } else if (in_class_def && (tag_flags & SE_TAG_FLAG_STATIC)) {
         ...
         if (tag_flags & SE_TAG_FLAG_LATE) {
            strappend(before_return,"late ");
         }
      } else if (show_static) {
      ...
      if (tag_flags & SE_TAG_FLAG_ASYNCHRONOUS && !is_java) {
         strappend(after_sig," async");
      }
      if (verbose) {
...
int _c_get_type_of_constant(_str ch, struct VS_TAG_RETURN_TYPE &rt, int depth=0)
{
   ...
   if (_LanguageInheritsFrom("e")) {
      ...
      if (pos(":q", ch, 1, "r") == 1) {
         rt.return_type = "_sc_lang_string";
         if (_chdebug) {
            isay(depth, "_c_get_type_of_constant: Slick-C quoted string, rt="rt.return_type);
         }
         return 0;
      }   
   } else if (_LanguageInheritsFrom("dart")) {
      // In Dart there are only string literals and then can have either single or double quotes
      if (pos(":q", ch, 1, "r") == 1) {
         rt.return_type = "dart/core/String";
         if (_chdebug) {
            isay(depth, "_c_get_type_of_constant: Dart quoted string, rt="rt.return_type);
         }
         return 0;
      }   
   } else {
...
bool _c_is_type_inferred(_str return_type, bool &add_const=true)
{
   ...
   // type inference only supported for C++, Slick-C, C#, Dart, Java, Groovy, and Rust.
   if (!_LanguageInheritsFrom("c") && 
       !_LanguageInheritsFrom("e") && 
       !_LanguageInheritsFrom("cs") &&
       !_LanguageInheritsFrom("java") &&
       !_LanguageInheritsFrom("dart") && 
   ...
   while (return_type != "") {
      ...
      if ((_LanguageInheritsFrom("cs") || _LanguageInheritsFrom("java") || _LanguageInheritsFrom("dart")) &&
                                 ...
                                 VS_TAG_RETURN_TYPE (&visited):[], int depth=0)
{
   if (_chdebug) {
      ...
      isay(depth,"_c_substitute_template_args: template_file="template_file" tempalte_line_no="template_line_no);
      ...
      if (i < template_parms._length() && template_parms[i] != "") {
         ...
         if (template_parms[i] != "") {
            ...
            if (template_file_name != "") {
               inmem := false;
               temp_view_status = _open_temp_view(template_file_name,
                                                  temp_view_id, orig_view_id,
                                                  "", inmem,
                                                  doClear:false,
                                                  doSelectEditorLanguage:true);
               if (!temp_view_status) {
                  rt_arg.filename = p_buf_name;
                  if (template_line_no > 0) {
                     rt_arg.line_number = template_line_no;
                     p_RLine = template_line_no;
                     _first_non_blank();
                  }
