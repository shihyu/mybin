...
const SVC_ROOT_PATH_CAPTION=     "Root Path: ";
const SVC_UNSHELVE_PATH_CAPTION= "Unshelve to: ";
const SVC_SHELF_COMMENT_CAPTION= "Comment: ";
const SVC_SHELF_LOCALROOT_CAPTION= "Shelf root: ";
const SVC_LOCAL_ROOT_LABEL=      "Local Path: ";

const SVC_DEFAULT_SYSTEM =      "Git";
...
_metadata enum_flags SVCUpdateFlags {
   SVC_UPDATE_AUTO_CLOSE                     = 0x1,
   SVC_UPDATE_AUTO_JUMP                      = 0x2,
   SVC_UPDATE_NO_AUTO_BINARY_COMPARE         = 0x4,
   SVC_UPDATE_AUTO_PROMPT_TO_SAVE_ON_JUMP    = 0x8,
   SVC_UPDATE_PROMPT_TO_SAVE_ON_CHANGE       = 0x10,
};

struct SVC_UPDATE_DIFF_INFO {
   int treeWID;
   int index;
   int bmindex1;
   int dataWID;
