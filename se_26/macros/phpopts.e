...
{
   format_list:=_file_types_get_filter_by_name(def_file_types, 'HTML Files');
   wildcards:=_file_types_get_wildcards_by_name(def_file_types, 'HTML Files');
   if( format_list == "" ) {
      // Fall back
      format_list = "HTML Files (*.htm;*.html;*.shtml;*.asp;*.jsp;*.php;*.php3;*.rhtml;*.css)";
      wildcards = "*.htm;*.html;*.shtml;*.asp;*.jsp;*.php;*.php3;*.rhtml;*.css";
   }
