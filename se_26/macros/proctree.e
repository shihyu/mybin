                               ...
                               bool ForceUpdate=false)
{
   ...
   if ( findCurrentProc && _TreeGetFirstChildIndex(index)>=0 ) {
      ...
      if (AlwaysUpdate || (child_wid.p_LastModified!=formInfo.m_RLine_LastModified) || formInfo.m_RLine!=EditorLN) {
         ...
         if (isOutlineViewActive(child_wid,ForceUpdate) == false) {
            ...
            if (doStatementTagging) {
               ...
               nearest_id = tag_nearest_statement(EditorLN, def_proctree_flags, find_tag_below:false);
            ...
            if (current_id != nearest_id && _in_comment()) {
               ...
               if (doStatementTagging) {
                  nearest_id = tag_nearest_statement(EditorLN, def_proctree_flags, find_tag_below:true);
               }
...
void _proc_tree.rbutton_up,context()
{
