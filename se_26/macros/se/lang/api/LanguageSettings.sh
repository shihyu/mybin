...
const FIXED_WIDTH_RIGHT_MARGIN_SHORT_KEY              = 'FWRM';
const FIXED_WIDTH_RIGHT_MARGIN_UPDATE_KEY             = VSLANGPROPNAME_FIXED_WIDTH_RIGHT_MARGIN;

const COLOR_PROFILE_SHORT_KEY                          = 'COLOR';
const COLOR_PROFILE_UPDATE_KEY                         = VSLANGPROPNAME_COLOR_PROFILE;
const MINIMAP_COLOR_PROFILE_SHORT_KEY                  = 'MAPCOLOR';
const MINIMAP_COLOR_PROFILE_UPDATE_KEY                 = VSLANGPROPNAME_MINIMAP_COLOR_PROFILE;
const ALT_COLOR_PROFILE_SHORT_KEY                      = 'ALTCOLOR';
const ALT_COLOR_PROFILE_UPDATE_KEY                     = VSLANGPROPNAME_ALT_COLOR_PROFILE;
const ALT_MINIMAP_COLOR_PROFILE_SHORT_KEY              = 'ALTMAPCOLOR';
const ALT_MINIMAP_COLOR_PROFILE_UPDATE_KEY             = VSLANGPROPNAME_ALT_MINIMAP_COLOR_PROFILE;
const ALT_COLOR_FILESPEC_SHORT_KEY                     = 'ALTCOLOREXTS';
const ALT_COLOR_FILESPEC_UPDATE_KEY                    = VSLANGPROPNAME_ALT_COLOR_FILESPEC;

const UNICODE_FONT_INFO_SHORT_KEY                     = 'UFONT';
const UNICODE_FONT_INFO_UPDATE_KEY                    = 'unicode_editor_':+VSLANGPROPNAME_FONT_INFO;
const UNICODE_DIFF_FONT_INFO_SHORT_KEY                = 'UDIFFFONT';
const UNICODE_DIFF_FONT_INFO_UPDATE_KEY               = 'unicode_diff_':+VSLANGPROPNAME_FONT_INFO;
const UNICODE_MINIMAP_FONT_INFO_SHORT_KEY             = 'UMFONT';
const UNICODE_MINIMAP_FONT_INFO_UPDATE_KEY            = 'unicode_minimap_':+VSLANGPROPNAME_FONT_INFO;
