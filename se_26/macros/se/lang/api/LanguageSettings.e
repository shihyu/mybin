...
class LanguageSettings {
   ...
   /**
    * Returns true if the tab key should align multiple cursors
    * to the same right-most tab stop when not in leading white-space.
    * 
    * @param langID        Language id
    * @param defaultValue  Default value to use if the setting does not exist.
    * 
    * @return bool True if the setting is enabled.
    */
   public static bool getTabAlignsCursors(_str langID, bool defaultValue=true)
   {
      return _LangGetPropertyBool(langID, VSLANGPROPNAME_TAB_ALIGNS_CURSORS, defaultValue);
   }
   /**
    * Setting that controls whether the tab key should align multiple cursors 
    * to the same right-most tab stop when not in leading white-space.
    * 
    * @param langID  Language id
    * @param value   True to enable the setting.
    */
   public static void setTabAlignsCursors(_str langID, bool value)
   {
      _LangSetProperty(langID, VSLANGPROPNAME_TAB_ALIGNS_CURSORS, value);
   }
   ...
   /**
    * Gets the default color scheme name for this language. 
    * This value is available on the GUI on the Appearance form for each applicable language. 
    * 
    * @param langID              language ID (see {@link p_LangId})
    * @param defaultValue        if the value is not available, then we just return this value.
    * 
    * @return                    color scheme configured for this language
    *  
    * @categories LanguageSettings_API 
    */
   public static _str getColorProfile(_str langID, _str defaultValue = '')
   {
      return _LangGetProperty(langID,VSLANGPROPNAME_COLOR_PROFILE,defaultValue);
   }

   /**
    * Sets the default color scheme name for this language. 
    * This value is available on the GUI on the Appearance form for each applicable language. 
    * 
    * @param langID              language ID (see {@link p_LangId})
    * @param value               new value
    ...
    * @categories LanguageSettings_API 
    */
   public static void setColorProfile(_str langID, _str value)
   {
      _LangSetProperty(langID,VSLANGPROPNAME_COLOR_PROFILE,value);
   }

   /**
    * Gets the alternate color scheme name for this language. 
    * This value is available on the GUI on the Appearance form for each applicable language. 
    * 
    * @param langID              language ID (see {@link p_LangId})
    * @param defaultValue        if the value is not available, then we just return this value.
    * 
    * @return                    alternate color scheme configured for this language
    *  
    * @categories LanguageSettings_API 
    */
   public static _str getAltColorProfile(_str langID, _str defaultValue = '')
   {
      return _LangGetProperty(langID,VSLANGPROPNAME_ALT_COLOR_PROFILE,defaultValue);
   }

   /**
    * Sets the alternate color scheme name for this language. 
    * This value is available on the GUI on the Appearance form for each applicable language. 
    * 
    * @param langID              language ID (see {@link p_LangId})
    * @param value               new value
    ...
    * @categories LanguageSettings_API 
    */
   public static void setAltColorProfile(_str langID, _str value)
   {
      _LangSetProperty(langID,VSLANGPROPNAME_ALT_COLOR_PROFILE,value);
   }

   /**
    * Gets the minimap color scheme name for this language. 
    * This value is available on the GUI on the Appearance form for each applicable language. 
    * 
    * @param langID              language ID (see {@link p_LangId})
    * @param defaultValue        if the value is not available, then we just return this value.
    * 
    * @return                    Minimap color scheme configured for this language
    *  
    * @categories LanguageSettings_API 
    */
   public static _str getMinimapColorProfile(_str langID, _str defaultValue = '')
   {
      return _LangGetProperty(langID,VSLANGPROPNAME_MINIMAP_COLOR_PROFILE,defaultValue);
   }

   /**
    * Sets the minimap color scheme name for this language. 
    * This value is available on the GUI on the Appearance form for each applicable language. 
    * 
    * @param langID              language ID (see {@link p_LangId})
    * @param value               new value
    ...
    * @categories LanguageSettings_API 
    */
   public static void setMinimapColorProfile(_str langID, _str value)
   {
      _LangSetProperty(langID,VSLANGPROPNAME_MINIMAP_COLOR_PROFILE,value);
   }

   /**
    * Gets the alternate minimap color scheme name for this language. 
    * This value is available on the GUI on the Appearance form for each applicable language. 
    * 
    * @param langID              language ID (see {@link p_LangId})
    * @param defaultValue        if the value is not available, then we just return this value.
    * 
    * @return                    Alternate minimap color scheme configured for this language
    *  
    * @categories LanguageSettings_API 
    */
   public static _str getAltMinimapColorProfile(_str langID, _str defaultValue = '')
   {
      return _LangGetProperty(langID,VSLANGPROPNAME_ALT_MINIMAP_COLOR_PROFILE,defaultValue);
   }

   /**
    * Sets the alternate minimap color scheme name for this language. 
    * This value is available on the GUI on the Appearance form for each applicable language. 
    * 
    * @param langID              language ID (see {@link p_LangId})
    * @param value               new value
    ...
    * @categories LanguageSettings_API 
    */
   public static void setAltMinimapColorProfile(_str langID, _str value)
   {
      _LangSetProperty(langID,VSLANGPROPNAME_ALT_MINIMAP_COLOR_PROFILE,value);
   }

   /**
    * Gets the alternate color scheme file specification for this language. 
    * This value is available on the GUI on the Appearance form for each applicable language. 
    * 
    * @param langID              language ID (see {@link p_LangId})
    * @param defaultValue        if the value is not available, then we just return this value.
    * 
    * @return                    alternate color scheme file specification configured for this language
    *  
    * @categories LanguageSettings_API 
    */
   public static _str getAltColorFileSpec(_str langID, _str defaultValue = '')
   {
      return _LangGetProperty(langID,VSLANGPROPNAME_ALT_COLOR_FILESPEC,defaultValue);
   }

   /**
    * Sets the alternate color scheme file specification for this language. 
    * This value is available on the GUI on the Appearance form for each applicable language. 
    * 
    * @param langID              language ID (see {@link p_LangId})
    * @param value               new value
    ...
    * @categories LanguageSettings_API 
    */
   public static void setAltColorFileSpec(_str langID, _str value)
   {
      _LangSetProperty(langID,VSLANGPROPNAME_ALT_COLOR_FILESPEC,value);
   }

   /** 
    * Language-specific font settings are only for Unicode editor fonts. 
    * Translate SBCS/DBCS font configuration items to the corresponding unicode 
    * item here.  There is no language-specific settings for HEX or File manager 
    * modes. 
   */
   protected static int translateFontCFGElement(int cfg)
   {
      switch (cfg) {
      ...
      case CFG_SBCS_DBCS_SOURCE_WINDOW:
         return CFG_UNICODE_SOURCE_WINDOW;
      case CFG_DIFF_EDITOR_WINDOW:
         return CFG_UNICODE_DIFF_EDITOR_WINDOW;
      case CFG_SBCS_DBCS_MINIMAP_WINDOW:
         return CFG_UNICODE_MINIMAP_WINDOW;
   ...
   /**
    * Gets the default font information for this language and editor mode. 
    * This value is available on the GUI on the Appearance form for each applicable language. 
    * 
    * @param langID              language ID (see {@link p_LangId}) 
    * @param cfg                 VSCFG_* constant, one of: 
    *                            <ul> 
    *                            <li>CFG_UNICODE_SOURCE_WINDOW
    *                            <li>CFG_SBCS_DBCS_SOURCE_WINDOW
    *                            <li>CFG_DIFF_EDITOR_WINDOW
    *                            <li>CFG_UNICODE_DIFF_EDITOR_WINDOW
    *                            <li>CFG_SBCS_DBCS_MINIMAP_WINDOW
    *                            <li>CFG_UNICODE_MINIMAP_WINDOW
    *                            </ul>
    * @param defaultValue        if the value is not available, then we just return this value.
    * 
    * @return                    font information for given language and editor mode
    *  
    * @note 
    * Language-specific font settings are only for Unicode editor, diff, and minimap fonts. 
    *  
    * @categories LanguageSettings_API 
    */
   public static _str getFontInfo(_str langID, int cfg, _str defaultValue = '')
   {
      cfg = translateFontCFGElement(cfg);
      if (cfg == CFG_NULL) return defaultValue;
      return _LangGetProperty(langID,_FontElementIdToNameId(cfg):+"_":+VSLANGPROPNAME_FONT_INFO,defaultValue);
   }

   /**
    * Sets the default font information for this language and mode. 
    * This value is available on the GUI on the Appearance form for each applicable language. 
    * 
    * @param langID              language ID (see {@link p_LangId})
    * @param cfg                 VSCFG_* constant, one of: 
    ...
    * @categories LanguageSettings_API 
    */
   public static void setFontInfo(_str langID, int cfg, _str font_name, _str font_size='', int font_flags=0, _str charset='')
   {
      cfg = translateFontCFGElement(cfg);
      if (cfg == CFG_NULL) return;
      value := font_name ',' font_size ',' font_flags ',' charset ',';
      _LangSetProperty(langID,_FontElementIdToNameId(cfg):+"_":+VSLANGPROPNAME_FONT_INFO, value);
   }
    ...
    * @categories LanguageSettings_API 
    */
   public static _str getEditorFontInfo(_str langID, _str defaultValue = '')
   {
      return _LangGetProperty(langID,_FontElementIdToNameId(CFG_UNICODE_SOURCE_WINDOW):+"_":+VSLANGPROPNAME_FONT_INFO,defaultValue);
   }
    ...
    * 
    * @param langID              language ID (see {@link p_LangId})
    * @param font_info           font name, size, flags, charset
    *  
    * @note 
    * Language-specific font settings are only for Unicode editor, diff, and minimap fonts. 
    *  
    * @categories LanguageSettings_API 
    */
   public static void setEditorFontInfo(_str langID,  _str font_info)
   {
      _LangSetProperty(langID,_FontElementIdToNameId(CFG_UNICODE_SOURCE_WINDOW):+"_":+VSLANGPROPNAME_FONT_INFO,  font_info);
   }
    ...
    * @categories LanguageSettings_API 
    */
   public static _str getMinimapFontInfo(_str langID, _str defaultValue = '')
   {
      return _LangGetProperty(langID,_FontElementIdToNameId(CFG_UNICODE_MINIMAP_WINDOW):+"_":+VSLANGPROPNAME_FONT_INFO,defaultValue);
   }
    ...
    * @categories LanguageSettings_API 
    */
   public static void setMinimapFontInfo(_str langID, _str font_info)
   {
      _LangSetProperty(langID,_FontElementIdToNameId(CFG_UNICODE_MINIMAP_WINDOW):+"_":+VSLANGPROPNAME_FONT_INFO,  font_info);
   }
    ...
    * @categories LanguageSettings_API 
    */
   public static _str getDiffEditorFontInfo(_str langID, _str defaultValue = '')
   {
      return _LangGetProperty(langID,_FontElementIdToNameId(CFG_UNICODE_DIFF_EDITOR_WINDOW):+"_":+VSLANGPROPNAME_FONT_INFO,defaultValue);
   }
    ...
    * @categories LanguageSettings_API 
    */
   public static void setDiffEditorFontInfo(_str langID, _str font_info)
   {
      _LangSetProperty(langID,_FontElementIdToNameId(CFG_UNICODE_DIFF_EDITOR_WINDOW):+"_":+VSLANGPROPNAME_FONT_INFO,  font_info);
   }
