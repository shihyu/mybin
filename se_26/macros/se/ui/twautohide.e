 ...
 * {@code form_name}, or 0 if no auto-hide window. Set 
 * {@code to_mdi_wid} if you only want the wid on a 
...
/**
 * Return auto-hide tool-window wid for form 
 * {@code form_name} that is currently not raised, or 0 if 
 * no auto-hide window. Set {@code to_mdi_wid} if you only 
