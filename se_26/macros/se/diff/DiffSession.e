...
sc.lang.IAssignTo {
   ...
   private void getDiffSetupStruct(int curIndex,DIFF_SETUP_DATA &diffSessionData,int xmlhandle=-1) {
      ...
      getProperty(curIndex,"BufferIndex1",diffSessionData.file1.bufID,-1,xmlhandle);
      getProperty(curIndex,"BufferIndex2",diffSessionData.file2.bufID,-1,xmlhandle);
   ...
   private void setAllProperties(int sessionIndex,DIFF_SETUP_DATA &diffSessionData,int xmlhandle=-1) {
      ...
      setProperty(sessionIndex,"BufferIndex1",diffSessionData.file1.bufID,xmlhandle,"-1");
      setProperty(sessionIndex,"BufferIndex2",diffSessionData.file2.bufID,xmlhandle,"-1");
