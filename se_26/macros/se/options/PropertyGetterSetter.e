...
class PropertyGetterSetter {
   ...
   #endregion Translation To Display Methods
   ...
   private static _str getDefaultColor(SetDefaultColorInfo &scoi)
   {
      ...
      if (scoi.Value) {
         parse _default_color(scoi.Value) with fg bg ff;
            return "0x":+_dec2hex((int)fg,16,6);
      }
   ...
   private static bool setDefaultColor(SetDefaultColorInfo &scoi, _str value)
   {
      ...
      if (scoi.Value) {
         ...
         if (handle>=0) {
            ...
            _xmlcfg_set_attribute(handle,attrs_node,"fg",se.color.ColorInfo.formatHTMLHexColor(0x0000000FFFFFFFF & fg /*c.getForegroundColor(&this)*/));
            _xmlcfg_set_attribute(handle,attrs_node,"bg",se.color.ColorInfo.formatHTMLHexColor(0x0000000FFFFFFFF & bg /*c.getBackgroundColor(&this)*/));
