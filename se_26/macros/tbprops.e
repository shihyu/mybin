...
{
   category := "";
   switch (formNameOrTab) {
   case '_tbstandard_form':        category = "Files and Buffers";    break;
   case '_tbproject_tools_form':   category = "Project";              break;
   case '_tbtools_form':           category = "Tools";                break;
   case '_tbedit_form':            category = "Edits and Selections"; break;
   case '_tbseldisp_form':         category = "Selective Display";    break;
   case '_tbxml_form':             category = "XML";                  break;
   case '_tbhtml_form':            category = "HTML";                 break;
   case '_tbtagging_form':         category = "Tagging";              break;
   case '_tbcontext_form':         category = "Tagging";              break;
   case '_tbdebugbb_form':         category = "Debug";                break;
   case '_tbdebug_sessions_form':  category = "Debug";                break;
   case '_tbvc_form':              category = "Version Control";      break;
   case '_tbandroid_form':         category = "Androis";              break;
   }

   if (category != "") {
      ctlcatlist._lbfind_and_select_item(category);
   }
