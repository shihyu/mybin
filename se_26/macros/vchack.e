...
static int _set_visualstudio_environment(bool quiet=false, int major_version=0, _str target_version='')
{
   ...
   if (major_version==0 && target_version=='') {
      ...
      case COMPILER_NAME_VS2022:
         return _set_visualstudio_environment(quiet,17);
      }
      if (!quiet) {
...
INCLUDE=
   ...
   C:\Program Files (x86)\Windows Kits\10\include\10.0.14393.0\cppwinrt
...
*/      
   ...
   if (major_version==15) {
      ...
      include_path=_get_vs_sys_includes(COMPILER_NAME_VS2022);
   }
   ...
   */
   ...
   case 16:
      ...
      break;
   case 17:
      env_commontools = 'VS170COMNTOOLS'; 
      break;
   }
 ...
 */
_command int set_visualstudio2022_environment()
{
   return(_set_visualstudio_environment(false,17));
}
...
_str _getVCToolsVersion2017(_str VCINSTALLDIR, int major_version)
{
   ...
   if (major_version == 17) {
      configFile = 'Microsoft.VCToolsVersion.v143.default.txt';
   } else if (major_version == 16) {
   ...
   if (major_version == 17) {
      configFile = 'Microsoft.VCToolsVersion.v143.default.props';
   } else if (major_version == 16) {
