 ...
 *                <ul>
 *                <li>{@literal 'C'} - (Windows) Create a console for the spawned program.</li> 
 *                <li>{@literal 'H'} - (Windows) Show program hidden. Useful for console
 *                          applications that should be "heard but not seen."</li>
 *                <li>{@literal 'H'} - (Unix) Show program hidden and create new process group.</li>
 *                </ul>
 *
 * <p>
