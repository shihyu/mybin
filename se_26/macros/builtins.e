...
/**
 * @return Return {@code true} if the given class is an instance
 ...
 * instance {@code null}, like {@link _makeempty()}, if {@code className} 
 ...
 * need for a {@code delete} or {@code _destruct()} operator.
 * 
 ...
 * When {@code true}, captions are display as tool tip help.
 *
 * @appliesTo SSTab
 * @categories SSTab_Properties
 */
 ...
 * {@link _setEnabled} method instead of this property when setting
...
/**
 * Determines the help for the active tab.  See {@link p_help} property
 ...
 * The {@code p_alignment} property has no effect if {@link p_auto_size} is non-zero.
 * {@code p_alignment} is one of the following constants defined in "slick.sh":
 ...
 * {@code p_auto_select} is non-zero, and you tab from a text box or combo box, the
 ...
 * set the {@code p_auto_select} property to zero.
 *
 ...
 * the {@link p_caption} property.  When {@code p_auto_size} is non-zero, the {@link p_alignment}
 ...
 * {@link p_caption} property is '', the {@code p_auto_size}
 * property has no effect.
 *
 ...
 * {@code p_buf_width} property is zero when displaying ASCII files.  When the
 * {@ocde p_buf_width} property is non-zero, new line characters no longer split a
 ...
 *
 * <p>IMPORTANT:  For menu items, set the {@code p_caption}
...
/**
 * Returns {@code true} if capitalization mode is on.
 *
 * @see p_LangId
 * @see p_caps
 *
 ...
 * {@code p_categories} property is also used to uniquely identify the menu.  For
 * example, if you wanted to maintain a history of files recently opened on a
 * File menu, insert a menu item line with the {@code p_categories} property set to
 ...
 * handle properties.  The {@code p_cb} property provides a way to make sure you are
 ...
 * was actually clicked in.  Compare the {@code p_cb_active} property to the
 ...
 * individually with the {@link p_cb}, {@link p_cb_text_box}, {@link p_cb_picture}, {@code p_cb_list_box}
 * instance handle properties.  The {@code p_cb_list_box} property is only available
 ...
 * accessed individually with the {@link p_cb}, {@link p_cb_text_box}, {@code p_cb_picture},
 * {@link p_cb_list_box} instances handle properties.  The {@code p_cb_picture} property is
 ...
 * box consists of 4 controls: the root window, text box, picture box, and
 * list box.  The properties and methods of the sub-controls may be accessed
 * individually with the {@link p_cb}, {@code p_cb_text_box}, {@link p_cb_picture}, {@link p_cb_list_box}
 * instances handle properties.  The {@code p_cb_text_box} property is only available
 * when the control is displayed.  Since all properties of {@link p_cb} and {@code p_cb_text}
 * access the same values except for the window position and size properties,
 * there is little need for the {@code p_cb_text_box} property other than to check if
 * it was clicked in.
 *
 * @example
 * <PRE>
 ...
 * repainting.  Painting a dialog box is slightly faster when {@code p_clip_controls}
 ...
 * a two state picture button is pressed.  If {@code p_command} is a valid editor
 ...
 * keys are pressed.  Valid {@code p_completion} constants are:
 * <DL compact style="margin-left:20pt">
 ...
 * has an effect of {@link p_completion} is set. 
 *  
 * @appliesTo Combo_Box, Text_Box
 * @categories Combo_Box_Properties, Text_Box_Properties
 */
 ...
 * nibbles or ASCII data.  {@code false} indicates that the cursor is in the ASCII
 ...
 * before left or right nibble.  {@code true} indicates that the cursor is on the
 ...
 * in the text box may be a floating pointer number (sorry, {@code p_increment} is
 * only an int).  If {@code p_increment} is 0, the spin control will call the
...
/**
 * Returns {@code true} if language is case sensitive.  This property is read only.
 *
 * @see p_LangId 
...
/**
 * When {@code true}, hides actual characters typed in.
 ...
 * size ({@link p_font_size}).  If {@code p_pic_point_scale} is 0, the picture ({@link p_picture}) is
 * not scaled.  The height and width of the picture are multiplied by
 * ({@link p_font_size}/{@code p_pic_point_scale}).
 *
 * @example
 * <PRE>
 * #include 'slick.sh'
...
/**
 * The {@code p_picture} property is an index to a picture in the names table.
 *
...
/**
 * Returns {@literal 'A'} if the current buffer buffer contains SBCS/DBCS data and that
 ...
 * ({@code p_ReadOnly}=true) than when it is disabled ({@link p_enabled}=false).
 *
 ...
 * still make a selection and copy the text to the clipboard.  In addition,
 * the color of the text is more readable when the text box is read only
 * ({@link p_ReadOnly}=true) than when it is disabled ({@link p_enabled}=false).
 *
 * @see p_readonly_set_by_user
 * @see p_ReadOnly
 * @see p_readonly_mode
...
/**
 * Determines the current line number.  Note that {@code p_RLine} (short for "real
 ...
 * it is determined.  If the {@code p_RLine} property is set to a value greater than
 ...
 * {@code p_scroll_bar} property may be one of the following constants defined in
 * "slick.sh":
 * <DL compact style="margin-left:20pt">
 ...
 * {@link p_ShowSpecialChars} property instead.
 *
 * @appliesTo Editor_Control, Edit_Window
 * @categories Edit_Window_Properties, Editor_Control_Properties
 */
...
/**
 * Determines whether the {@link _save_file} function (used by
 * {@link save} command) inserts or removes the EOF character that
...
/**
 * Determines the extra spacing in twips between each line in a tree control. 
 *  
 * The default amount of spacing is 40 twips, setting this property to anything 
 * less than that will have no effect on row space. 
 *
 * @appliesTo Tree_View
 * @categories Tree_View_Properties 
 */
 ...
 * The {@link p_auto_size} and {@link p_picture} properties must be
 ...
 * only when the control is displayed.  {@code p_tabs} is a string in the
 ...
 * the form.  This property is set by the {@link _load_template} and
 * {@link _update_template} functions.  The purpose of this property is
 * to allow you to determine the name of the form
 * ({@link name_name}(p_template)) which should be opened for
 ...
 * set, an {@link on_change} event will occur.
 *
 * @appliesTo Combo_Box, Text_Box
 * @categories Combo_Box_Properties, Text_Box_Properties
 */
...
/**
 * Determines the persistent id of the window.
 * 
 * <p>AutoRestore saves and restores the persistent wid. Right 
 * now the persistent wid is used for bookmarks. That way, if 
 * there are multi edit windows viewing the same file, the go 
 * to bookmark code can go back to the same window viewing the 
 * file when possible. 
 *
 * @appliesTo Edit_Window
 * @categories Edit_Window_Properties
 */
int p_persistent_wid,
    _sc_lang_editor::p_persistent_wid;
...
/**
 * When this property is {@code true}, the caption at the top of a form is
 ...
 * line length calculation, users should reference {@link _TruncateLengthC} 
 ...
 *
 * <dt>{@link _JoinLineToCursor}, {@link vsJoinLineToCursor}</dt><dd>
 *    The join is aborted if the join will create a line longer
 * than the truncation length.   An error status is returned if
 * the join is aborted.</dd>
 *
 * <dt>{@link _insert_text}, {@link vsInsertText}</dt><dd>
 ...
 *
 * <dt>{@link _delete_text}, {@link vsDeleteText}</dt><dd>
 *    The text to the right of the truncation length on the
 * current line is not effected.</dd>
 *
 * <dt>{@link _delete_selection},{@link vsDeleteSelection}</dt><dd>
 *    The text to the right of the truncation length on the
 * current line is not effected.</dd>
 *
 * <dt>{@link vsTruncQLineLength}</dt><dd>
 ...
 * the length.</dd>
 *
 * <dt>{@link _SearchInitSkipped},{@link vsSearchInitSkipped}</dt><dd>
 ...
 *
 * <dt>{@link _SearchQSkipped}, {@link vsSearchQSkipped}</dt><dd>
 ...
 *
 * <dt>{@link _SearchQNofSkipped},{@link vsSearchQNofSkipped}</dt><dd>
 *    Call this function after performing search and replace
 * operation to determine how many replace operations were
 * skipped to avoid line truncation.</dd>
 *
 * <dt>{@link keyin}, {@link vsKeyin}</dt><dd>
 *    Text to the right of the truncation length on the current
 * line is not effected.</dd>
 *
 * <dt>{@link search}, {@link search_replace}, {@link vsSearch},
 * {@link vsSearchReplace}, {@link vsRepeatSearch}</dt><dd>
 ...
 * not effected.</dd>
 *
 * <dt>{@link _overlay_block_selection}, {@link _adjust_block_selection},
 * {@link _fill_selection}</dt><dd>
 *    Text to the right of the truncation length is not effected.</dd>
 *
 * <dt>{@link _shift_selection_left}, {@link vsShiftSelectionLeft}</dt><dd>
 *    Text to the right of the truncation length is not effected.</dd>
 *
 * <dt>{@link _shift_selection_right}, {@link vsShiftSelectionRight}</dt><dd>
 *    Text to the right of the truncation length is not effected.</dd>
 *
 * <dt>{@link _copy_to_cursor}, {@link vsCopyToCursor}</dt><dd>
 *    Text to the right of the truncation length is not effected.
 * Any resulting lines longer than then truncation length are
 * truncated.</dd>
 *
 * <dt>{@link _move_to_cursor}</dt><dd>
 *    Text to the right of the truncation length is not effected.
 * Any resulting lines longer than then truncation length are
 * truncated.</dd>
 * </dl>
 ...
 *
 * <dl>
 * <dt>{@link _expand_tabsc}, {@link vsExpandTabsC},
 * {@link _expand_tabsc_raw}</dt><dd>
 *    A width value of -2 specifies that the
 * {@link vsTruncQLineLength} be used instead of the real
 * line length.</dd>
 *
 * <dt>{@link _text_colc}, {@link vsTextColC}</dt><dd>
 *    A new {@literal 'E'} option specifies that the
 * {@link vsTruncQLineLength} be used instead of the real
 * line length.</dd>
 * </dl>
 *
 ...
 *
 * <dl>
 * <dt>{@link _save_file}, {@link vsSaveFile}</dt><dd>
 *    A new +CL option (Check Line length option) was
 * added.  When specified, the new
 * {@link vsCheckLineLengths} function is called if the
 * output file has a required record length or if the source
 * file has a non-zero {@link p_MaxLineLength} property.</dd>
 *
 * <dt>{@link _CheckLineLengths}, {@link vsCheckLineLengths}</dt><dd>
 *    Allows you to get a list of lines longer than a specified
 * line length.  Usually, {@link p_MaxLineLength} is
 * specified.</dd>
 * </dl>
 *
 * @see p_TruncateLength
 ...
 * {@link p_min}>= {@link p_value} &lt;={@link p_max}.  Setting the
 * p_value property has no effect.</p>
 *
 * <p><b>Gauge</b> - Indicates a portion of a total where {@link p_min}>=
 * {@link p_value} &lt;={@link p_max}.</p>
 *
 * <p><b>Picture Box, Image</b> - Determines which state of a picture gets
 * displayed where 0>= p_value &lt;{@link p_Nofstates}.</p>
 *
 * <p><b>Frame</b> - Only applies when the frames
 * {@link p_checkable} value is true.  In this case,
 * {@link p_value} is the value of the checkbox.  Does not support
 ...
 *
 * <dl>
 * <dt>{@literal 'I'}</dt><dd>Iconized window</dd>
 * <dt>{@literal 'M'}</dt><dd>Maximized window  (hides Document Tabs)</dd>
 * <dt>{@literal 'N'}</dt><dd>Normalized window (shows Document Tabs)</dd> 
 * <dt>{@literal 'F'}</dt><dd>Fullscreen</dd> 
 * </dl>
 *
 ...
 * such as {@link next_word}, {@link prev_word}, and
 * {@link cap_word}.
 *
 * @note
 ...
 * {@code p_active_form} property.  This property is not available when the form is not displayed.
 *
 * @example
 * <PRE>
 *    defeventtab form1;
...
/**
 * Determines the color profile name to use for color coding in this window. 
 *  
 * This will be the real color profile name in use, 
 * it does not translate "Automatic" or any other derived color profile names.  
 *  
 * @note 
 * This function is intended for internal use only.  Generally, color profiles 
 * should be used per-buffer, not per-window. 
 *  
 * @see p_BufferColorProfile 
 * @see p_MinimapColorProfile 
 * @see window_color()
 *  
 * @appliesTo Editor_Control, Edit_Window
 * @categories Editor_Control_Properties, Edit_Window_Properties
 */
bool p_WindowColorProfile,
        _sc_lang_editor::p_WindowColorProfile;
/**
 * Determines the color profile used by the current buffer in an editor control. 
 *  
 * @see p_MinimapColorProfile 
 * @see window_color() 
 *  
 ...
 * @categories Editor_Control_Properties, Edit_Window_Properties
 */
bool p_BufferColorProfile,
        _sc_lang_editor::p_BufferColorProfile;
/**
 * Determines the color profile used by the current buffer in an minimap editor control. 
 *
 * @see p_BufferColorProfile 
 * @see window_color() 
 *  
 ...
 * @categories Editor_Control_Properties, Edit_Window_Properties
 */
bool p_MinimapColorProfile,
        _sc_lang_editor::p_MinimapColorProfile;

/**
 * Determines the font used by the current buffer in an editor control. 
 *  
 * @see p_MinimapFontInfo
 * @see wfont()
 * @see window_font()
 *  
 * @appliesTo Editor_Control, Edit_Window
 * @categories Editor_Control_Properties, Edit_Window_Properties
 */
bool p_BufferFontInfo,
        _sc_lang_editor::p_BufferFontInfo;
/**
 * Determines the font used by the current buffer in an minimap editor control. 
 *
 * @see p_BufferFontInfo 
 * @see window_color() 
 *  
 * @appliesTo Editor_Control, Edit_Window
 * @categories Editor_Control_Properties, Edit_Window_Properties
 */
bool p_MinimapFontInfo,
        _sc_lang_editor::p_MinimapFontInfo;
...
/**
 * If the current window is a minimap editor window, return the window ID 
 * for the editor control window it is attached to.
 *
 * @appliesTo All_Window_Objects
 *
 * @categories Check_Box_Properties, Combo_Box_Properties,
...
/**
 * Determines the initialization style.  The {@code p_init_style} property
 ...
 * {@link _modal_wait} function is called with a specified form, the {@code p_modal} property
...
/**
 * Determines whether the object is selected.  If the {@link p_edit}
 ...
 * {@link lbutton_down} event. Uses p_border_style.</dd>
 * <dt>PSPIC_FLAT_BUTTON</dt><dd>Tool-button style. Set the 
 * {@link p_picture} property to a 1 state picture without a 
 * border to get a 3 state toolbar button (0-normal, 1-pushed, 
 * 2-mouse over button).  This style 
 * supports the {@link p_enabled} property on all platforms. 
 * {@link lbutton_down} event calls {@link lbutton_up} event or executes
 * command in {@link p_command} property.  {@link p_value}
 ...
 * is used, along with {@link p_forecolor}, to fill the mask with 
 * the foreground color. This style supports the 
 * {@link p_enabled} property on all platforms. 
 * {@link lbutton_down} event calls {@link lbutton_up} event or 
 * executes command in {@link p_command} property. {@link p_value}
 * property is restored to its original value.</dd>
 * <dt>PSPIC_HIGHLIGHTED_BUTTON</dt><dd>Tool-button style. Set 
 * the {@link p_picture} property to a 1 state picture without a 
 * border to get a 3 state toolbar button (0-normal, 1-pushed, 
 * 2-mouse over button).  This style 
 * supports the {@link p_enabled} property on all platforms.
 * {@link lbutton_down} event calls {@link lbutton_up} event or executes
 ...
 * button. This style supports the {@link p_enabled} property on all
 * platforms.  If you set the {@link p_picture} or 
 * {@link p_caption} property, the control will 
 * display and act like a tool-button.  {@link lbutton_down}
 * event calls {@link lbutton_up} event or executes command in
 * {@link p_command} property.  {@link p_value} property is restored
 * to its original value.</dd>
 * <dt>PSPIC_AUTO_BUTTON</dt><dd>Set the {@link p_picture}
 * property to a 1 state picture without a border to get a 2 state push
 * button.  {@link lbutton_down} event calls {@link lbutton_up}
 * event or executes command in {@link p_command}
 * property.  {@link p_value} property is restored to its
 * original value.</dd>
 * <dt>PSPIC_AUTO_CHECK</dt><dd>Picture is a 2 or more
 * state picture.  {@link lbutton_down} event calls {@link lbutton_up} after
 * {@link p_value} property has be incremented (or set to 0
 ...
 * <dl>
 * <dt>PSPIC_DEFAULT</dt><dd>No default handling for
 * {@link lbutton_down} event.</dd>
 * <dt>PSPIC_PUSH_BUTTON</dt><dd>Push-button style. Picture 
 * is a 1 state picture which needs button up and down borders 
 * drawn around it. 
 * The {@link lbutton_down} event calls the {@link lbutton_up}
 * event or executes the command in the {@link p_command}
 * property.  The {@link p_value} property is restored to its
 * original value.</dd>
 ...
 * it. The {@link lbutton_down} event calls the {@link lbutton_up}
 * event or executes the command in the {@link p_command}
 * property.  The {@link p_value} property is restored to its
 ...
 * {@link p_picture} property to a 2 or more state picture and set the
 * {@link p_Nofstates} property to indicate the number of picture states.
 * {@link lbutton_down} event calls {@link lbutton_up} event or executes
 * command in {@link p_command} property.  {@link p_value} property
 ...
 * {@link p_backcolor} to {@link p_forecolor}.</dd> 
 * <dt>PSPIC_FILL_GRADIENT_VERTICAL</dt><dd>Gradient fill top to
 * bottom with {@link p_backcolor} to {@link p_forecolor}.</dd> 
 ...
 * control can rely on the {@link p_prev} property getting to the text box
...
/**
 * Determines whether the control is visible when {@link p_edit}!=0.
 ...
 * if the object is being edited ({@link p_edit}!=0).
 *
 * @see _ShowWindow
 *
 * @categories Check_Box_Properties, Combo_Box_Properties,
 ...
 * the focus.  Use the {@link _set_focus} method to change the focus.
 ...
 * <P>
 * The option defaults to {@literal 'W'} and may be one of the following:
 * <DL compact style="margin-left:20pt">
 * <DT>{@literal 'W'}<DD>Indicates that wid_or_etab is the window id of the object.  The event
 * handler is determined by the dialog box inheritance order.
 * <DT>{@literal 'E'}<DD>Indicates that wid_or_etab is an index to and event table.
 * <DT>{@literal '2'}<DD>Indicates that wid_or_etab is the window id of the object.  The event
...
/**
 * Appends {@code source} string to end of {@code dest} string. 
 * This function performs faster than using the statement
 * "<code>dest = dest :+ source;</code>", but it is preferred to use the Slick-C 
 * shorthand assignmentand concatenation operator "<code>dest :+= source;</code> 
 *
 ...
 *
 * <dl>
 * <dt>{@literal 'V'}</dt><dd>(Default) Attempt to tile windows vertically.</dd>
 * <dt>{@literal 'H'}</dt><dd>Attempt to tile windows horizontally.</dd>
 * <dt>{@literal 'U'}</dt><dd>Until windows (one group of tabs)</dd> 
 * </dl>
 *
 ...
 * Otherwise a negative error code is returned.  option may be {@literal 'M'} or {@literal 'P'}.
 * Specify {@literal 'P'} for option to display a menu resource as a pop-up menu.
 ...
 * {@link p_template} property is 0, a new dialog box template is
 * inserted.  Otherwise, the existing dialog box template is replaced.
 * Specify the name of the form ({@link p_name}) to the {@link show}
 ...
 *         {@link p_template} property of the form is set to the index into the
...
/**
 * @return Returns line number ({@link p_line}) corresponding
 *         to offset
 *
 ...
 * The (x, y) position is relative to parent_wid.  Use the {@literal 'C'}
...
/**
 * Converts the {@code x} and {@code y} variables which are in the scale,
 * {@code scale_mode}, to pixels.  {@code scale_mode} may be SM_PIXEL or SM_TWIP.
 *
...
/** 
 * @return 
 * Returns an instance handle (window id) to form {@code form_name}. Returns 0 if
 * an instance is not found.  Beware, by default, this function will find edited 
 * or non-edited instances of a form.  Specify the {@literal 'N'} option if you only want 
 * to find a non-edited instances of the form.  Specify the {@literal 'E'} option if you 
 * only want to find an edited instance of a form. 
 *  
 * @param form_name     name of form to search for an instance of 
 * @param option        {@literal 'N'} or {@literal 'E'}, as described above 
 ...
 * {@code object_name}.  Returns 0 if an instance is not found.  Beware, by 
 * default, this function will find edited or non-edited instances of an object.  
 * Specify the {@literal 'N'} option if you only want to find a non-edited instance of an 
 * object.  Specify the {@literal 'E'} option if you only want to find an edited instance 
 * of an object. 
 *  
...
/**
 * Gives the object a unique tab index ({@link p_tab_index}) different
 * from other controls on the form.  If {@link p_tab_index} is not 0 and
 ...
 * {@link p_visible} property to make a window visible without
 * changing it Z order.  {@code swOption} may be one of the following
 ...
 * ({@link p_xyscale_mode}) except for the {@literal 'O'} option which returns the 
 * values in pixels. 
 * {@code option} can be {@literal 'C'} for current size, {@literal 'N'} for 
 * normalized size (before it was iconized), or {@literal 'O'} for 
 ...
 * and size parameters are specified in the parent scale mode (p_xyscale_mode).  Use the {@literal 'N'}
 * option to move and size the normalized information for the window when the window is
 * iconized or maximized.  The {@literal 'C'} option is the default, and specifies that the current
 * window position and size be changed.  The {@literal 'N'} option is no 
 * longer supported.
 *
...
/**
 * Switches to the previous window.  The hidden window is skipped unless the {@literal 'H'}
 ...
 *
 * <dl>
 * <dt>{@literal 'A'}</dt><dd>Update all editor controls.  This does not flush paint
 * messages.</dd>
 * <dt>{@literal 'W'}</dt><dd>Flush paint messages to the current window.</dd>
 * <dt>{@literal 'F'}</dt><dd>This options is ignored and is present only for
 ...
 * {@code keysOnly} option of {@link last_event()} to avoid
 ...
 * Use the {@link _GoToOldLineNumber} method to go to an old line
 ...
 * {@link p_newline} character string at cursor.  If the cursor is past the
 * end of the line, the {@link p_newline} character string is inserted after
 ...
 * @param NewLineChars defaults to "\r\n".
 *
 * <p>Insert {@code string} at cursor position.  Specify {@link true} for the
 * {@code binary} option if you want to allow splitting of newline characters
 * (i.e. CR&lt;insert here&gt;LF).  You may use this function to insert multiple lines
 * of text.  The {@code NewLineChars} string specifies a 1 or two byte sequence
 * which indicates the line separation characters for the {@code string}
 * argument.  The {@code NewLineChars} argument is ignored if the binary option
 * is {@link true}.</p>
 *
 * <p>When you use this function on a record file (p_buf_width!=0) and the
 * {@code binary} option is {@link true}, all data is inserted into current line
 * and not broken up into multiple lines.</p>
 *
 * <p>NOTE: If you are inserting at the end of a file and the last character
 * of {@code string} is a new line, you can end up with a blank line that has no
 * new line characters in it.  You can test for this condition by calling
 * {@link _line_length}(1) which will return 0.  Use {@link delete_line}() to
 * delete the line.</p>
 *
 * @appliesTo Edit_Window, Editor_Control
 * @categories Edit_Window_Methods, Editor_Control_Methods
 ...
 * characters.  Specify {@code IncludeNLChars}={@link true} if you want to include
 ...
 * <dt>{@literal 'P'}</dt><dd>Imaginary, Physical</dd>
 * <dt>{@literal 'T'}</dt><dd>Imaginary, Physical.  Position is negated if the
 * imaginary column input corresponds to the middle
 * of a tab character.</dd>
 * <dt>{@literal 'L'}</dt><dd>Doesn't matter, Imaginary length of string.</dd>
 * <dt>{@literal 'E'}</dt><dd>Doesn't matter, Imaginary length of line where the
 * {@link vsTruncQLineLength} is used.  This has the
 * same effect as the {@literal 'L'} option if the
 * {@link VSP_TRUNCATELENGTH} property is
 * 0.</dd>
 * <dt>{@literal 'I'}</dt><dd>Physical, Imaginary</dd>
 * </dl>
 *
 * <p>The input column is returned if input column is less than or equal to
 * zero and the third parameter is not {@literal 'L'}.</p>
 *
 ...
 * settings.  option may be {@literal 'E'} or {@literal 'S'}.  If the {@literal 'S'} option is given, only
...
/**
 * This function is identical to the {@link _expand_tabsc} function, except
 ...
 * @param option    option defaults to {@literal 'M'} when not given.
 *                  <DL compact>
 *                  <DT>Option<DD>Description
 *                  <DT>{@literal 'M'}<DD>  Temporarily turns recording output on or off.  If the second parameter is specified, recording output is set to new_value.  Returns current recording output value.  A non-zero value indicates macro actions should be recorded.
 *                  <DT>{@literal 'S'}<DD>  Returns non-zero value if macro recording is on.  Second parameter is ignored.
 *                  <DT>{@literal 'B'}<DD>  Turns on macro recording.  Output for recording is to the current file.  Returns 0.  Second parameter is ignored.
 *                  <DT>{@literal 'E'}<DD>  Turns off macro recording.  Returns 0.  Second parameter is ignored.
 *                  <DT>{@literal 'R'}<DD>  Indicates that a recording macro is running.  The editor needs to know when a recorded macro is being executed to correctly handle special cases.  For example, when in BRIEF emulation, after performing a search the delay function gets called to wait for 4 seconds or until a key is pressed to temporarily show a highlight on the text that was found.  When running a recorded macro, the delay function will return immediately.
 *                  <DT>{@literal 'ka'}<DD> Abort kbdmacro playback and
 *                  clear all kbdmacros.
 *                  <DT>{@literal 'KA'}<DD> Abort kbdmacro playback. Has no
 *                  effect on stacked recordings. Must use {@literal 'KE'}
 *                  to terminate recordings.
 *                  <DT>{@literal 'KB'}<DD> Begin recording keyboard macro
 *                  to the keyboard macro index specified by
 *                  new_value (0..N).
 *                  <DT>{@literal 'KE'}<DD> End recording keyboard macro
 *                  for the keyboard macro index specified by
 *                  new_value (0..N).
 *                  <DT>{@literal 'KD'}<DD> Delete the last key sequence in
 *                  the all keyboard macro currently recording
 *                  or the keyboard macro index specified by
 *                  new_value (0..N). Call before calling
 *                  _macro({@literal 'KE'}).
 *                  <DT>{@literal 'KG'}<DD> Get the string value for the 
 *                  keyboard macro index specified by new_value
 *                  (0..N). Call after calling _macro({@literal 'KE'}).
 *                  <DT>{@literal 'KK'}<DD>Append key event to end of all
 *                  keyboard macros being recorded. new_value is
 *                  an event string ({@literal 'a'}, name2event({@literal 'ENTER'}),
 *                  etc.).
 *                  <DT>{@literal 'KI'}<DD>Query if a keyboard macro is
 ...
 *                  keyboard macro index specified by new_value
 *                  (0..N) is recording.
 *                  <DT>{@literal 'KR'}<DD> Query if a keyboard macro is
 ...
 *                  <DT>{@literal 'KP'}<DD> Play the keyboard macro index
 *                  specified by new_index (0..N), or the
 *                  keyboard macro specified by kbdmacro_string.
 *                  new_value is '' or a count of the number of
 *                  times to repeat this keyboard macro.
 *                  </DL>
 *                  <P>
 *                  The {@literal 'M'} option allows macro recording to be on, but no recorded actions to
 ...
 * @param new_value
 * 
 * @return If {@literal 'S'} is specified, this return an int.  If {@literal 'KE'}
 *         or {@literal 'KD'} specified, this returns a list keys.
 * @see start_recording
 * @see end_recording
 ...
 * {@code ReservedMore} variable to ensure all search data is restored.
 * For backward compatibility, the {@code ReservedMore} parameter is
 * optional.  The built-in function {@link restore_search} is called with
 * the same data to restore the search which is used by the built-in
 * functions {@link repeat_search}, {@link _select_match}, and
 * {@link match_length}.
 *
 ...
 * {@link save_search} may be called to return the current search data
 * which is used by the built-in functions {@link repeat_search},
 * {@link _select_match}, and {@link match_length}.  {@code Flags} is a
 ...
 * <DL compact>
 * <DT>{@literal 'C'}</DT><DD> Specifies that the selection extend as the
 * cursor moves.</DD>
 * <DT>{@literal 'E'}</DT><DD> (Default) Requires that _select_block be
 * executed to end the text selection.</DD>
 * <DT>{@literal 'P'}</DT><DD> specifies a persistent select style.  Macros
 * use this to help determine if a selection should be
 * unhighlighted when the cursor moves.</DD>
 * <DT>{@literal 'I'}</DT><DD> This option is ignored. For
 * backward compatibilty, BLOCK mark must be
 * initially inclusive. Use _select_type(mark,'I',0) to
 * change to non-inclusive.</DD>
 * <DT>{@literal 'N'}</DT><DD> This option is ignored.</DD>
 * </DL>
 *
 ...
 *    the {@literal 'C'} letter is not specified, this select style is used.
 *    <DT><B>{@literal 'C'}</B>
 ...
 *    selections are affected by this option.  If the {@literal 'I'} letter is not
 *    specified, the character selection will be non-inclusive selection.
 *    <DT><B>{@literal 'P'}</B>
 *    <DD>A value of {@literal 'P'} specifies a persistent select style and may be
 ...
 * {@code mark_id} is a handle to a selection returned by one of the built-
 * ins {@link _alloc_selection} or {@link _duplicate_selection}.  A
 * {@code mark_id} of '' or no {@code mark_id} parameter identifies the
 * active selection.
 *
 * @return Returns 0 if successful.  Common return codes are
 ...
 *               built-ins _alloc_selection or _duplicate_selection.  A {@code mark_id} of '' or
 *               no {@code mark_id} parameter identifies the active selection.
 * @appliesTo Edit_Window, Editor_Control
 *
 * @return
 *         <DL compact>
 ...
 * @param options    is a string of zero or more of the following:
 *    <DL compact>
 *    <DT>{@literal 'H'}<DD>Allow switching to the hidden window.
 *    <DT>{@literal 'N'}<DD>Don't update the active buffer's non-active cursor position information.
 *    <DT>{@literal 'R'}<DD>Don't do any screen updating.
 *    </DL>
 *    <P>
 *    The active cursor position information is saved in the active buffer's non-active
 *    cursor position information unless the {@literal 'N'} option is specified.  Each buffer maintains ONE
 ...
 *    <P>
 *    The {@literal 'H'} option determines whether buffers with (p_buf_flags&VSBUFFLAG_HIDDEN) true may be selected.
 *    <P>
 *    The {@literal 'R'} options specifies that the screen should not be refreshed.
 *
 * @see _prev_buffer
 * @see _delete_buffer
 *
 ...
 *
 * @param option     letter defaults to {@literal 'U'} and may be one of the following:
 *    <DL compact>
 *    <DT>{@literal 'U'}
 ...
 *    <DT>{@literal 'C'}
 *    <DD>Same {@literal 'U'} option except when the current buffer has more than 0
 *    undoable steps.  Consecutive cursor motion is undone as one step.
 *    <DT>{@literal 'V'}
 *    <DD>Same {@literal 'C'} option except this option avoids doing an
...
/**
 * Moves cursor number of lines up.  If number is not given a value of {@literal '1'} is used.
 ...
 * {@literal '1'} is used.  If line is not in view, line is center scrolled or smooth
 * scrolled into view.
 *
...
/**
 * Moves text under the cursor {@link p_char_height} - 1 lines up.  If the
 * bottom line of the buffer is reached and it is not visible, the cursor is
 * placed at the last row of the window.  {@link _page_down} is not
...
/**
 * Moves text under the cursor {@link p_char_height} - 1 lines down.
...
/**
 * Replaces the match found by the last {@link search} or
 * {@link repeat_search} with {@code replace_string}.  If the {@literal 'R'} option is
 * specified, a search for the next string is performed with the same
 * options and direction specified by the last {@link search} or
 * {@link repeat_search} call.
 *
 ...
 * with one of the search commands {@link find}, or {@link replace}
 * (see {@link find_next} command).
 *
 * @appliesTo Edit_Window, Editor_Control
 * @categories Edit_Window_Methods, Editor_Control_Methods, Search_Functions
 * @param options
 ...
 *                  <dt>{@literal '&'}</dt><dd>Interpret string as a wildcard
 ...
 *                  for the character {@literal 'a'}, it will not be found as the
 ...
 *                  specified by {@code start_col}.  If {@code start_col} is not given,
...
/**
 * Searches for {@code search_string} specified.  If {@code replace_string}
 * is specified, a search and replace without prompting is performed.
 * The number of changes is returned in the optional {@code Nofchanges}
 ...
 *                   option is specified.</dd>
 *                   <dt>,</dt><dd>Delimiter to separate ambiguous options.
 *                   <dt>#</dt><dd>Highlight matched occurences with highlight color.
 ...
 * last {@link search} or {@link repeat_search} executed.  If the {@literal 'C'} parameter is
 ...
 * buffer position of a tagged expression.  Specifying {@literal 'S'} followed by a tagged
 * expression number (i.e. {@literal 'S0'}) will return the start buffer position of
 * that tagged expression. The start buffer position is a seek position or
 * point which may be used as input to the {@link goto_point} and {@link get_text}
 * built-ins. An undefined start buffer position is returned if that tagged
 * expression was not found. If {@literal 'S'} is not followed by a number, the start
 * position of the entire string found is returned. Specifying a tagged
 * expression number (such as {@literal '0'}) will return the match length of that group.  0 is
...
/**
 * @return 
 * Returns a list of match group names (separated by spaces)
 * for each of the regular expression match groups found by the
 * last {@link search} or {@link repeat_search} executed. 
 *  
 * @param min_length    (default 1) minimum match group length to count 
 *
 * @example
 * <pre>
 *         // This example works for files with tab characters.
 ...
 *         // In this case, match_length('S')==match_length('S0');
 *         // and match_length()==match_length('0');
 *         groups := match_group_names();
 *         foreach (auto group_name in groups) {
 *            word=get_text(match_length(group_name),match_length(group_name))
 *         }
 * </pre>
 *
 * @see _select_match
 ...
 * @categories Search_Functions
 */
_str match_group_names(int min_length=1),
    _sc_lang_editor::match_group_names(int min_length=1);
 ...
 *
 * @return Returns {@code count} characters from current buffer starting from
 *         <i>seek_pos.</i>  {@link get_text} is a stream-oriented function which for
 *         ASCII buffers will return line separation characters.  Use the
 *         {@link get_text} function to retrieve strings found by a regular expression
 *         search.  {@code count} defaults to 1 if not specified.  {@code seek_pos}
 ...
 *
 * @param line   String to insert.  {@code line} should not contain newline characters since
...
/**
 * This function is identical to the {@link insert_line} function, except that
...
/**
 * This function is identical to the {@link get_line} function, except that
...
/**
 * This function is identical to the {@link replace_line} function, except
 ...
 * </pre>
 *
 * @param option_letters may be {@literal 'H'},{@literal 'S'},{@literal 'A'},{@literal 'D'},{@literal 'P'},{@literal 'T'},{@literal 'V'} with the
 * following meanings:
 *
 * <dl>
 ...
 * and '?'.  If {@code filespec} is not specified, current directory is used.
 *
 ...
 *
 * @return When no parameters specified, returns {@literal '1'} if insert mode on.
 * Otherwise {@literal '0'} is returned.
 *
 * <p>When {@code newValue} parameter is not "", the insert state is set to
 * {@code newValue}.  <i>newValue </i>must be an integer.</p>
 *
 * <p>Specify "D" for {@code set_default} to set the initial insert state used
 * when the editor is invoked.  The current insert state is not changed.  The
 * current initial insert state is returned.  Specify "" for {@code newValue} and
 * "D' for {@code set_default} to get the current initial insert state.</p>
 *
 * @example
 * <pre>
 ...
 * @param option 
 *  
 * {@code option} may be one of the following values:
 * <dl>
 * <dt>""</dt><dd>Returns 1 if the build window
 * (concurrent process buffer) is running.
 * Otherwise 0.</dd>
 * <dt>{@literal 'C'}</dt><dd>Returns start column of process request for input.
 * If the current line is not reading input for a concurrent 
 * process, 0 is returned.</dd> 
 * <dt>{@literal 'B'}</dt><dd>Returns 1 if the current buffer has a 
 * process running in it. Otherwise 0 is returned.</dd> 
 * <dt>{@literal 'E'}</dt><dd>Gets and/or sets the "Send input on Enter".
 ...
 * the process when the {@literal 'R'} option is explicitly specified. 
 * </dd> 
 * <dt>{@literal 'H'}</dt><dd>Returns 1 if the current line is reading 
 * input for a hidden password for a pseudo TTY. Otherwise, 0 
 * is returned.</dd> 
 * <dt>{@literal 'K'}</dt><dd>(Unix and macOS only) Returns 0. Sends 
 * backspace to pseudo TTY.</dd> 
 * <dt>{@literal 'P'}</dt><dd>(Unix and macOS only) Returns process id of 
 * process running in buffer.</dd> 
 * <dt>{@literal 'Q'}</dt><dd>Forcefully terminates the process running in 
 * the process buffer.</dd> 
 * <dt>{@literal 'R'}</dt><dd>Returns 1 if the build window is running.
 * Otherwise 0 is returned.  A delay is performed and
 * pending build window output is read into the
 * build window.</dd>
 * <dt>{@literal 'X'}</dt><dd>Returns 1 if the command shell running in
 ...
 * supported by {@literal 'R'}, {@literal 'X'}, {@literal 'Q'}, {@literal 'L'}, and {@literal 'S'} options. 
 *  
 * @param value  Specifies a new value for option. 
 * Currently, only the  {@literal 'L'} option supports this argument.
 * 
 * @return
 * 
 */
...
/**
 * Remarks {@code column} does not have a default value.
 * The third parameter defaults to {@literal 'L'}.
 *
...
/**
 * Returns a sub-string of input {@code string} containing tab
 * characters.  The {@code start} and {@code count} specification correspond to
 ...
 * <p>
 * By default, the tab characters in string specified by {@code start} and
 * {@code count} are expanded to spaces according to the current buffer's tab
 * settings.  Specify {@literal 'S'} for {@code option} if you only want to expand tabs to
 * spaces when a tab character is bisected.  If {@code count} extends past the
 * imaginary length of string, the result is padded with blank characters.  A
 * {@code count} of -1 specifies the rest of the input string starting from the
 * imaginary column {@code start}.  The {@code start} parameter must be greater
 * than zero.
 * @example
 * <pre>
 ...
 * the current line.  The current line is unchanged.  {@code left_edge} and
 * {@code cursor_y} are in pixels.  The {@link p_cursor_y} property may
 ...
 * the {@code number} argument.  The purpose of this function is to allow macros to flush
 ...
 * {@link point} function returns the seek position of the first previous
 ...
 *
 * <p>Specify {@literal 'L'} for {@code option} to get the current line number.  Unlike
 * the {@link p_line} property which determines the current line number
 * when it is not known, a line number of -1 is returned to indicate that the
 * line number is not known.</p>
 *
 * <p>Specify {@literal 'S'} for {@code option} to return just the offset to
 ...
 * {@link _GoToROffset}, {@link _QROffset}, {@link p_RLine}, and
 * {@link p_RNoflines} for dealing with disk seek positions and line
 * numbers.</p>
 *
 * @example
 * <pre>
 ...
 * {@code text_pos} may either be a seek position to any byte in the current
 ...
 * down.  If {@code line_number} is specified, the current line number is set to
 * line_number.  The built-in function {@link point} may be used to return the
 ...
 * retrieved by the built-in function {@link point}.</p>
 *
 ...
 * savable lines.  Use {@link _GoToROffset}, {@link _QROffset}, {@link p_RLine},
 * and {@link p_RNoflines} for dealing with disk seek positions and line numbers.</p>
 *
 ...
 * {@link _SetAllOldLineNumbers} method for
 * more information.</dd>
 *
 ...
 * the {@link p_MaxLineLength} property.  If there are any lines 
 ...
 * option is ignored if {@link p_binary}==true
 ...
 * {@link p_binary}==true or +B option
 * specified.</dd>
 *
 ...
 * {@link p_binary} property for other buffers.</dd>
 *
 ...
 * the {@link p_showeof} is true and the output
 ...
 * </dl>
 *
 * <p>The {@link p_modify} property is turned off if the output filename is
 ...
 *
 * @param options  {@code options} may contain one file or buffer name and the following options:
 *
 * <dl>
 ...
 *
 * <dt>+ or -LF</dt><dd>+LF Turns off loading entire file and
 * turns on fast line count. This is the fastest way to count
 ...
 * of {@link p_binary} property.  All edit/save options which performed
 ...
 * {@link p_showeof} property.  When on, EOF characters at the end of DOS files
 ...
 * buffer/window.  Wonderful option!  Helps {@link prev_buffer} and
 * {@link prev_window} commands to switch previously active file or window.</dd>
 *
 ...
 * files.</dd> 
 *
 * <dt>+F<i>nnn [<i>buf_name</i>]</i></dt><dd>Use <i>nnn</i> as 
 * the decimal value for the line separator character for new 
 * files.  Effects new files and existing 
 * files.</dd> 
 *
 ...
 * ending interpretation for existing files.</dd> 
 *
 * <dt>+FN<i>nnn [<i>buf_name</i>]</i></dt><dd>Use <i>nnn</i> as
 * the decimal value for the line separator character for new
 * files. Does not affect line
 * ending interpretation for existing files.</dd> 
 *
 * <dt>+ or -FN <i>buf_name</i></dt><dd> The word that follows
 * is the file or buffer name. This option allows for file or
 * buffer names that start with
 * - or +.
 *
 * <dt>+FENDDEFAULTS</dt><dd>When an editing mode switch is such as "+FTEXT" or
 * "+FUTF8" is specified, the value for the {@link p_encoding_set_by_user}
 * property is set.  When this option is specified,
 * {@link p_encoding_set_by_user} is set to -1.  This option made implementing
 * the {@link p_encoding_set_by_user} property easier.</dd>
 *
 ...
 *
 * <dt>+ or -BP</dt><dd>Turn on/off reinsert selected buffer/window after current
 * buffer/window.  Effects any macro which uses the {@link edit} command to
 * activate an existing buffer or window.  Effected commands include
 * {@link push_tag}, {@link next_error}, {@link edit}, {@link cursor_error}, and
 * {@link list_buffers}.  Helps the {@link prev_buffer} and {@link prev_window}
...
/**
 * Updates {@link p_left_edge} and {@link p_cursor_y} property to
...
/**
 * Be sure to look at the {@link get_string} function which prompts the user
...
/**
 * <p>Be sure to look at the macro function {@link get_string} which allow
 * a macro to read command line input from the user.</p>
 *
 * <p>{@link set_command} changes current setting of the command line.
 * Text of command line is set to {@code command_text}.   The selection
 * columns (1.. MAXINT) are set if {@code start_sel} is >=0.  If
 * {@code end_sel}<0, {@code end_sel} is set to {@code start_sel}.  The
 * {@code prompt} parameter sets the command prompt.  The prompt may
 * only be modified by the {@link set_command} primitive.</p>
 *
 * @example
 * <pre>
 *           command_text='dir ';
...
/**
 * @return Returns the cursor position (same as {@code end_pos}).
 * {@code start_pos}, if given, is set to the cursor position from which the
 * selection was started.  {@code end_pos}, if given, is set to the current cursor
...
/**
 * @return Sets the cursor position or selection.  If {@code end_pos} is not given,
 * the new cursor position is set to {@code start_pos} and no text is
 * selected.  If end_pos is given, the selection starts from
 * {@code start_pos} and ends at the cursor which is set to
 * {@code end_pos}.  The first text position is 1.
 *
 * @see _get_sel
 * @see p_sel_start
 * @see p_sel_length
 ...
 * When the {@link execute} function is issued, the current line of the
 * retrieve buffer becomes the last line.  However, the first execution of
 * {@link retrieve_prev} after {@link execute} is issued will place the
 ...
 * line.  When {@link execute} is issued, the current line of the retrieve
 ...
 * {@link p_ActiveEnabled} property when setting enabled state of a
 * non-active tab.
 *
 * <p>
 *
...
/**
 * Compares file parts {@code file1} to {@code file2} in the case sensitivity
 ...
 * _UTF8()==0 ), this function operates identically to the {@link _chr}
 * function.
 *
 * @categories String_Functions
 *
...
/**
 * @return Returns the number of bytes in {@code string}.
 *
 * @example
 * <pre>
 * length('abc')  == 3
...
/**
 * @return Returns the position of {@code needle} in {@code haystack}.  If
 * {@code needle} is not found, 0 is returned.
 *
 ...
 *                       following meaning:
 *                       <dl compact>
 *                       <dt>{@literal 'I'}</dt><dd>Ignore case.</dd>
 *                       <DT>{@literal 'R'}</DT><DD>Interpret string as a SlickEdit regular expression. See section <a href="help:SlickEdit regular expressions">SlickEdit Regular Expressions</a>.</DD>
 *                       <DT>{@literal 'L'}</DT><DD>Interpret string as a Perl regular expression. See section <a href="help:Perl regular expressions">Perl Regular Expressions</a>.</DD>
 *                       <DT>{@literal '~'}</DT><DD>Interpret string as a Vim regular expression. See section <a href="help:Vim regular expressions">Vim Regular Expressions</a>.</DD>
 *                       <DT>{@literal 'U'}</DT><DD>Interpret string as a Perl regular expression. See section <a href="help:Perl regular expressions">Perl Regular Expressions</a>. Support for Unix syntax regular expressions has been dropped.</DD>
 *                       <DT>{@literal 'B'}</DT><DD>Interpret string as a Perl regular expression. See section <a href="help:Perl regular expressions">Perl Regular Expressions</a>. Support for Brief syntax regular expressions has been dropped.</DD>
 *                       <dt>{@literal '&'}</dt><dd>Interpret string as a wildcard expression.
 *                       See section Wildcard Expressions.</dd>
 *                       <dt>{@literal 'Y'}</dt><dd>Binary search.  This allows start positions in the
 *                       middle of a DBCS or UTF-8 character.  This option
 *                       is useful when editing binary files (in SBCS/DBCS
 *                       mode) which may contain characters which look
 *                       like DBCS but are not.  For example, if you search
 ...
 *                       second character of a DBCS sequence unless this
 *                       option is specified.</dd>
 *                       <dt>{@literal 'A'}</dt><dd>Specifies an SBCS/DBCS active code page search.
 *                       {@code needle} and {@code haystack} must be
 ...
 *                       word boundaries (example {@literal "[A-Za-z0-9]"}).
 *
 * @example
 * <pre>
 * pos('a','zzz') == 0
 ...
 * tagged expression information.  Specifying {@literal 'S'} followed by a tagged
 * expression number (i.e. {@literal 'S0'}) will return the start position of that
 * tagged expression. 1 is returned if that tagged expression was not
 * found. If {@literal 'S'} is not followed by a number, the start position of the
 ...
 * last occurrence of {@code needle} in {@code haystack}.
 * If {@code needle} is not found, 0 is returned.
 *
 * @param needle         string to search for.  If this is the only parameter
 *                       it retrieves tagged expression information. (see example).
 * @param haystack       (optional) string to search within
 ...
 *                       searching begins at end of {@code haystack}.
 *                       {@code start} must be in the range 1..MAX_WHOLE_NUMBER.
 * @param options        (optional) Multiple options may be specified with the
 *                       following meaning:
 *                       <dl compact>
 *                       <dt>{@literal 'I'}</dt><dd>Ignore case.</dd>
 ...
 * </PRE>
 *
 * The {@code pos} and {@code lastpos} function return the same tagged
 ...
 * {@code strip_char}. {@code ltb} may be one of 3 values with the 
 * following meaning: 
 * <ol>
 * <li>{@literal 'L'} -- Remove leading {@code strip_char}
 * <li>{@literal 'T'} -- Remove trailing {@code strip_char}
 * <li>{@literal 'B'} -- (Default) Remove both leading and trailing 
 * {@code strip_char}
 * </ol>
 * <p>
 * If {@code strip_char} is omitted, both tabs and spaces are 
 * stripped. 
 *
 ...
 * {@code start| must be a positive whole number.
 *
 * @param string     input string
...
/**
 * @return Returns {@code true} if {@code string1} matches {@code string2} when
 ...
 *  
 * @return Returns {@code original} with all occurrences of 
 *         {@code search_for} replaced with {@code replace_with}.
 *         See {@link pos}</b> function for information on valid
 *         search {@code search_options}.
 *
 * @param original           String to modify
 * @param replace_with   String to replace occurrences of 
 *                       {@code search_for} with
...
/**
 * <p>If {@code option} =={@literal ''}, this function returns the first character position
 * in {@code string} which is not one of the characters in
 * {@code reference}.  If {@code string} is only composed of characters
 * from {@code reference}, then 0 is returned.</p>
 *
 * <p>If {@code option} == {@literal 'M'} , this function returns the first character
 * position in {@code string} which matches one of the characters in
 * {@code reference}.  If no characters in {@code reference} match a
 * character in {@code string}, 0 is returned.</p>
 *
 * <p>If <i>start </i>is specified, the searching begins at {@code start}.</p>
 *
 * @example
 * <pre>
 * verify("test.*","*?",'M')  ==6
...
/**
 * Returns a symmetrically padded string of {@code width} characters.
 * If the length of {@code string} is less than {@code width} characters, the
 * left and right of the returned string will be padded with the {@code pad} character.
 * The right will always be padded the same or more than the left.  If the length of
 * {@code string} is greater than or equal to {@code width} characters, the returned
 ...
 * <p>
 * If {@code compliment} is given and not zero, characters matching the
 ...
 * @param compliment      Replace char with {@code pad} character if it matches input table
 ...
 * to {@code number} if given.  Otherwise return code is set to 0.
 *
 * @see safe_exit
 * @see fexit
 * @categories Miscellaneous_Functions
 ...
 *    --You used {@link get_event} and read a key or mouse event and you want normal
 ...
 *      Specify the first and second parameters.  The {@link last_index} function with the {@literal 'p'} option will return the key message text.
 *    --You have written a keyboard hook function for the {@link on_select} event and you want
 *      processing to call the original event. Specify {@literal 'S'} for the third argument.
 *    --You have written an _on_hex() function and you want
 *      processing to call the original event. Specify {@literal 'E'} for the third argument.
 *    --You have written buffer specific keyboard callback by using the _kbd_add_callback()
 *      function and you want processing to call the original event. Specify {@literal '1'} for the third argument.
 *    --Specify {@literal 'L'} if you have already processed _on_select, _on_hex, _on_key
 * </pre>
 ...
 * <p>
 *    If 2 or more parameters are specified, the last event returned by the {@link last_event} function is set to key.
 * @example
 *
 *          key=get_event();
 *          call_key(key);
 ...
 *                     already-created object. If {@literal 'W'} or {@literal 'R'}
 ...
 *                     <ul>
 *                       <li>{@literal 'H'} = Load template hidden.
 *                       <li>{@literal 'E'} = Used internally by dialog editor. Load template in edit mode.
 *                       <li>{@literal 'A'} = Load template with ON_CREATE arguments passed on the interpreter stack. <b>IMPORTANT:</b> See VSLOAD_ARGPARAMS for more explanation before you attempt to use this option.
 *                       <li>{@literal 'W'} = Reload template with provided wid passed in index_or_wid parameter.
 *                       <li>{@literal 'R'} = Reinitialize template with provided wid passed in index_or_wid parameter. p_user, p_user2, * window geometry, default property values are reset.
 *                       <li>{@literal 'C'} = Do not call ON_CREATE events for loaded template. This includes ON_LOAD and ON_RESIZE. Use {@literal 'W'} to call these events later.
 *                       <li>{@literal 'P'} = Load template as a child of parent wid.
 *                       <li>{@literal 'N'} = Load template as a child of parent wid and do not draw a border.
 *                       <li>{@literal 'S'} = Create children of parent. Parent wid must be a handle to the already created parent.
 *                       <li>{@literal 'Y'} = Load template with ON_CREATE arguments passed as an array. Next argument is the array of ON_CREATE arguments.
 *                       <li>{@literal 'M'} = Use MDI callbacks. Useful for setting status line text when window is not an MDI child.
 *                       <li>{@literal 'T'} = Load template as toolbar.
 *                     </ul> 
 * 
...
/**
 * @param load_option may be {@literal 'L'},{@literal 'R'}, or {@literal 'U'}.  Module
 * name extensions are replaced with '.ex'.
 *
 * @return If {@code load_option}=={@literal 'L'} the modules specified are loaded if
 ...
 *
 * <p>If {@code load_option}=={@literal 'R'} the modules specified are loaded after the
 ...
 * successful completion, 0 is returned.  If any of the {@code modules} can not
 * be unloaded, the message "Can't remove module" will be displayed.</p>
 *
 * <p>If {@code load_option}=={@literal 'U'} the modules specified are unloaded.  If any
 * of the {@code modules} can not be unloaded because they are running, unloading
 ...
 * {@code name_prefix}.  If a match is not found, the global {@link rc} variable
 * is set to STRING_NOT_FOUND_RC and '' is returned.  If {@code find_first} is
...
/**
 * @return Returns the value of the environment variable {@code name}.  If
 * {@code name} is not found, rc is set to STRING_NOT_FOUND_RC and '' is
 * returned.
 *
 * @see env_match
 * @see set_env
...
/**
 *
 * Assigns {@code value} to the environment variable {@code name}.  If
 * {@code value} is not given, the environment variable is removed from
 * the environment.
 *
 ...
 *
 * <p>When the second parameter is {@literal 'D'}, this function returns (and sets if
 * {@code new_value} not ''), the index of the last command executed by a key or
 * the built-in {@link call_key} function.</p>
 *
 * <p>When the second parameter is {@literal 'C'}, this function returns (and sets if
 * <i>new_value </i>not ''), the index of the last command executed by any
 * mechanism.</p>
 *
 * <p>When the second parameter is {@literal 'P'}, this function returns the prefix key
 * message displayed on the message line for the last key sequence executed.
 * {@code new_value} parameter is ignored.</p>
 *
 * <p>When the second parameter is {@literal 'K'}, this function returns the index of
 * the last event table used to determine a key binding.  {@code new_value}
 * parameter is ignored.</p>
 *
 * <p>When the second parameter is {@literal 'W'}, this function returns (and sets if
 * {@code new_value} not ''), the command line/menu wait value.  This flag is set
 ...
 * function {@link call_key}. If {@code new_value} is specified and not '',
 * the index of the previous command is set to {@code new_value}.
 *
 * <p>When the second parameter is {@literal 'C'}, this command returns (and sets if
 ...
 * @return  Returns string containing {@code pcode_offset} and {@code filename}
 * of the last interpreter run-time error.  The filename returned has no path.
 * {@code pcode_offset} is the offset in .ex (pcode) file of error.  This
 * information may be passed to {@link st} command to find the corresponding line
 * of the last run-time error.  If the {@code pcode_offset} and {@code filename}
 ...
 *          {{@code name_prefix}  | ['-' | '+' {@code option_letters}]}
 * <p>
 * When prefix match is on, file names with prefix matching
 * {@code name_prefix} are returned (the prefix "abc" matches "abcd" and "abce").
 ...
 * are present in {@code name_prefix}, prefix matching is ignored.
 * <p>
 ...
 * <P>
 * @param find_first  A non-zero value for {@code find_first}, begins a new directory search.
 * If {@code find_first} is zero, the next matching file name is returned.  '' is
 * returned if no match is found and {@link rc} is set to the error code.  Search
 ...
 * {@code index}.  If {@code index} is not an index to a valid name, 0 is
...
/**
 * @return Returns name corresponding to name table entry {@code index}.  If
 * {@code index} is not an index to a valid name, '' is returned.  Names are
 ...
 * {@code index}.  If {@code index} is not an index to a valid name
...
/**
 * Replace info, corresponding to name table {@code index}.  If
 * {@code index} is not a valid index, the interpreter is halted.  Info may
 ...
 * by {@link find_index} to call a function or set a variable DOES NOT count as a
...
/**
 * Removes name entry corresponding to name table {@code index}.
 * If {@code index} is not a valid index, the interpreter is halted.
...
/**
 * Inserts {@code name} into names table with type and optional info.  Valid
 ...
 * {@code type} given is PICTURE_TYPE, {@code name} must be a filename.
 *
 * @return If successful, the index of the new name table entry is returned.
 * Otherwise 0 is returned and {@link rc} is set to INTERPRETER_OUT_OF_MEMORY_RC.
 ...
 * EVENTTAB_TYPE.  If the {@code type} given is PICTURE_TYPE,
 * {@code name} should be a filename.
 *
 ...
 * {@code string_constant}.  The binary key string returned is the same as the
...
/**
 * @return  Returns the event name corresponding to the binary {@code event}
 * string.  {@code Event} may have been returned by {@link get_event}(),
 * {@link test_event}(), and {@link last_event}() into a event name.
 *
 * @param  option defaults to {@literal 'S'} and may be one of the following:
 * <DL compact style="margin-left:20pt;">
 *    <DT>{@literal 'S'}  <DD>Return Slick-C&reg; source code event name.
 *    <DT>{@literal 'L'}  <DD>Return long menu bar event name.
 *    <DT>{@literal 'C'}  <DD>Return condensed menu bar event name.
 * </DL>
 * @example
 * <pre>
 *          key=get_event()
...
/**
 * @return  Returns the event index corresponding to the binary {@code event}
 * string given.  The event index returned by this function may be used by the
 * functions {@link eventtab_index}, or {@link index2event}. <i>event </i>may have
 * been returned by {@link get_event}(), {@link test_event}(), and
 * {@link last_event}().
 * @example
 * <pre>
 *         key=get_event();
...
/**
 * Converts key table {@code index} into the binary string representation of
 * keys returned by {@link get_event}(), {@link test_event}, and
 * {@link last_event}().
 *
 * @see get_event
 * @see test_event
 ...
 * to {@code key_index}.  The fourth parameter may be set to "U", to return the
 * index of the event table used.  If the mode event table has a non zero
 * binding for the key corresponding to {@code key_index} this index is returned.
 ...
 * {@code index} is invalid or does not correspond to a procedure or command, 0
 * is returned.
 *
 * @example
 * <pre>
 ...
 * the function is contained in.   See {@link vsDLLExport} for
...
/**
 * @return Returns n<sup>p</sup> -- {@code n} raised to the power of {@code p}. 
 *
 * @categories Miscellaneous_Functions
 */
...
/**
 * @return Returns {@code true} if {@code t} is a valid pointer to a function
...
/**
 * @return Returns non-zero value if {@code string} is a valid number of any
...
/**
 * @return Returns {@code true} if {@code string} is a valid signed or
 * unsigned integer. Returns true for integers up to 64-bits. If
 * {@code string} is floating point number, 0 is returned.
 *
 * @categories String_Functions
 *
 */
 ...
 * contains the byte at column {@code col}.
 *
...
/**
 * @return  Returns {@code true} if the 1 byte length string {@code ch} is a
 * valid first character of a double byte character (DBCS).  Always return
 * {@code false}, if the operating system is not in Japanese mode.
 * @example
 * <pre>
...
/**
 * @return  Returns {@code true} if the character at {@code i} in string is
...
/**
 * Returns value for system-metric {@code sm}. 
 *
 ...
 * class {@code class_name}.  The {@code title} of the window is checked
...
/**
 * Reads and dispatches all system messages until there are no more
 * messages or the timeout occurs, whichever comes first. 
 *  
 * @param cancel  (output) set to {@literal true} if the user hit Escape 
 * @param options Set of options indicating what events to handle
 *                <dl compact> 
 *                <dt>{@literal 'T'}</dt><dd>Process timer events</dd>
 *                <dt>{@literal 'E'}</dt><dd>Check for Escape key</dd>
 *                <dt>{@literal 'P'}</dt><dd>Allow user input</dd>
 *                </dl>
 * @param timeout (default 0, meaning no timeout) timeout in milliseconds
 *  
 * @example
 * <pre>
 * #include "slick.sh"
 ...
 * @categories Keyboard_Functions
 */
void process_events(bool &cancel, _str options="", int timeout=0);
/**
 * Converts (maps) the {@code x} and {@code y} coordinates from the coordinate
 * space relative to the {@code from_wid} to the coordinate space relative to the
 * {@code to_wid}.   If <i>scale_mode </i> specifies the input and output scale
 * mode for the {@code x} and {@code y} coordinates.
 *
 ...
 *                   
 *                   <dl>
 *                   <dt>{@literal 'I'}</dt><dd>Windows with {@link p_visible} false will be returned.</dd>
 *                   <dt>{@literal 'X'}</dt><dd>Exact buffer name match instead of prefix matching.</dd>
 *                   <dt>{@literal 'H'}</dt><dd>Windows with (p_window_flags &
 *                   HIDE_WINDOW_OVERLAP) true will be returned.</dd>
 *                   <dt>{@literal 'E'}</dt><dd>Only windows with {@link p_edit} true will be returned.</dd>
 *                   <dt>{@literal 'N'}</dt><dd>Only windows with {@link p_edit} false will be returned.</dd>
 *                   <dt>{@literal 'A'}</dt><dd>Non-MDI edit window ids will be returned.  By default,
 ...
 *         ({@link p_buf_name}) with prefix matching {@code name_prefix}.  A
 *         non-zero value for {@code find_first},  begins a new search.  If
 *         {@code find_first} is zero, the next matching window id is returned.  0
...
/**
 * @return Returns non-zero value if the {@code font_name} given is a
 * scalable font.
 *
 * @param options is a string of zero or more of the following option
 * letters:
 ...
 * font functions.
 *    <DT>P<DD>Get font type for print font {@code font_name}.
 ...
 * own Font dialog box  ({@code _font_form}).  The {@code cf_flags} and {@code font}
 ...
 *
 * @param font is a string in the format: {@code font_name}, {@code font_size}, {@code font_flags} [,]
 ...
 * returned in the same format as the {@code font} argument.  The {@code rgb_color}
 * is appended only if the CF_EFFECTS flag is specified.  However, a ',' will still
 * follow the {@code font_flags}.
 *
 * @see _font_form
 * @see _font_param
 *
 ...
 *                 <DL compact style="margin-left:20pt;">
 *                 <DT>{@literal 'A'}  </DT><DD>boolean. Alt  menu.  When {@code true}, won't accidentally get placed on menu bar when press Alt key not followed by another key.</DD>
 *                 <DT>{@literal 'C'}  </DT><DD>boolean. Display MDI child cursor position when do not have focus.  Default is on.</DD>
 *                 <DT>{@literal 'E'}  </DT><DD>boolean. Set Slick-C&reg; error position on weak interpreter error.  Effects {@link find_error} command.</DD>
 *                 <DT>{@literal 'F'}  </DT><DD>boolean. Maximize first MDI child.  Default is off.</DD>
 *                 <DT>{@literal 'H'}  </DT><DD>boolean. Display horizontal scroll bar on edit window.  Default is on.</DD>
 *                 <DT>{@literal 'I'}  </DT><DD>boolean. When on, a carriage return not followed by a new line in the build window erases current line.  Default is on.</DD>
 *                 <DT>{@literal 'K'}  </DT><DD>boolean. Cursor blink.  Default is on.</DD>
 *                 <DT>{@literal 'L'}  </DT><DD>int. Window left margin in twips for edit window and editor control.  Ignored when there are selective display bitmaps or any other line prefix bitmaps.  Default is 100.</DD>
 *                 <DT>{@literal 'N'}  </DT><DD>_str. Past EOF character.  Determines the character displayed on lines past the end of the file.  Useful for VI emulation.</DD>
 *                 <DT>{@literal 'P'}  </DT><DD>boolean.  Hide mouse when type character.  Default is off.</DD>
 *                 <DT>{@literal 'Q'}  </DT><DD>_str. This option is ignored.</DD>
 ...
 *                 <DT>{@literal 'R'}  </DT><DD>Column to display vertical line in edit window.  0 specifies no vertical line. Defaults to 0.</DD>
 *                 <DT>{@literal 'S'}  </DT><DD>int.  Default search flags.</DD>
 *                 <DT>{@literal 'T'}  </DT><DD>boolean. Display top of file line for edit window and editor control. Defaults to on.</DD>
 *                 <DT>{@literal 'U'}  </DT><DD>boolean. Draw box focus rect around current line for edit window and editor control. Defaults to off.</DD>
 *                 <DT>{@literal 'V'}  </DT><DD>boolean. Display vertical scroll bar on edit window.  Defaults to on.</DD>
 *                 <DT>{@literal 'W'}  </DT><DD>int. Maximum length of filename placed in menu in bytes.  Effects X windows only. Defaults to 40.</DD>
 *                 <DT>{@literal 'Z'}  </DT><DD>boolean. Protect read only mode.  When on, the editor will not allow read only files to be modified.  Saving a read only file always displays the Save As dialog box.  Defaults to on.</DD>
 ...
 * is used in conjunction with the {@link _iswindow_valid} function to loop
 * through all windows.
 *
 * @example
 * <pre>
...
int _last_window_id();
/**
 * @return Returns {@code true} if {@code window_id} is a valid window handle.
...
/**
 * @return Returns the window id of a displayed form whose {@link p_template}
 * property matches <i>form_index.</i>  Returns 0 if a match is not found.
 * {@code form_name} is an index into the names table of a form.  When a form is
 * loaded with the {@link _load_template} function ({@link show} calls this
 * function), the {@link p_template} property is set to the {@code form_index}
 * given to the {@link _load_template} function.   This allows a macro to
 ...
 * after the form is loaded.  The {@link p_template} property is read only and is
 * set only by the {@link _load_template} and {@link _update_template} functions.
 * Beware, by default, this function will find edited or non-edited instances of
 * an object.
 *
 * @param option may be {@literal 'N'} or {@literal 'E'}.  Specify the {@literal 'N'} option if you only
 * want to find a non-edited instance of an object.  Specify the {@literal 'E'} option if
...
/**
 * <p>If {@code newValue} is not null, the corresponding option is set to
 * {@code vewValue}.</p>
 *
 * <p> 
 * The options have the following meaning:
 * <dl compact>
 * <dt>{@literal 'R'}</dt><dd>Indicates whether repeated words should be flagged
 * as an error.  Returns non-zero value when on.</dd>
 * <dt>{@literal 'U'}</dt><dd>Indicates whether upper case words should be
 * ignored.  Returns non-zero value when on.</dd>
 * <dt>{@literal 'C'}</dt><dd>Specifies name of common word dictionary.
 * Returns name of dictionary.</dd>
 * <dt>{@literal 'M'}</dt><dd>Specifies name of main dictionary.  Returns name
 * of dictionary.</dd>
 * <dt>{@literal '1'}</dt><dd>Specifies name of user 1 dictionary.  Returns name
 * of dictionary.</dd>
 * <dt>{@literal '2'}</dt><dd>Specifies name of user 2 dictionary.  Returns name
 * of dictionary.</dd>
 * </dl>
 *
 ...
 * <dl compact>
 * <dt>{@literal 'H'}</dt><dd>Clear history.</dd>
 * <dt>{@literal '1'}</dt><dd>Clear user 1 dictionary</dd>
 * <dt>{@literal '2'}</dt><dd>Clear user 2 dictionary</dd>
 * <dt>{@literal 'R'}</dt><dd>Clear the repeat word.</dd>
 * </dl>
 *
 * @categories Miscellaneous_Functions
 *
 ...
 * @param option must be one of the folowing:
 * <dl compact> 
 * <dt>{@literal 'H'}</dt><dd>Delete word from history.</dd>
 * <dt>{@literal '1'}</dt><dd>Delete word from user 1 dictionary.</dd>
 * <dt>{@literal '2'}</dt><dd>Delete word from user 2 dictionary.</dd>
 * </dl>
 *
 * @categories Miscellaneous_Functions
 *
 ...
 * {@code replace_word} argument is given, occurrences of
 * {@code ignore_word} are replaced with the {@code replace_word}.
 *
 * @return Returns 0 if successful.
 *
 * @categories Miscellaneous_Functions
 ...
 * specified.  {@code user_dict1} and {@code user_dict2} specify output file
 * names.  The default user dictionary name set by the
 * {@link _spell_option} function is used if a dictionary name is not
 * specified.
 *
 * @return Returns 0 if successful.
 *
 ...
 * drive type of the drive specified.  {@code drive} is a drive letter followed
 ...
 * {@code form_wid} is the instance handle (window id) usually returned by one of
 * the functions {@link _load_template} or {@link show}.  All other forms, other
 * than {@code form_wid}, are disabled.  When the wait terminates, all forms are
...
/**
 * Creates a modal dialog box and displays {@code string} message and various
 * buttons.
 * 
 * @categories Miscellaneous_Functions
 * @param string   may contain carriage return characters to break a
 *                 string message into multiple lines.  By default, {@code string} is broken into
 *                 multiple lines on word boundaries if necessary.  The title of the dialog box
 *                 is set to {@code title} if given.
 * @param title
...
/**
 * Plays standard system beep if no parameters are specified or beeps for {@code frequency} and {@code duration}
 * specified.  {@code frequency} is specified in hertz.  {@code duration} is in milliseconds.  Under UNIX, the
 * {@code frequency} and {@code duration} parameters are ignored.
 *
 ...
 * We recommend that you use the {@link _dx2lx} function instead of
 ...
 * We recommend that you use the {@link _dy2ly} function instead of
 * this function because it may not be portable.
 *
...
/**
 * @return Returns date of {@code filename}.
 *
 * @param filename   file to retrieve date of
 * @param option     Currently you must specify the {@literal 'B'}
 *                   option which returns the date in binary string
 *                   comparison form.  '' is returned if {@code filename} is
...
/**
 * @return Returns the size of {@code filename}
 * 
 ...
 *                 <dl compact>
 *                 <dt>{@literal 'U'}</dt><dd>US format date mm/dd/yyyy.</dd>
 *                 <dt>{@literal 'L'}</dt><dd>Locale dependent date string.
 *                     Under Windows, this uses the regional settings "Short date style".
 *                     For other platforms, the format is settable
 *                     under "Appearance -&gt; General -&gt; Date display style.".</dd>
 *                 <dt>{@literal 'C'}</dt><dd>Returns date and time in the current locale long format. 
 *                     Under Windows, this uses the regional settings "Long date style".
 ...
 *                 <dt>{@literal 'S'}</dt><dd>Returns date and time in the current locale short format. 
 *                     Under Windows, this uses the regional settings "Short date style".
 *                     and "Time style."  For other platforms, the format is settable
 *                     under "Appearance -&gt; General -&gt; Date display style." and
 *                     under "Appearance -&gt; General -&gt; Time display style."</dd>
 *                 <dt>{@literal 'I'}</dt><dd>ISO 8601 format date yyyy-mm-dd.</dd>
 *                 </dl>
 *
 * @param date_time    (optional) Slick-C date time (YYYYMMDDhhmmssfff) 
 *                     to use instead of current date.
 *  
 * @see _time()
 * @see _file_date() 
 * @see strftime() 
 ...
 * @categories Miscellaneous_Functions
 */
_str _date(_str option='U', long date_time=0);
 ...
 * @param option  return value format option, may be one of the following:
 *                <dl compact>
 *                <dt>{@literal 'T'}</dt><dd>Return time in the format <i>hh</i>:<i>mmcc</i>
 *                    where <i>hh</i> is an hour between 1 and 12, mm
 *                    is the minutes between 0 and 59, and <i>cc</i> is
 *                    the "am" or "pm".</dd>
 *                <dt>{@literal 'B'}</dt><dd>Return binary time in milliseconds.
 *                    This options is used for comparing dates with the :&lt; and :&gt; operators.</dd>
 *                <dt>{@literal 'M'}</dt><dd>24-hour (Military) time in the format
 ...
 *                <dt>{@literal 'L'}</dt><dd>Returns time in the current local format. 
 ...
 *                     under "Appearance -&gt; General -&gt; Date display style." and
 *                     under "Appearance -&gt; General -&gt; Time display style."</dd>
 *                <dt>{@literal 'F'}</dt><dd>Return time in the format YYYYMMDDhhmmssfff
 ...
 *                    UTC/GMT.</dd> 
 *                <dt>{@literal 'G'}</dt><dd>Returns seconds elapsed since UNIX Epoch
 *                    (Midnight of January 1, 1970). This value is always in
 *                    UTC/GMT.</dd> 
 *                </dl> 
 *                
 * @param date_time    (optional) Slick-C date time (YYYYMMDDhhmmssfff) 
 *                     to use instead of current time.
 *  
 * @categories Miscellaneous_Functions
 *
 * @see _date()
 ...
 * @see strftime() 
 */
_str _time(_str option='T', long date_time=0);
...
/**
 * Inserts a list of font names or font sizes.  If the {@code font_name}
 ...
 */
int _create_tile_id();
bool _timer_is_valid(int timer_handle);
/**
 * Creates a timer and optionally calls a function you specify.
 * {@code interval} is specified in milliseconds.  {@code callback} is a
 * pointer to a function or names table index to a global function returned
 * by {@link find_index}.  {@code arg1} is a an optional argument to pass
 * to the call back function.  If only one argument is given, a
 * {@link get_event} timer is created.  This allows you to use get_event
 * in a loop and wait for a key or mouse event, or until the
 * {@link on_timer} event occurs.  When the {@code callback} argument
 * is not {@code null}, {@link get_event} is not effected.  Instead, the
 * callback function is called with the {@code arg1} argument if given at
 * intervals specified by {@code milli_interval}.
 *
...
/**
 * Frees the timer corresponding to {@code timer_handle}.  {@code timer_handle}
 * must have been allocated by the {@link _set_timer} function.  When
 * {@code timer_handle} is -1, the {@link get_event} timer is killed (see
 * {@link _set_timer}) Beware, if a timer callback function dies, the timer
 ...
 * Use the {@link clipboard_itype} function to determine the format of an
 ...
 * but there will be some internal clipboards.  Use the {@link clipboard_itype} function
 ...
 *                   {@code parent_wid}.  This flag is not valid for an OI_FORM object and
...
/**
 * @return Last mouse x position relative to active window in pixels. If the {@literal 'M'}
 ...
 *               {@literal 'M'} means to return value in current windows scale mode (p_scale_mode).
 *
 * @see p_scale_mode
 * @see mou_last_y
 * @see mou_get_xy
...
/**
 * @return Last mouse y position relative to active window in pixels. If the {@literal 'M'}
 * option is given the return value is in current windows scale mode (p_scale_mode).
 *
 * @param option (optional). '' means to return pixels.
 *               {@literal 'M'} means to return value in current windows scale mode (p_scale_mode).
 ...
 * form that is being edited.  If the {@code new_width} parameter is given, the
 * grid width is set to this value.  The {@code new_width} parameter is in twips
 ...
 * editor.  This affects the distance displayed between the dots displayed on a
 * form that is being edited.  If the {@code new_height} parameter is given, the
 * grid height is set to this value.  The {@code new_height} parameters is in
...
/**
 * @return  Returns non-zero value if the current window ({@link p_window_id}) is
...
/**
 * Runs the command currently on the command line or the {@code command}
 ...
 * {@code defmain} entry point).  If the {@code command} argument is {@code null},
 * the command line is erased and the command is inserted into the command
 * retrieve buffer ".command".  See {@link retrieve_prev}, {@link retrieve_next}.
 *
 * @param command
 * @param options a string of one or more of the following letters:
 *                <DL compact style="margin-left:20pt;">
 *                <DT>W <DD>If command is an external program, run {@link slkwait} program to wait
...
/**
 * Fills the selection specified with {@code character}. 
 * 
 * @appliesTo Edit_Window, Editor_Control
 * @categories Selection_Functions
 * @param ch
 * @param mark_id
 * {@code mark_id} is a handle to a selection returned by one of 
 * the built-ins 
 * {@link _alloc_selection} or {@link _duplicate_selection}.  A {@code mark_id} of
 * '' or no {@code mark_id} parameter identifies the active selection.
 ...
 *                the built-ins {@link _alloc_selection} or {@link _duplicate_selection}.
 *                A {@code mark_id} of '' or no {@code mark_id} parameter identifies the
 *                active selection.  This function performs a "binary" delete when in
 *                hex mode ({@link p_hex_mode}=={@code true}).  A binary delete allows
 ...
 * mark may be showing at a time.  {@code mark_id} is a handle to a
 * selection returned by one of the built-ins {@link _alloc_selection} or
 * {@link _duplicate_selection}.  A {@code mark_id} of '' or no
 * {@code mark_id} parameter identifies the active selection.
 *
 * @return Returns 0 if successful.  Otherwise
 ...
 * {@literal 'B'} option is used for allocating a book mark.  Bookmarks can not be deleted.</p>
 *
 ...
 *         {@code mark_id} is a handle to a selection returned by one of the built-ins
 *         {@link _alloc_selection} or {@link _duplicate_selection}.
 *         <p>
 *         <b>IMPORTANT:</b>  If an empty string ('') is specified for the {@code mark_id}
 ...
 * {@code mark_id}.  {@link _free_selection} will not free the active selection
 * (the one that is seen on screen).  Use {@link _show_selection} if necessary to
 * activate another selection before freeing the selection.  {@code mark_id} is a
...
/**
 * Clears selection specified.  {@code mark_id} is a handle to a
 * selection returned by one of the built-ins {@link _alloc_selection}
 * or {@link _duplicate_selection}.
 *
 ...
 * {@link _alloc_selection} built-in.  A {@code mark_id} of '' specifies the
 * active selection or selection showing and is always allocated.  The
 * third parameter is only supported by the {@literal 'T'} option.
 *
 * @param option may be {@literal 'T'}, {@literal 'S'}, {@literal 'P'}, {@literal 'I'}, {@literal 'U'}, {@literal 'A'}
 *
 * <p>If a value of {@literal 'T'} is specified for {@code option}, one of the selection
 * types "BLOCK", "CHAR", "LINE" or "" is returned.  If the third
 * parameter is specified, the selection style is set to {@code new_type}
 * which must be "BLOCK", "CHAR", or "LINE".  A null string is
 * returned if the selection specified has not been set.</p>
 *
 * <p>When a value of {@literal 'S'} is specified for {@code option}, the select style is
 * returned.  Select styles are {@literal 'C'} or {@literal 'E'} which correspond to cut/paste
 ...
 *
 * <p>If a value of {@literal 'P'} is specified for {@code option}, selection anchor (pivot
 ...
 * letter is {@literal 'B'} if the begin mark is the line anchor or {@literal 'E'} if it is not.  The
 * second letter is {@literal 'B'} if the begin mark is the column anchor or {@literal 'E'} if it is
 * not.  The null string is returned if the selection specified has not been
 * set.</p>
 *
 * <p>If a value of {@literal 'I'} is specified for {@code option}, a {@literal '1'} is returned if the
 * selection specified is an inclusive selection.  A {@literal '0'} is returned if the
 ...
 *
 * <p>When a value of {@literal 'U'} is specified for {@code option}, a {@literal 'P'} is returned if
 * the selection specified is a persistent mark.  Otherwise, '' is returned.</p>
 *
 * <p>When a value of {@literal 'A'} is specified for {@code option}, a {@literal '1'}
 * is returned if columns are adjusted for the selection 
 * specified. Otherwise, {@literal '0'} is returned. This option is only 
 ...
 * resulting reflowed text output from the {@link _reflow_selection} function.
 * If the cursor does not need to be moved, {@code Noflines_down} will be a
 * negative number, otherwise {@code Noflines_down} indicates the number of lines
 * to move down in the reflowed text, and {@code col} specifies
...
/**
 * If the {@literal 'C'} argument is specified the scroll style is set to center scrolling,
 * both horizontally and vertically.  The {@literal 'V'} option specifies center
 * scrolling vertically, and smooth scrolling horizontally.
 * The {@literal 'H'} option specifies center scrolling horizontally and smooth
 ...
 * text that is not in view.  {@code number} specifies how close the cursor
 * may get to the top or bottom of the window before scrolling occurs.
 * For the {@link bottom} primitive, center scrolling style will also cause
 * the bottom line of the buffer to be centered when the end of the
 * bottom line is within view.  Scrolls style affects: {@link left},
 * {@link right}, {@link up}, {@link down}, {@link _rubout},
 * {@link tab}, {@link backtab}, {@link insert_line}, {@link keyin} and
 ...
 * case and returns current case sensitivity.  {@literal 'E'} specifies case sensitive
 * searching by default.  {@literal 'I'} specifies case insensitive searching by default.
 * The built-in {@link search} command will default to this case unless
 * the {@literal 'E'} or {@literal 'I'} is specified to override the default.
 *
 * @see repeat_search
 * @see _select_match
 * @see match_length
 ...
 * <pre>
 * {@code cmdline} is a string in the format: [+|-][R][H][S][A] <i>filename</i>
 *
...
/**
 * Changes to drive and directory specified.  If {@code changeDrive}
...
/**
 * Removes directory specified by {@code path}.
 *
 * @return Returns 0 if successful.  Common return codes are
...
int mkdir(_str path);
/**
 * @return Returns the current working directory for the {@code drive}
 * specified.  {@code drive} must be a one-character drive letter.  The
 * {@code drive} argument is ignored under UNIX.
 *
 * @example
 * <pre>
 ...
 * environment variable {@code env_var} are searched.
 *
 ...
 * @param options    is a string of zero or more of the following:
 * <dl compact>
 * <dt>{@literal 'P'}</dt><dd>Program search.  Does not effect UNIX.</dd>
 * <dt>{@literal 'M'}</dt><dd>Program search including search for .e and .ex Slick-
 * C batch macros.</dd>
 * <dt>{@literal 'S'}</dt><dd>Don't search in current directory.  Does not effect
 * UNIX.</dd>
 * <dt>{@literal 'V'}</dt><dd>indicates that contains a search path value 
 *                 rather than an environment variable name</dd>
 * <dt>{@literal 'R'}</dt><dd>relative path search. Append filename to each
...
/**
 * Deletes the {@code filename} specified.
 *
 * @return  Returns 0 if successful.  Common return codes are
 * ACCESS_DENIED_RC, ERROR_OPENING_FILE_RC, FILE_NOT_FOUND_RC,
...
/**
 * Returns f{@code ilename} with exact path specification as if the current directory was {@code toDir}.
 *
...
/**
 * @return Returns {@code filename} with relative path specification as if the
 * current directory was {@code toDir}.  If {@code toDir} is null, the current
 * directory is used.
 *
 * @example
 * <pre>
 ...
 * from {@link get_event} or {@link test_event}.  If the {@code event} parameter is
 * specified, the last event is set to {@code event}.  For ASCII keys, a string
 * of length 1 is returned.  For extended keys like Alt+L, and ESC, a string of
 * length 2 or 3 is returned.  Use the {@link mou_mode} function if you want
 * button-up events returned by {@link get_event}.
 *
 ...
 *
 * <p>If the {@literal 'R'}  is not given, the screen is refreshed.</p>
 *
 * @param options  defaults to '' and may be {@literal 'R'} and/or {@literal 'K'}:
 *
 * <dl>
 * <dt>{@literal 'R'}</dt><dd>Specifies no screen refresh.</dd>
 * <dt>{@literal 'K'}</dt><dd>Return keys from physical keyboard and not
 * keyboard macro that is being played back.</dd>
 * <dt>{@literal 'P'}</dt><dd>UNIX only.  Causes all messages except keyboard
 ...
 * <dl>
 * <dt>{@literal 'R'}</dt> <dd>Specifies no screen refresh.</dd>
 * <dt>{@literal 'K'}</dt><dd>Return keys from physical keyboard and not keyboard macro that is
 * being played back.</dd>
 * <dt>{@literal 'N'}</dt><dd>Get next key.  When a Slick-C&reg; macro uses {@link get_event} for
 * multiple key sequence key bindings, all {@link get_event} calls after the
 ...
 * <dt>{@literal 'D'}</dt><dd>Return and possibly set the prefix key delay in 10ths of seconds.
 * To set the prefix key delay, concatenate a number to the {@literal 'D'}.  For example,
 * the parameter {@literal 'D4'} sets the prefix key delay to .4 seconds.  The current or
 * new prefix key delay is returned.</dd>
 * <dt>{@literal 'B'}</dt><dd>Reset mouse button click count to zero.</dd>
 * <dt>{@literal 'U'}</dt><dd>Always return unshifted key with SHIFT 
 * modifier (Ex: '&lt;' = Shift+,).</dd> 
 * <dt>{@literal 'F'}</dt><dd>Ignore FocusIn events coming to the 
 * command line</dd> 
 * </dl>
 *
 * <p>
 * If {@literal 'R'} option is not given, the screen is refreshed.
 * </p>
 *
 * @example
 * <pre>
...
/**
 * Waits {@code secondsX100} is in hundredths of a second.  If {@literal 'K'}
 * is specified for {@code option}, this function returns when a key is pressed.
 * @categories Miscellaneous_Functions
 */
void delay(int secondsX100,_str option="");
/**
 * Returns execution to the statement after the last {@link _suspend}.
 * This function is used in conjunction with {@link _suspend} to check
 * for critical errors which halt the interpreter.  Critical errors which halt
 * the interpreter automatically issue a {@link _resume}.  If a
 * {@link _suspend} was issued, the following statement receives control
 * and can check the {@link rc} variable to determine the reason for the
 * {@link _resume}.  Before executing the {@link _resume} statement
 * you will want to set the {@link rc} variable to a positive value to
...
void _resume();
/**
 * Pushes a new level for a signal handler.  After a {@link _suspend} has
 * been executed, errors which halt the interpreter will set the variable
 * {@link rc} to the error code and {@link _resume} execution at the
 * first statement after {@link _suspend}.  The {@link _resume} function
 * restores the interpreter stack and code position to the state it was in
 * after the last {@link _suspend} was executed.  Be sure to execute
 * {@link _resume} to restore the previous signal handler.  This function
 * sets the {@link rc} variable to 0 if successful.  Interpreter is stopped if
...
/**
 * @return Returns length of the path in the string {@code filename} including
 * trailing backslash.
 *
 * @categories File_Functions
 *
...
/**
 * @return Returns the default path for the editor spill file.  When {@code path} is
 * not null, the default spill file path is set to {@code path}.  If the spill file
 ...
 * If {@code buffer_ksize} is less than zero, the cache will grow until no memory is available.
 ...
 * <p>
 * The {@code state_ksize} parameter specifies the maximum amount of swappable state file data (parts
 ...
 * built-in function {@link concur_shell}.
 *  
...
/**
 * @return
 * Returns {@literal 'WINDOWS'} if running under Windows NT or newer on an Intel compatible
 * machine.  Returns {@literal 'NT386'} if running under Windows NT on 386 compatible machine.
 * Returns {@literal 'NTMIPS'} if running under Windows NT on
 * MIPS/compatible machine.  Returns NTALPHA if running under Windows NT
 * on a DEC ALPHA AXP machine.  Returns {@literal 'SPARC'} if running under SUN SPARC
 * station.  Returns {@literal 'RS6000'} if running under AIX RS600.  Returns {@literal 'NTPPC'}
 * if running under Windows NT on a PowerPC.  Returns {@literal 'LINUX'} if running
 * under LINUX on Intel machine.  Returns {@literal 'HP9000'} if running under UNIX
 * on HP9000.  Returns {@literal 'SGMIPS'} if running under UNIX on Silicon Graphics
 * machine. Returns {@literal 'MACOSX11'} if running under macOS on a
 * PowerPC.
 * <ul>
 ...
 * <li>"MACOSX-M1"       -- Native macOS on M1 ARM
 * </ul>
 *
 * @see _win32s
 * @see machine_bits 
...
/**
 * @return
 * Returns {@literal '64'} if running a 64-bit version of SlickEdit on a platform 
 * such as 64-bit Windows 7 or Linux.  Otherwise, return {@literal '32'}. 
 * <P> 
 ...
 * can return {@literal '32'} even if you are running a 64-bit OS if you are running 
 ...
 *             <li><b>-sticky</b> -- return {@literal 'true'} if the current message on the message line is sticky
 ...
 *    <li>V -- If the {@literal 'V'} (verbose) option is specified,
 ...
 *
 * @param option defaults to {@literal 'E'} if not given or ''.
 * @param new_value (optional). Set new value for option.
 *                  Only valid for {@literal 'R'} option.
 * <pre>
 * Input Return Value
...
/**
 * Sets the screen element corresponding to {@code ColorIndex} to the foreground
 * and background colors given. The {@code fg_color} and {@code bg_color} parameters
 * specify an RGB color.  Use the {@link _rgb} function to build these colors.
 *
 ...
 *                      attributes from.
 * @param profile_name  color profile to get color for 
 *
 ...
 * </pre>
 * @return  Returns the current font string value in the same format as the {@code font} argument.
 * @categories Miscellaneous_Functions
 */
 ...
 *
 * <dl compact style="margin-left:20pt">
 * <dt>{@literal 'Q'}</dt><dd>Run program without showing console window.  DO NOT 
 * USE WITH {@literal 'W'} OPTION.</dd> 
 *
 * <dt>{@literal 'P'}</dt><dd>Do not search for SlickEdit batch programs.</dd>
 *
 * <dt>{@literal 'A'}</dt><dd>Run program asynchronously.</dd>
 *
 * <dt>{@literal 'W'}</dt><dd>Run slkwait program to wait for a key press before
 * closing application.  DO NOT USE WITH {@literal 'Q'} OPTION.  Under UNIX, this 
 * argument is ignored if {@code shell_processor} is specified.</dd> 
 *
 * <dt>{@literal 'N'}</dt><dd>No command processor.  Use this option when you
 ...
 * {@code program} argument, the command processor
 * is used to process the {@code program} argument.
 * This can cause a command shell window to be
 * created when you are trying to run a windows
 * program.</dd>
 *
 * <dt>{@literal 'B'}</dt><dd>Allow user to break by pressing Ctrl+Alt+Shift
 * (Windows only).</dd>
 * </dl>
 *
 * <p>For UNIX, the {@code shell_processor} argument allows you to specify
 * an alternate shell command line to parse the {@code command} string
 * specified.  For non-UNIX platforms, this argument is ignored.
 * {@code shell_processor} defaults to  "<b>$SHELL -c</b>".  For
 * backward compatibility with SlickEdit, if
 * {@code shell_processor} does not contain a space, "<b> -c</b>" is
 ...
 * multiple labels with borders and various options.  {@code index} starts
 * at 0 and indicates which label you are setting the {@code width},
 * {@code flags}, and {@code state} for.  You must initialially create
 ...
 * _UTF8()==0 ), this function operates identically to the {@link _asc}
 * function.
 *
 * @categories Unicode_Functions
 */
 ...
 * @param free_markid
 *               When non-zero, {@link _free_selection} is called for the markid belonging to this bookmark.
 *
 * @see _BookmarkAdd
 * @see _BookmarkRemove
 * @see _BookmarkRestore
 ...
 * @param markid    Selection id returned from {@link vsAllocSelection} or {@link vsDuplicateSelection}.
 * @param vsbmflags Combination of VSBMFLAGS_??? ORed together.
 * @param RealLineNumber
 *                  Real line number of bookmark.  Specify -1 if {@code markid} is an active bookmark.
 * @param col       Column of bookmark.  Specify 0 if {@code markid} is an active bookmark.
 * @param BeginLineROffset
 *                  Real offset to beginning of line.  Imaginary line data not counted.  Specify 0 if {@code markid} is an active bookmark.
 * @param LineData  Text on the line of the bookmark.  Specify 0 if {@code markid} is an active bookmark.
 * @param Filename  Filename the bookmark is in.  Specify 0 if {@code markid} is an active bookmark.
 * @param DocumentName
 *                  Document name the bookmark is in.  Specify 0 if {@code markid} is an active bookmark.
 *
 * @see _BookmarkAdd
 * @see _BookmarkRemove
 * @see _BookmarkRestore
 ...
 * @param profile_name  (optional) color profile to allocate color in 
 *                      (defaults to color profile of current editor control) 
 *  
 * @example
 * <PRE>
 * int gColorIndex;
 ...
 * @categories Edit_Window_Methods, Editor_Control_Methods
 */
int _AllocColor(int fg=0x000000, int bg=0xffffff, int fontFlags=0, int parent_color=0, _str profile_name=null),
    _sc_lang_editor::_AllocColor(int fg=0x000000, int bg=0xffffff, int fontFlags=0, int parent_color=0, _str profile_name=null);
 ...
 * @categories Edit_Window_Methods, Editor_Control_Methods
 */
void _FreeColor(int cfg, _str profile_name=null),
    _sc_lang_editor::_FreeColor(int cfg, _str profile_name=null);

/**
 * If {@code parent_color} is not specified, just return what color index 
 * {@code cfg} inherits color or font attributes from.  If {@code parent_color} is 
 ...
 * @param parent_color  color index for {@code cfg} to inherit from.
 * @param profile_name  (optional) color profile to allocate color in 
 *                      (defaults to color profile of current editor control) 
 * 
 ...
 * @categories Edit_Window_Methods, Editor_Control_Methods
 */
int _InheritColor(int cfg, int parent_color=0, _str profile_name=null),
    _sc_lang_editor::_InheritColor(int cfg, int parent_color=0, _str profile_name=null);
 ...
 *                  which corresponds to the symbol under the cursor.  The clexflags argument
 *                  is ignored.  This option is very similar to the {@literal 'G'} option above,
 ...
 *  
 *                  <P>
 *                  The option parameter may include a '-' (dash) character to enable the {@literal 'O'}
 *                  and {@literal 'N'} options to search backwards.
 *                  </P>
 *
 * @return
 * @example
 ...
 *    {@literal 'R'} - 'RTF Format' (Windows format)
 *    {@literal 'H'} - 'HTML Format' (Windows format)
 *
 * @param markid Handle to a selection returned by one of the built-ins _alloc_selection or
 *               _duplicate_selection.  A mark_id of '' or no mark_id parameter identifies
 *               the active selection.
 ...
 * {@link _menu_load}, {@link _menu_find}, or {@link _menu_get_state}.  Specify 0
 * if you want this parameter to be ignored.
 *
 * @param resource_handle Handle to menu resource returned by
 * {@link find_index}, {@link name_match}, {@link p_child}, {@link p_next}, or
 * {@link p_child}.  Specify 0 if you want this parameter to be ignored.
 *
 * @param command Name of command to bind
 *
 * @param key_string If option=={@literal 'B'}<i>, key_string</i> is displayed to
 * right of menu items which execute {@code command}.  If option=={@literal 'U'}, key
 ...
 *
 * <dl>
 * <dt>{@literal 'B'}</dt><dd>{@code key_string} is displayed to right of menu items which
 * execute {@code command}.</dd>
 * <dt>{@literal 'U'}</dt><dd>Key strings for menu items which display key string to
 * right of menu item are removed.</dd>
 * <dt>{@literal 'C'}</dt><dd>Clear all bindings for {@code menu_handle} or
 * {@code resource_handle}.</dd>
 * </dl>
 *
 * @return Returns 0 if successful.
 *
 ...
 * {@link p_menu_handle}, {@link _menu_load}, {@link _menu_find}, or
 * {@link _menu_get_state}.
 *
 * @param command_or_category
 * Command or category of menu item to find.  If a command is specified, the
 * command must match exactly.  See {@code option} parameter.
 *
 * @param output_menu_handle
 * Handle to loaded menu which contains menu item found.
 *
 * @param output_menu_pos
 * Position of menu item found within {@code output_menu_handle}.  0 is the
 * position of the first menu item.  Use the {@link _menu_info} function to
 * determine the number of items in a loaded menu.<i></i>
 *
 * @param option
 * May be {@literal 'M'} or  {@literal 'C'}.  If the {@literal 'M'} option is given,
 * {@code command_or_category} is the command of the menu item to be found.  If
 * the {@literal 'C'} option is given,  {@code command_or_category} is the category of the
 * menu item to be found.  Defaults to {@literal 'C'} if not specified.
 *
 * @return Returns 0 if successful.
 *
 * @example
 ...
 * {@code src_menu_index} and {@code dest_menu_index} do not have to be the same
 * menu.  {@code src_menu_index} and {@code dest_menu_index} are returned by
 * {@link find_index}, {@link name_match}, {@link p_child}, {@link p_next}, or
 * {@link p_child}. This function currently only supports menu resources and not
 * loaded menus.
 *
 * @see on_init_menu
 * @see _menu_add_filehist
 ...
 * @param menu_handle Handle of loaded menu returned by
 * {@link p_menu_handle}, {@link _menu_load}, {@link _menu_find}, or
 * {@link _menu_get_state}.  This handle may also be a handle to menu resource
 * returned by {@link find_index} or {@link name_match}.<i></i>
 * menu_pos Position within menu {@code menu_handle}.  The first menu item
 * position is 0.
 *
 * @example
 * <pre>
 ...
 * returned by {@link find_index} or {@link name_match}.<i></i> 
 *  
 * @param menu_pos Position within menu {@code menu_handle}. 
 ...
 *
 * @param mf_flags {@code mf_flags} may be zero or more of the following
 * flags defined in "slick.sh":
 *
 * <ul>
 * <li>MF_CHECKED</li>
 ...
 * This parameter is ignored if {@code mf_flags} contain the MF_SUBMENU flag.
 *
 * @param categories Menu item categories.  May be one or more categories
 * separated with a '|' character.  See {@link _menu_set_state} function for more
...
/**
 * Destroy menu loaded by the {@link _menu_load} function.  This function is
 * typically used to destroy the old menu bar when replacing a menu bar or to
 * destroy a pop-up menu after it has been displayed.  {@code menu_handle} is
 * typically returned by {@link p_menu_handle} or {@link _menu_load}.
 *
 * @return Returns 0 if successful.
 *
 * @see on_init_menu
...
/**
 * @return Returns number of menu items in loaded menu {@code menu_handle}.
 * {@code menu_handle} is returned by {@link p_menu_handle}, {@link _menu_load},
 * {@link _menu_find}, or {@link _menu_get_state}.
 *
 * @see on_init_menu
 * @see _menu_add_filehist
 * @see _menu_add_hist
 ...
 *       MF_GRAYED
 *       MF_ENABLED</pre>
 * @param option                 May be {@literal 'M'}, {@literal 'C'}, {@literal 'P'}.  If the {@literal 'M'} option is given, command_or_category is the command of the menu item to be found. If the {@literal 'C'} option is given,  command_or_category is the category of the menu item to be found.  If the {@literal 'P'} option is given, command_or_category is the position (0.._menu_info(menu_handle)-1) of the menu item with in menu_handle.  Defaults to {@literal 'C'}.
 ...
 *
 * @param command_or_category
 * Command, category, or position within {@code menu_handle} of menu item.  If
 * a command is specified, the command must match exactly.  See {@code option}
 * parameter.
 *
 * @param option May be {@literal 'M'}, {@literal 'C'}, {@literal 'P'}.  If the {@literal 'M'} option is given,
 * {@code command_or_category} is the command of the menu item to be found. If
 * the {@literal 'C'} option is given,  {@code command_or_category} is the category of the
 * menu item to be found.  If the {@literal 'P'} option is given,
 * {@code command_or_category} is the position
 * (0..<b>_menu_info</b>(<i>menu_handle</i>)-1) of the menu item with in
 * {@code menu_handle}.  Defaults to {@literal 'C'}.
 *
 * @param mf_flags {@code mf_flags} may be zero or more of the following
 * flags defined in "slick.sh":
 *
 ...
 * @param caption Menu item title.
 *
 * @param command For sub-menu, {@code command} is a menu handle which may be
 * used in calls to {@link _menu_get_state} or {@link _menu_info}.  Otherwise,
...
int _set_menu_state(int menu_handle ,_str command_or_category,
                    ...
                    _str help_message="");
/**
 * This function is identical to the {@link _menu_get_state} function and is
 ...
 * {@link _menu_get_state}.
 *
 * @param vpm_flags Defaults to VPM_LEFTBUTTON|VPM_LEFTALIGN.  {@code vpm_flags}
...
void _QtPrintPreviewDialog(_str reserved="", 
                           int editorctl_wid=0,
 ...
 * formatted text.  Usually the {@link _create_temp_view} function is
 ...
 * </dl>
 *
 * <p>The letters {@literal 'c'}, {@literal 'l'}, and {@literal 'r'} correspond to the header or footer at the center,
 ...
 *
 */
void _tprint_format(int output_view_id,
                    _str filename="",
                    _str options="",
 ...
 * can cancel printing by calling the {@link _print_cancel} function.
 *
 ...
 * </dl>
 *
 * <p>The letters {@literal 'l'}, {@literal 'c'}, and {@literal 'r'} correspond to the header or footer at the left,
 ...
 *       the item specified by {@code ItemIndex}.</dd>
 ...
 *       Otherwise, {@code overlayBitmapIndex} is ignored.</dd>
 * </dl>
 *
 * @param overlayBitmapIndex  Names table index to a picture which gets 
 *                            overlayed on top of the {code bitmapIndex} picture.
...
/**
 * @return Returns the user info value set by the {@link _TreeSetUserInfo}
 ...
 * @param option     all values for {@code option} are deprecated
 *
 * @appliesTo Tree_View
 * @categories Tree_View_Methods
 */
 ...
 * {@code ItemIndex}.  -1 is returned if the node specified has no children.
 *
 ...
 * specified by {@code ItemIndex}.  -1 is returned if the node specified has
 * no previous sibling.
 *
 * @param ItemIndex     Specifies a tree item.
 *
 ...
 * {@code ItemIndex}.  -1 is returned if the node specified has no next
 * sibling.
 *
 * @param ItemIndex     Specifies a tree item.
 *
 ...
 * is a list box.  By default, will not return hidden nodes.  Specify {@literal 'H'} to
 ...
 * list box.  By default, will not return hidden nodes.  Specify {@literal 'H'} to
 * return hidden nodes. -1 is returned if the node specified has no next
 * node.
 *
 * @param ItemIndex     Specifies a tree item.
 ...
 * {@code ItemIndex}.  -1 is returned if the node specified has no parent
 * (this only happens when {@code ItemIndex} is 0).
 *
 * @param ItemIndex     Specifies a tree item.
 *
 * @see _TreeGetNextSiblingIndex
...
/**
 * Deletes the tree item specified and all its descendants.  {@code option}
 ...
 *    <DL>
 *    <DT>{@literal 'F'}<DD>Sort filenames
 *    <DT>{@literal 'N'}<DD>Sort numbers
 *    <DT>{@literal 'E'}<DD>Exact Case.  Sort is case insensitive if this
 *    option is not specified
 *    <DT>{@literal 'I'}<DD>Sort case insensitive
 *    <DT>{@literal 'B'}<DD>First try case insensitive compare, then
 *    perform insensitive
 *    <DT>{@literal 'D'}<DD>Descending.  Sort is ascending if this option
 *    is not specified
 *    <DT>{@literal '2'}<DD>Sort based only on filename part of caption
 *    <DT>{@literal 'T'}<DD>Traverse children (sort recursively)
 *    <DT>{@literal 'P'}<DD>Sort parents nodes at the top. Here
 *    we consider a parent nodes to be those with ShowChildren
 *    >= 0.
 *    <DT>{@literal '='}<DD>Place parents nodes at the top after sort. Here
 *    we consider a parent nodes to be those with ShowChildren
 *    >= 0.
 *    <DT>{@literal 'U'}<DD>Remove duplicates
 *    <DT>{@literal 'H'}<DD>Hide duplicates
 *    <DT>{@literal 'C'}<DD>Sort current sort column only
 *    <DT>{@literal 'M'}<DD>Sort tab delimited column (column specified in
 ...
 * key.   See {@code PrimarySortOptions}.
 *
 * @see _TreeSortUserInfo
 *
 * @appliesTo Tree_View
 ...
 * children to be searched.  If the {@literal 'S'} option is
 ...
 *
 * <dl>
 * <dt>{@literal 'I'}</dt><dd>Case insensitive search.</dd>
 * <dt>{@literal 'P'}</dt><dd>Prefix match.</dd>
 * <dt>{@literal 'C'}</dt><dd>Contains match.</dd>
 * <dt>{@literal 'S'}</dt><dd>Search siblings.  When this is specified,
 * {@code itemIndex} is the first sibling
 * searched.  By default, {@code itemIndex}
 * is the parent of the items to be searched.</dd>
 * <dt>{@literal 'T'}</dt><dd>Search recursively through the tree.  By
 * default, only one level is searched.</dd> 
 * <dt>{@literal 'H'}</dt><dd>Search hidden nodes.</dd>
 * 
 * </dl>
 *
 ...
 * are list box.  If {@code lineNumber}>=0, the current node is set to the
 ...
 *
 * @param ItemIndex     Specifies a tree item.
 * @param options       If {@literal 'T'}, get the number of children recursively
 *
 * @appliesTo Tree_View
 * @categories Tree_View_Methods
 */
 ...
 * @param options       if {@literal 'T'}, update the node and all child nodes recursively
 *
 * @see _TreeAddItem
 * @see _TreeEndUpdate
 *
 ...
 * @param PrimarySortOptions  String of one or more of the following options:
 *    <DL>
 *    <DT>{@literal 'I'}<DD>Ignore case
 *    <DT>{@literal 'F'}<DD>Sort filenames
 *    <DT>{@literal 'N'}<DD>Sort numbers
 *    <DT>{@literal 'E'}<DD>Exact Case.  
 *    <DT>{@literal 'D'}<DD>Descending.  Sort is ascending if this option is not specified.
 *    </DL>
 ...
 * bind this event to one of the commands {@link mou_click},
 * {@link mou_click_line}, {@link mou_click_block}, {@link mou_click_menu},
 * {@link mou_click_menu_line}, or {@link mou_click_menu_block}.
 *
 * @categories Combo_Box_Events, Edit_Window_Events, Editor_Control_Events,
 * Form_Events, Image_Events, List_Box_Events, Picture_Box_Events, Text_Box_Events
 *
...
/**
 * <p><b>Text Box</b> - Occurs when the {@link p_text} property changes.</p>
 *
 * <p><b>Combo Box</b> - Occurs when the {@link p_text} property changes.
 * The {@link on_change} event is called with a {@code reason} argument which may
 ...
 * catch the {@link on_change} event.</dd>
 * </dl>
 *
 * <p><b>List Box</b> - The {@link on_change} event is called with a
 * {@code reason} argument set to CHANGE_SELECTED.  Occurs when items are
 * selected or deselected because of a key press or mouse event.  None of the
 * _lb??? functions cause a list box on_change event.</p>
 *
 * <p><b>Directory List Box</b> - The {@link on_change} event is called
 * with a {@code reason} argument which may be one of the following {@code reason}
 * constants defined in "slick.sh":</p>
 *
 * <dl>
 ...
 * CHANGE_PATH {@link _dlpath} function was called which changed the
 * directory displayed.</dd>
 * </dl>
 *
 * <p><b>File List Box</b> - The {@link on_change} event is called with a
 * {@code reason} argument which may be one of the following {@code reason}
 * constants defined in "slick.sh":</p>
 *
 * <dl>
 * <dt>CHANGE_SELECTED</dt><dd>
 ...
 * {@link _flfilename} function was called which changed the file names
 * listed.</dd>
 * </dl>
 *
 * <p><b>Drive List -</b>  The {@link on_change} event is called with a
 * {@code reason} argument which may be one the following constants defined in
 * "slick.sh":</p>
 *
 * <dl>
 * <dt>CHANGE_OTHER</dt><dd>{@link p_text} property changed probably because of key
 * press.</dd>
 *
 * <dt>CHANGE_CLINE</dt><dd>{@link p_text} property changed because selected line in
 * list box changed and the list was visible.</dd>
 *
 * <dt>CHANGE_CLINE_NOTVIS
 * </dt><dd>{@link p_text} property changed because a key was pressed which scrolls
 ...
 * completed.  The {@link p_value} property has the new scroll position.</p>
 *
 * <p><b>Spin -</b>  The {@link on_change} event is called with a
 * {@code reason} set to CHANGE_NEW_FOCUS.  This event occurs before an
 * {@link on_spin_up} or {@link on_spin_down} event to allow you to return the
 * window id of the control you want to get focus after spinning is completed.
 * Return '' if you don't care.</p>
 *
 * <p><b>Tree View -</b>  The {@link on_change} event is called with a
 * {@code reason} argument which may be one the following constants defined in
 * "slick.sh":</p>
 *
 * <dl>
 ...
 * argument
 *
 * <p><b>SSTab -</b>  The {@link on_change} event is called with a
 * {@code reason} argument which may be one the following constants defined in
 * "slick.sh":</p>
 *
 * <dl>
...
/**
 * <b>Combo Box -</b>Occurs when the {@link p_text} property changes.  No
 ...
 * {@link on_close} is called.  If the form does not have an {@link on_close}
 * event, the dialog manager executes the {@link lbutton_up} event handler for
 * the command button with the {@link p_cancel} property set to {@link true}.  If
...
/**
 * All objects are sent an {@link on_create} event when a dialog box template
 * is loaded with the {@link show} or {@link _load_template} function.  The
 * {@link show} and {@link _load_template} function can be given a variable number
 * of arguments to pass to the {@link on_create} event.  The on_create event can
 * not be used to change the focus.  Use the {@link on_load} function to set the
...
/**
 * All objects are sent an {@link on_create2} event when a dialog box template
 * is loaded with the {@link show} or {@link _load_template} function.  No
 * parameters are passed to the {@link on_create2} event.  We recommend that only
 * user level 2 inheritance catch this event.  User level 1 inheritance should
 * catch the {@link on_create} event instead.
 *
 * @appliesTo Text_Box, Combo_Box, List_Box,  Directory_List_Box,
 * File_List_Box, Drive_List, Command_Button, Check_Box, Radio_Button, Frame,
 * Hscroll_Bar, Vscroll_Bar, Spin, Gauge, Image, Form, Tree_View
...
/**
 * All objects are sent an {@link on_destroy} event when the object is deleted
 * with the {@link _delete_window} function.
 *
 * @appliesTo Text_Box, Combo_Box, List_Box,  Directory_List_Box,
 * File_List_Box, Drive_List, Command_Button, Check_Box, Radio_Button, Frame,
 * Hscroll_Bar, Vscroll_Bar, Spin, Gauge, Image, Form, Tree_View
...
/**
 * All objects are sent an {@link on_destroy2} event when the object is
 * deleted with the {@link _delete_window} function.  We recommend that only user
 * level 2 inheritance catch this event.  User level 1 inheritance should catch
 * the {@link on_destroy} event.
 *
 * @appliesTo Text_Box, Combo_Box, List_Box,  Directory_List_Box,
 * File_List_Box, Drive_List, Command_Button, Check_Box, Radio_Button, Frame,
 * Hscroll_Bar, Vscroll_Bar, Spin, Gauge, Image, Form, Tree_View
...
/**
 * The {@link on_got_focus} event is sent to an object when it receives the
 * input focus.
 *
 * @appliesTo Text_Box, Combo_Box, List_Box,  Directory_List_Box,
 * File_List_Box, Drive_List, Command_Button, Check_Box, Radio_Button, Frame,
...
/**
 * The {@link on_drop_down} event is sent to a combo box with a {@code reason}
 * argument.  The {@code reason} argument specifies one of the following
 * conditions:
 *
 * <dl>
...
/**
 * The {@link on_hsb_bottom} event is sent to an Edit Window when the
...
/**
 * The {@link on_hsb_line_down} event is sent when the right arrow of a
...
/**
 * The {@link on_hsb_line_up} event is sent when the left arrow of a
 * horizontal scroll bar is pressed.
 *
 * @appliesTo Edit_Window, Editor_Control
 *
...
/**
 * The {@link on_hsb_page_down} event is sent when the you click on the area
...
/**
 * The {@link on_hsb_page_up} event is sent when the you click on the area
...
/**
 * The {@link on_hsb_thumb_pos} event is sent when you click and drag the
 * thumb box of a horizontal scroll bar.  The {@code hsb_pos} argument is a
...
/**
 * The {@link on_hsb_thumb_track} event is sent when you finish dragging the
 * thumb box of a horizontal scroll bar.  The {@code hsb_pos} argument is a
 * number between 0 and 32000 and corresponds to the far left and right
 * positions.
 *
...
/**
 * The {@link on_hsb_top} event is sent to an Edit Window when the horizontal
...
/**
 * The {@link on_init_menu} event is sent to a Form or MDI Window which has a
...
/**
 * The on_keystatechange event is returned by the {@link get_event}
 * function to indicate that a shift key has been pressed or released.  You must
 * call the {@link mou_mode} function with a one for this event to be returned by
...
/**
 * The {@link on_load} event is sent to a form (after the {@link on_create} and
 * {@link on_create2} events) when a dialog box template is loaded with the
 * {@link show} or {@link _load_template} function.  The {@link on_load} event is
 * intended to be used to set the control which has the initial focus.  Use the
 * {@link on_create} event unless you need to set the initial focus.
 *
 * @example
 * <pre>
 * #include 'slick.sh'
...
/**
 * The {@link on_lost_focus} event is sent to an object when it loses input
 * focus.
 *
 * @appliesTo Text_Box, Combo_Box, List_Box,  Directory_List_Box,
 * File_List_Box, Drive_List, Command_Button, Check_Box, Radio_Button, Frame,
...
/**
 * The {@link on_resize} event is sent to an object when the window position
 * or size is changed.  Use the {@link p_x}, {@link p_y}, {@link p_width}, and
 * {@link p_height} properties to get the position and size.
 *
...
/**
 * The {@link on_scroll} event is sent when you click and drag the thumb box
 * of a scroll bar.  The {@link on_change} event is sent after dragging the thumb
 * box is completed.
 *
 * @example
 * <pre>
...
/**
 * The {@link on_scroll_lock} event is sent when the scroll lock key is
 * pressed.  The {@code value} parameter is 1 if scroll lock is on.  Otherwise,
 * {@code value} is 0.
 *
 * @appliesTo Edit_Window, Editor_Control
 *
...
/**
 * The {@code on_select} event is sent before a key press event when the
 * current buffer has a selection.  User level 1 and user level 2 inheritance
 * can not catch this event.  Only the {@link default_keys} event table can
...
/**
 * The {@link on_spin_down} event is sent to a spin control if the
 * {@link p_increment} property is 0.  When the {@link p_increment} property is
...
/**
 * The {@link on_spin_up} event is sent to a spin control if the
 * {@link p_increment} property is 0.  When the {@link p_increment} property is
 * non-zero, the number in the previous control in the tab order (which must be
...
/**
 * The {@link on_timer} event is returned by the {@link get_event} function
 * when {@link _set_timer} is called with only the first argument.
 *
 * @categories Miscellaneous_Functions
 */
...
/**
 * The {@link on_vsb_bottom} event is sent to an Edit Window when the
...
/**
 * The {@link on_vsb_line_down} event is sent when the down arrow of a
 * horizontal scroll bar is pressed.
 *
 * @appliesTo Edit_Window, Editor_Control
 *
...
/**
 * The {@link on_vsb_line_up} event is sent when the up arrow of a horizontal
...
/**
 * The {@link on_vsb_page_down} event is sent when the you click on the area
...
/**
 * The {@link on_vsb_page_up} event is sent when the you click on the area
...
/**
 * The {@link on_vsb_thumb_pos} event is sent when you click and drag the
 * thumb box of a vertical scroll bar.  The {@code vsb_pos} argument is a number
...
/**
 * The {@link on_vsb_thumb_track} event is sent when you finish dragging the
 * thumb box of a vertical scroll bar.  The {@code vsb_pos} argument is a number
 * between 0 and 32000 and corresponds to the far left and right positions.
 *
 * @appliesTo Edit_Window, Editor_Control
...
/**
 * The {@link on_vsb_top} event is sent to an Edit Window when the vertical
...
/**
 * {@link rc} is a global variable that is automatically defined by the Slick-C&reg;
 ...
 * {@link buf_match}, and {@link get_env} which requires its use for
 * error checking.  Many other functions set the {@link rc} variable, but
 * we have not documented them to prevent unnecessary use of the
 * {@link rc} variable.  See also Error handling and the RC Variable.
 *
 * @categories All_Windows_Properties
 */
typeless rc;
...
/**
 * @return Return the major version of Qt SlickEdit is linked with (e.g. 4 or 5)
 */
bool _QtMajorVersion();
/**
 * @return Return the minor version of Qt SlickEdit is linked with 
 * (for example, return 15 for 5.15.2)
 */
bool _QtMinorVersion();

/**
 * @return
 * Returns {@code true} if the current object is an editor control
 * (and not a hidden window).
 *
 * @categories Window_Functions
 */
