 ...
 * new comparison function with {@code setCompareFunction}. 
 * Set the comparison function to {@code null} if you 
 ...
 * <p><b>Inserting</b></p>
 *
 * Use {@code insert} to insert an item into the map in
 ...
 * {@code exists} or {@code findKey}. 
 *
 * <p><b>Deleting</b></p>
 *
 * Use {@code delete} to delete an item out of the map that
 * matches a specific key. 
 *
 * <p><b>Navigating</b></p>
 *
 * <li>Use {@code front} to get an iterator to the first 
 * item in the map. 
 * <li>Use {@code back} to get an iterator to the last item 
 * in the map. 
 * <li>Use {@code next} to get an iterator to the next item 
 * in the map relative to a specific iterator position. 
 * <li>Use {@code prev} to get an iterator to the previous 
 * item in the map relative to a specific iterator position. 
 *
 * <p><b>Searching</b></p>
 *
 * <li>Use {@code findKey} to search for an item matching a
 * specific key.
 * <li>Use {@code findValue} to search for items matching a
 * specific item-value.
 *
 * <p>
 *
 * Note: When using {@code findValue}, and item-values 
 ...
 * exists with that key. You can also use {@code get} or 
 * {@code getRef} to retrieve the value pointed to by an 
 * iterator returned by {@link foreach}, {@code findKey}, 
 * {@code findValue}, or any of the map navigation methods. 
 * You can not use the <code>:[]</code> operator to insert new 
 * items into the map. Use {@code insert} instead. 
 *
 * <p><b>Iterating</b></p>
 *
 ...
 * value. Use {@code setCompareFunction} to change the 
 * sorting algorithm. 
 *
