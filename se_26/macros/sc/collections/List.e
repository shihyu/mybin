 ...
 * <p><b>Inserting</b></p>
 *
 * Use {@code insert} to insert an item into the List at a 
 * specific position. Use {@code append} to append an item 
 * at end of List. Use {@code prepend} to prepend item at
 * beginning of List. Use {@code assign} to assign to an 
 * existing item in the List. 
 *
 * <p><b>Deleting</b></p>
 *
 * Use {@code delete} to delete item(s) out of the List.
 *
 * <p><b>Searching</b></p>
 *
 * Use {@code find} and {@code findNext} to find the 
 ...
 * <p><b>Retrieving</b></p>
 *
 * Use {@code get} to retrieve the item at a specific 
