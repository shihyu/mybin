 ...
 * own. Set the comparison function to {@code null} if you 
 ...
 * {@code null}). Existing iterators are not affected 
 ...
 * then use {@code exists} or {@code findKey}. You can
 * not use the <code>:[]</code> operator to insert new items 
 * into the map. Use {@code insert} instead. 
 *
 * <p><b>Deleting</b></p>
 *
 * <li>Use {@code delete} to delete a specific item out of 
 * the map. 
 * <li>Use {@code deleteByKey} to delete all items out of 
 ...
 * <p><b>Searching</b></p>
 *
 * <li>Use {@code findKey} and {@code findNextKey} to 
 * search for items matching a specific key. 
 * <li>Use {@code findValue} and {@code findNextValue}
 ...
 * <p><b>Retrieving</b></p>
 *
 * Use {@code get} or {@code getRef} to retrieve the 
 * value pointed to by an iterator returned by {@link foreach}, 
 * {@code findKey}, {@code findValue}, or any of the 
 * map navigation methods. 
 *
 * <p>
 *
 * Use {@code byKeyIterator} to iterate over items that map
 ...
 * item-value. Use {@code setCompareFunction} to change the
 * sorting algorithm. 
 *
