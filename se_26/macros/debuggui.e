...
{
   // check if current entries are valid
   if (_debug_props_configurations_form_is_modified()) {
...
//
void ctl_threads_tree.rbutton_up,context()
{
   // get the menu form
...
// for the threads tree.
//
void ctl_stack_tree.rbutton_up,context()
{
   // get the menu form
...
// for the threads tree.
//
void ctl_locals_tree.rbutton_up,context()
{
   // get the menu form
...
// for the threads tree.
//
void ctl_members_tree.rbutton_up,context()
{
   // get the menu form
   index := find_index("_debug_variables_menu",oi2type(OI_MENU));
   if (!index) {
...
// for the threads tree.
//
void ctl_watches_tree1.rbutton_up,context()
{
   // get the menu form
   index := find_index("_debug_variables_menu",oi2type(OI_MENU));
   if (!index) {
 ...
 */
void ctl_breakpoints_tree.rbutton_up,context()
{
   // get the menu form
 ...
 */
void ctl_exceptions_tree.rbutton_up,context()
{
   // get the menu form
...
// for the threads tree.
//
void ctl_autovars_tree.rbutton_up,context()
{
   // get the menu form
   index := find_index("_debug_variables_menu",oi2type(OI_MENU));
   if (!index) {
...
//
void ctl_classes_tree.rbutton_up,context()
{
   // get the menu form
