 ...
 *               display unescaped)
 * @param name    Name of property ({@literal 'n'} attribute)
 * @param defaultValue Returned value if property or profile not
 *                     found.
 * @param apply   Set to {@literal 'apply'} atribute setting.
 * @param optionLevel
 *               optionLevel=0 specifies the user level
 *               settings. There may be project and
 *               workspace levels in the future.
 ...
 * @param name   Name of property ({@literal 'n'} attribute)
 * @param value
 * @param apply  If specified (non-null), sets {@literal 'apply'}
 *               attribute.
 * @param optionLevel
 *               optionLevel=0 specifies the user level
 *               settings. There may be project and
 ...
 * @param profileVersion Version of profile. Only used if new 
 *                       profile is created.
 * @param apply   If not null, sets {@literal 'apply'} attribute.
 * @param optionLevel
 *                optionLevel=0 specifies the user level
 *                settings. There may be project and
 *                workspace levels in the future.
 ...
 *  
 * <p>non-user properties can be removed (a {@literal 'd'} element is added
 * automatically).
 *  
 * @param escapedProfilePackage  The escaped profile package. 
 *                               Specifies the package this
