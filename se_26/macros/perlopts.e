...
{
   format_list := _file_types_get_filter_by_name(def_file_types, "Perl Files");
   wildcards:=_file_types_get_wildcards_by_name(def_file_types, "Perl Files");

   if( format_list == "" ) {
      // Fall back
      format_list = "Perl Files (*.pl;*.pm;*.perl;*.plx)";
      wildcards = "*.pl;*.pm;*.perl;*.plx";
   }
