...
void _emulation_form_init_for_options()
{
   ...
   if (purpose == OP_QUICK_START) {
      ...
      _ctl_cheat_sheet_link.p_y += heightDiff;
      _ctl_cheat_sheet_link.p_visible = true;
   }
}
...
void _ctl_cheat_sheet_link.lbutton_up()
{
   cheat_sheet := _getSlickEditInstallPath();
   cheat_sheet :+= "docs" :+ FILESEP;
   ...
   case 'gnu':
      ...
      break;
   case 'vcpp':
      cheat_sheet :+= "VisualCpp";
      break;
   case 'vsnet':
      cheat_sheet :+= "VisualStudio";
      break;
   case 'ispf':
      cheat_sheet :+= "ISPF";
      break;
   case 'codewarrior':
      cheat_sheet :+= "CodeWarrior";
      break;
   case 'codewright':
      cheat_sheet :+= "CodeWright";
      break;
   case 'bbedit':
      cheat_sheet :+= "BBEdit";
      break;
   ...
   cheat_sheet :+= "_Emulation.pdf";
   html_preview(cheat_sheet);
}
