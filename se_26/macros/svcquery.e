                           ...
                           bool &sectionsMatched)
{
   ...
   int OutputBufId;
   DIFF_INFO info;
   info.viewID1 = temp_view_id1;
   info.viewID2 = temp_view_id2;
   info.options = def_diff_flags|DIFF_NO_BUFFER_SETUP|DIFF_DONT_COMPARE_EOL_CHARS|DIFF_OUTPUT_BOOLEAN;
   info.numDiffOutputs = 0;
   info.isSourceDiff = false;
   info.loadOptions = def_load_options;
   info.gaugeWID = 0;
   info.maxFastFileSize = 800;
