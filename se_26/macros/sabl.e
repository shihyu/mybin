...
static const VSAUTOCODEINFO_SABL_IS_FUNC=   VSAUTOCODEINFO_USER1;
static const VSAUTOCODEINFO_SABL_IS_LABEL=  VSAUTOCODEINFO_USER2;
/*
   This is turned on if there is only one
   possible match.
*/
static const VSAUTOCODEINFO_SABL_EXACT_MATCH=              VSAUTOCODEINFO_USER3;
static const VSAUTOCODEINFO_SABL_LASTID_FOLLOWED_BY_SPACE= VSAUTOCODEINFO_USER4;
