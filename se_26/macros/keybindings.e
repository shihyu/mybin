...
static int getFileName(_str& suggestedFileName, _str initDir, bool doSave,_str initial_wildcards='*.cfg.xml',_str file_types=_file_types_append_filters('XML Config Files (*.cfg.xml)',def_file_types)) {
   fileName := "";
